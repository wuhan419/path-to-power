...
POTUS.define("event", [
  ...
  /* ── 第一幕 · 宣布寻求连任（窗口 3 个月）────────────────────────────── */
  {
    id: "camp_re_announce", brief: {
      lede: "你还没说要选，党内已经有人在排你走之后的座次了。",
      known: [
        "在任者的筹码是账本已经在手，包袱也是账本已经在手。",
        "早期州小车巡回赌热度，第二份新政赌蓝图，给党员的信赌不出错。",
        "你连一句「我打算参选」都还没说，第二任的人选已经有人在数了。"
      ],
      unknown: ["宣布调门定得太高，往后三个月每一件事都会被拿来跟它比。"]
    },
    grade: "major", category: "campaign", unique: false,
    valence: "risk", tierRaw: true, tierMin: 9, tierMax: 9, weight: 1,
    title: "宣布寻求连任",
    body: "登记还没截止，机器已经开动。你站到话筒前，说出那句「我打算寻求连任」——说完这一句，真正的仗才开始。",
    choices: [
      {
  ...
  {
    id: "camp_re_primary", brief: {
      lede: "初选里最锋利的刀不在对岸，在你自己党内，而且很年轻。",
      known: [
        "挑战者没有施政记录可打，他全部的选情只押在一句话上：你已经是过去式。",
        "亲自下场赌打没他，赢了也划线；党机器出手赌规则，赢了欠建制一笔；不接招最稳，也最像怕了。",
        "你手上攒着这几年的把柄——党内相残，用不用得看你想留什么。"
      ],
      unknown: ["真把他碾死了，代表大会上第一个过来跟你握手的还是他那一派。"]
    },
    grade: "major", category: "campaign", unique: false,
    valence: "risk", tierRaw: true, tierMin: 9, tierMax: 9, weight: 1,
    title: "党内的挑战者",
    body: "一位不到四十岁的挑战者挤进了初选。他不攻击你的政策——他攻击的时间：「那已经是上一代人的事了。」",
    choices: [
      {
  ...
  {
    id: "camp_re_debate", brief: {
      lede: "第二次站上辩论台，对面换了张新面孔——他上来的第一件事就是审你这几年。",
      known: [
        "新面孔不是来辩政策的，是来替你这几年结账的。",
        "在任者从容赌分量，摊开政绩账本赌气势，照稿念赌不失态。",
        "你这几年攒下的把柄够炸掉对面半个竞选总部——投不投，是最后一道选择题。"
      ],
      unknown: ["观众记住的往往不是你的政绩，是那一道你没答上来的追问。"]
    },
    grade: "major", category: "campaign", unique: false,
    valence: "risk", tierRaw: true, tierMin: 9, tierMax: 9, weight: 1,
    title: "第二次总统电视辩论",
    body: "台下还是几亿双眼睛，台上的布景和几年前一模一样。对面站着的新面孔开口第一句就是：「总统先生，我们来谈谈这几年。」",
    choices: [
      {
  ...
  {
    id: "prog_reelect", brief: {
      lede: "选票上印着你的名字，称盘上放着你的全部几年。",
      known: [
        "赢，就再把旗插进白宫四年；输，就在今天开始记清算的账。",
        "主战赌这几年，押地方议题赌转移，主动让位赌遗产与党内好感。",
        "在任者赢连任靠的从来不是气势，是没被翻出来的那几页。"
      ],
      unknown: ["开票之夜结束后，卸任清算的账本从今晚第一笔开始记。"]
    },
    grade: "major", category: "campaign", unique: false,
    ...
    valence: "risk", tierRaw: true, tierMin: 9, tierMax: 9, weight: 1,
    title: "投票日 · 连任",
    body: "投票站的队在天亮前就排了起来。今晚，选民替你的这几年结账——要么盖章续期，要么当面清账。",
    choices: [
      {
