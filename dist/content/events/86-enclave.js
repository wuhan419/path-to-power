...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "这四百人里三分之一会去投票，且会问牧师投谁。",
        "牧师不站党派，只站这个社区；你讲的得和他一致。",
        "他给你十分钟不是因为你，是有人托了他。",
        "台下第三排坐着三位老人，是社区真正记账的人。"
      ],
      rumor: [
        "据说牧师上次替人讲话，是因那人答应修屋顶。",
        "据说社区正争一件事，他两边都得罪不起。"
      ],
      unknown: [
        "他为什么给你，而不是给别人。",
      ...
      terms: [
        { k: "讲台", v: "社区里不花钱就能被四百人同时听见的地方。" },
        { k: "牧师", v: "他不投你，他决定别人投不投。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      terms: [
        { k: "公所", v: "没章程没选举，权力来自「大家都这么办」。" },
        { k: "义捐", v: "社区里对赞助的称呼，不算贿赂是入场券。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "选务处今年打算把双语选票从三个投票站撤掉，理由是「使用率不足」。\n" +
      ...
      "他们不是不需要，他们是不问。",
    brief: {
      lede: "一千七百张票不会自己消失，只会变成「不知道发生了什么」。",
      known: [
        "撤的是三个站：老城最集中、投票率最低那三个。",
        "选务处主任不是坏人，只是被要求把成本压下来。",
        "报纸上还没人写——它还只是个行政决定。",
        "你手上有二十天，之后是委员会的例会。"
      ],
      rumor: [
      ...
      terms: [
        { k: "双语选票", v: "一张纸，决定谁能在不被翻译时做出选择。" },
        { k: "使用率", v: "一个统计口径，改下算法结论就反过来。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      terms: [
        { k: "巡逻队", v: "社区自发的夜间照看：有效，且不可控。" },
        { k: "警力配置", v: "预算表上的数字，它一变等候时间就变。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "社区开会要推一个人去选下一级的席位——他们选中了你。",
      known: [
        "社区能动员约四千张票，地方选举里足以定一个席位。",
        "他们不指望你赢，只望登记时门口站个认识的人。",
        "接了就等于站队：党内会把你当「社区的人」。",
        "他们不喜欢被当跳板，你太像政客会发现。"
      ],
      rumor: [
      ...
      terms: [
        { k: "推出", v: "社区一致的动作：不给钱，只给名字。" },
        { k: "能被接受", v: "社区里被信任，外面不被当威胁。" }
      ]
    },
    choices: [
      {
