...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "得州尤瓦尔迪，周三上午：一个步枪手走进三年级教室。十九个孩子、两名老师留在学校里——而全副武装的边境巡警在走廊外守了七十几分钟才破门，指挥链当场乱套。\n" +
      "你所在的选区今晚有烛光守夜。本地台要你说第一句话；党部要你「先别谈政治」——本州拥枪传统深厚，党团——全美最有分量的拥枪游说团体——的办公室就挨着州议会。你扶哪条法案，党鞭记下的是第一笔账。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    title: "联邦最高法院推翻罗伊案，五十年的堕胎权保护一夜失效",
    body: "五月初，泄漏的判决书草稿让九位大法官的天平先漏了底；六月下旬，判决落地：1973 年罗伊案确立的联邦宪法堕胎权保护戛然而止，南方十几个州的「触发法」当天生效，诊所连夜转诊。\n" +
   ...
   * ==================================================================== */
  {
    ...
    body: "六月 CPI 同比 9.1%——四十年来最高，七月十三日公布。油价破五块，房贷利率跟着央行的锤子上蹿——加息以「基点」计，一次 75 基点就是 0.75 个百分点。白宫说峰值已过、风向要转，本地加油站的价格牌不认这句话。\n" +
      "镇民大会上坐满了算账算到发火的人。他们不问你什么是通胀，问你：谁的错，你打算怎么办。加息的账单明年初才轮到就业市场来付——你先说的那句，会先被做成对比广告。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "十一月八日，出口民调本该讲一个浪潮故事。结果是：总统所在党在参院反增席位，众院以极微弱多数易手，佐治亚要等十二月的决胜轮定参院归属。\n" +
      "你押了潮水的人此刻得重新读表：一场没输光的败选，一场没赢到的胜。剩下的账，都是自己的。这份读数将定下 2024 两边初选的调子——你今晚的定位，就是下轮的起拍价。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "周三，母公司公告卖资产补缺口；周四一天被提走约一千亿美元；周五监管进门接管——全美第十六大银行，两天塌掉，九成存款本超着保险线。随后一个周末另一家银行也进去了，又一天，财政部与央行宣布「系统性风险」例外——为防挤兑，全部存款一律兜底。\n" +
      "你选区科技镇上的创始人打来电话：工资到底该发在哪张卡里。存款早几个月就朝 5% 的货币基金搬家了，这次只是没人再假装没事。你现在替谁稳住的钱，人家会记很久。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "国会定的举债天花板——债务上限——早已触顶，财政部的非常规手段进入倒计时，违约最早落在六月初；评级机构已放话要下调。众议院议长把提高上限与两年支出上限捆成一张票，白宫说「不谈条件」，政府内斗在电视上直播。\n" +
   ...
   * ==================================================================== */
  {
    ...
    body: "十月七日，哈马斯越界袭击南以色列，约一千二百人死亡、两百余人被掳——人质家属已经站到了镜头前；以色列随即对加沙展开空袭，人道数字一天一个样。远方的战争当月就爬上本地校园与犹太会堂的围墙。\n" +
      "你的捐款账本与街区的祈祷都朝你伸着手。两边都用同一个词指控对方：仇恨。大学正在开听证，校董会名单上有你认识的姓。你此刻的措辞，两边会各剪出一版。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "宾州钢铁镇，前总统候选人露天集会：枪声起，特勤局扑上讲台——他耳廓带血举起拳头，看台上有人永远没再站起来，枪手被狙击手当场击毙。有人说这是独狼——现场清单与他旧日的发帖很快会被公开。\n" +
      "全国数小时内完成站队：有人高喊团结，有人查安保漏洞，有人先算这场血会怎么改写民调。你的电话也在响。聚旗效应——冲击之后支持率短期冲高——正在抬表；特勤局为何迟了，是两边都想要的议题。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "夏天退选、副总统接棒、辩论与 AI 假音频轮番上场，最后开票：前总统归来，参议院翻转，众院计到次日凌晨。在野一方的败选检讨会还没开，执政一方的分赃会已经开始。\n" +
      "你的处境取决于：你此刻坐在哪一桌、还有没有桌可坐。交棒仍按程序走：先电话，再委员会，再人事清单——而你今晚选的边，几年后会被逐条清算。",
    choices: [
      {
