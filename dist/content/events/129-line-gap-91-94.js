...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "最高法院提名人坐在镜头前，与他当年的女下属、一位法学教授互相指认：她说他当年没完没了地追问，他说这是「高科技私刑」。委员会七比五把提名送交全院，五十二比四十八，确认了。\n" +
      ...
      "有人说，还有两名前下属的证词已经备好；这句话没人证实，也没人否认。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "挑战者把「关键是经济」喊成了全国方言，计票夜赢下白宫：同一党执掌白宫十二年，一夜结清。第三党候选人卷走近两成普选票，把在任者在数个只有一两个点差距的州顶下了台。\n" +
      "同一夜，新总统所在党把参众两院一并握住——这样的「一党通吃」，已经四十年没出现过。新政府头一百天，本地任命表要全部重排。\n" +
      "浪潮已经在路上：不在浪头上的人，就得吃浪。这份赢家名单上有没有你，今夜没人认得你。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "联邦购枪背景审查与等待期法案在十一月落笔签署：来年春天临时条款陆续施行，枪店的柜台上多出一张非填不可的表。拥枪阵营把这一天叫作「执法的末日」——今年春天就有上万人携枪涌进首都游说，来年春天的草坪集会许可已经递了上去。\n" +
      "你的办公室里，枪店协会的请愿书和警长们的联署函摞在一起，都等你的第一句话。新规是买枪先核查再等待——持牌枪店售枪前须核对购买资格。\n" +
      "有人说等待期根本执行不了，枪店会成批关门。执法的钱和锅哪个先到你头上，没人给你排过序。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "三百页的联邦犯罪法在九月签署：十年增警十万，社区警力拨款下沉到警局，联邦上诉程序拧紧；攻击性武器禁令也第一次写进联邦法律，尾巴上带着十年日落条款。\n" +
      "凶案曲线还在高位，中期选举只剩两个月，「打击犯罪」成了最锋利的话筒：人人都抢着认领这个词，人人都怕被贴上「心软」的标签。本地警长已经在向你要社区警力的名额——禁令这道日落条款（到期自动失效）之外，拨款的名额据说早被自己人预订了。\n" +
      "今天往别人脸上贴的标签，四年后贴回谁脸上，账还没人算。",
    choices: [
      {
