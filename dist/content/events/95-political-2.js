...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        ...
        "提名怎么打取决于年代：六十年代表决从党支部会议（caucus）的会议室里谈出来；七四年前后许多州靠代表大会（convention）的代表票定胜负；到你的时代，多半是征集签名登上初选选票、然后拼初选投票日。",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "领袖办公室把党鞭名单摊开：一场关键表决（预算/法案/任命——按你的层级）差距两票，而你的名字在「未确定」那一栏——因为你的选区对这项表决五五开。",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        ...
        "背书的潜规则是链条式的：你背书上面那位，上面那位欠你一次；你背书后辈，后辈的整个网络将来都从你这里发端——所谓循环背书，A 捧 B 上位，B 的资历反哺 A 的「伯乐」叙事。",
