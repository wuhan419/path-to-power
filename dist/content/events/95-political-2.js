...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "本党席位开放，党部给两个人留了椅子：你和一位先到一步的同志，而机器的初步意向站在他那边。初选本有「不互撕」的规矩，两人同印上选票就化了；争、等、还是让，三天里试探的电话打个不停。据说那位同志半年前就跟县党部打过招呼。初选里说的每句话，输家的基层桩脚都记着——他们的人脉不会消失，只会等上两年或四年。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "关键表决差两票，你的名字在领袖的「未确定」栏。你的选区对这项表决五五开，所以你迟迟没定。数票人（替领袖清点本党票数、催票的党内职务）一下午从你门口过了三次；据说对面也开了价——一个对你选区有利的项目。这张名单上没有「弃权」：不接电话，也算一票。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "全国代表大会（四年一次提名总统候选人的全党大会）的代表席位开放报名，你要争的是基层代表那一档：无薪、无镜头，名单按忠诚、出席率和苦活排，不按资历。县党部书记说得直白：坐满五年冷板凳，第六年才有椅子。据说有位老代表的席位「可商量」，但得先陪他下完棋。这份苦差的真正红利四年后才兑现，而走廊往往比会场值钱。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "两份背书（公开支持某候选人的政治表态）同时找上门：高你两级的人要你署名，你提携的后辈在等你一句话。麻烦在于他俩分属党内两派，你只能真实地站一边。你的名字是货币，印出去就回不来。今天你捧的人，明天可能坐在决定你提名的位置上。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "扶你上位的派系在改组中失势，新当权派开始清洗——胜利者对失败者网络的系统性清账。你一半人脉、两份背书和第一次升迁，都签着旧派系的名字。今晚最老的盟友来电：「名单第三页有你，我看过。」当权派也约你「喝茶」：要的不是检讨，是表态；旧规矩里这叫投名状——把旧关系的底交出去。据说新派手里攥着旧派这些年的往来记录。清洗里没有旁观席：你的沉默，两边各记一笔。",
    choices: [
      {
