...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    title: "一整片州一夜之间换了颜色",
    body: "电视里，那位前演员以碾压之势横扫全国：滞胀、人质、和一句「政府不能解决问题」，把在位者送下了台。\n" +
      "你的选区这回投了对手，党部的电话已经打过来——要解释，也看你变不变调。\n" +
      "「里根民主党人」（本该铁票民主党的蓝领，这回放他上台）已经印上每一张民调。有人说党魁正挑第一个转向的人当样板。你是识时务还是没骨气，看接下来谁当家。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "空中交通管制员罢工，白宫给每个人发了一封信：回来，否则解雇——依据就是那部禁止公务人员罢工的法。\n" +
      "绝大多数人没回来，几周之内一万多人被正式开除，工会罚到破产。全国头一次看清：风向真的变了。\n" +
      "本地机场的预算走你这条线，被解雇者的家属就印在你的选民册上。有人说这场罢工是被人故意激出来的，好杀鸡儆猴。这一刀砍下去，你的工会票仓还剩多少？",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "监管松绑后，一批新开的储贷协会（吸储放贷，联邦担保兜底，崩了得有人背）开始满世界撒钱：地产、油田，什么都投。\n" +
      "他们要你挂个董事的名，替他们的牌照扫清障碍；价码很客气：投一笔，年底分红——如果它没在你分红前先倒下。\n" +
      "有人说这家的账目全是花架子，撑两年就卷款走人。散场的时候，你的名字在领奖台，还是被告席？",
    choices: [
      {
