  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        ...
        "这件事如果有人拍照、有人说话，你的政治生命会在四十八小时内结束。",
        "她比你更清楚利害——但她显然已经不在乎了。"
      ],
      "rumor": [
        "圈子里有人说你也已经听说了。这种消息在华盛顿传播得比任何政策都快。",
        "有人说你那位同僚本人最近也在闹同样的事，所以你并不孤独，只是运气不同。"
      ],
      "unknown": [
        "有没有人已经知道这条消息的存在。",
        "几年后互联网会变成什么样子——那时一条消息可以在一夜之间铺满所有屏幕。",
        "你今晚做的决定，会不会成为某个人未来要挟你的筹码。"
      ],
      "terms": [
        {
          "k": "绯闻政治",
