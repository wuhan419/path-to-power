...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "历史罕见地把「赢麻了」的顺风塞进你手里，就看你说不落、记不记得住。",
      known: [
        "苏维埃社会主义共和国联盟正式停止存在，核武仍在但没人接班。",
        "本地东欧裔社区要办感恩集会，缺一个「有头衔的人」站台。",
        "有线台正找各地民选官录「胜利意味着什么」的回应镜头。"
      ],
      rumor: [
        "有人说莫斯科的强硬派随时可能翻回来。",
        "有人说省下的军费今年就能落到本地账上。"
      ...
      terms: [{ k: "苏联解体", v: "1991年12月苏联正式停止存在。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "火烧起来以后，沉默是表态，说话也是表态，两边都会记账。",
      known: [
        "四人被殴的画面全国播过无数遍，被告席上却全是无罪。",
        "哄抢与纵火连日不歇，消防队出警要配警察护送。",
        "本地黑人教堂和商户协会都在等你的第一句话。"
      ],
      rumor: [
        "有人说店主们已在自组巡逻队。",
        "有人说火是趁火打劫者放的，与判决无关。"
      ...
      terms: [{ k: "洛杉矶暴动", v: "警察殴人案判无罪引发的六天骚乱。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "一声谁都没当真的警告枪：你可以说「前所未有」，没人敢说不会有下次。",
      known: [
        "目标是双塔本身，策划者要的是炸塌，实际只炸穿了底部。",
        "同案嫌犯在逃，联邦悬赏，各地同步在查租车记录。",
        "本地中东裔商铺遭遇罢市与冷眼，商户联名请你出面。"
      ],
      rumor: [
        "有人说城外还有一辆装满炸药的货车。",
        "有人说联邦其实什么都不知道。"
      ...
      terms: [{ k: "世贸爆炸", v: "1993年2月世贸北塔车库汽车炸弹案。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "火还没冷，争论已经着火：谁点的令，谁本该拦住。",
      known: [
        "首次突袭就有人员死伤，最终强攻选在凌晨五点。",
        "幸存者证词与官方说法对不上，档案还不公开。",
        "追悼会与挺执法集会排在了同一周，都请你出席。"
      ],
      rumor: [
        "有人说庄园里本有一堆没核实就上报的武器情报。",
        "有人说教派自己放的火，不是政府的锅。"
      ],
      unknown: [
        "这火星日后会在别处再燃。",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "一场短促的战斗变成一段长长的画面：公众要有人负责，家属要人回来。",
      known: [
        "行动目标是军阀的几个助手，代价是一夜激战与电视画面。",
        "白宫已在讨论撤出，维和的欧洲国家跟着动摇。",
        "你选区的征兵处和两个军属家庭半夜接了电话。"
      ],
      rumor: [
        "有人说还有俘虏活着，在被当筹码谈。",
        "有人说真正的目标是爆炸案背后的金主。"
      ...
      terms: [{ k: "黑鹰坠落", v: "1993年10月摩加迪沙突击失利。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "天灾不挑选举年：重建的钱和问责的账，最后都归活人算。",
      known: [
        "联邦救灾款在批，但程序长，本地等不起。",
        "保险公司全州停售地震险，业主们排队也无门。",
        "你治下的灾民安置点缺人、缺水、缺工程队。"
      ],
      rumor: [
        "有人说救灾款已定，谁嗓门大先到谁账上。",
      ...
      terms: [{ k: "北岭地震", v: "1994年1月洛杉矶都会区强震。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      terms: [{ k: "共和党革命", v: "1994中期选举共和党夺回两院。" }]
    },
    choices: [
      {
