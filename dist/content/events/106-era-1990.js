...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "本地议会要拿你的决议表态「挺不挺部队」；反战即不爱国。",
        "联合国给了最后期限，多数美国人支持动武，支持率创新高。",
        "你选区里的阿拉伯裔家庭一夜之间成了怀疑对象，商户电话被打爆。"
      ],
      rumor: [
        "有人说这仗为石油，跟「解放」无关，只是没人敢说。",
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "党部找你，因为你在本地说得上话、懂怎么劝退摇摆者。",
        "经济疲软让在位者支持率跳水，第三党正好卡在这个缝里。",
        "「不开除第三名」是当年调侃：他赢不了，却能把水搅浑。",
        "你可以正面打，也可以把话放回自己选区，两条路账不同。"
      ],
      rumor: [
        "有人说那位富翁只是想要一张更大的牌桌，谈妥了就撤。",
        "有人说危险的不是他当选，是他把议题整个带跑偏。"
      ],
      unknown: [
        "第三党会不会把两党结构撬开一条长期的缝。",
        "你替机器堵漏，机器会记住，还是用完就忘。"
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "表决落到你手上：你选区既有军工工厂，也有等钱修路的选民。",
        "军工承包商正密集游说，主打「不能自废武功」。",
        "财政鹰派则盯着赤字，想把省下的军费拿去还债或投国内。"
      ],
      rumor: [
        "有人说真威胁没了，剩下的军费全是承包商在分。",
        "也说旧对手散了，中东新麻烦在冒头，别急着砍。"
      ],
      unknown: [
        "若日后冒新敌，今天砍的军费都成把柄。",
        "投国内的政绩，够不够撑到下次连任。"
