...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    id: "gulf91_storm", photo: "gulf91_storm.jpg", grade: "major", category: "foreign",
    valence: "risk", dyn: true,
    era: ["1990_GULF"], tierMin: 1, tierMax: 5, weight: 12, unique: true,
    medium: ["print", "radio", "tv", "cable"], month: 1,
    title: "导弹拖着光尾划过夜空，全世界都在看",
    body: "伊拉克吞并科威特数月后，联军开打，代号「沙漠风暴」。联合国下了最后期限，多数美国人支持动武，支持率创了新高。\n" +
      "电缆新闻网把摄像头架在酒店窗口，空袭画面第一次实时传进每一间客厅。支持还是反对，成了压在每个民选官员头上的题。\n" +
      "本地议会要拿你的决议表态「挺不挺部队」：反战就是不爱国。你选区里的阿拉伯裔商户一夜之间成了怀疑对象，正等着看你怎么开口。\n" +
      "有人说这仗打的是石油，跟解放无关。你替他们说的那句话，是护身符还是催命符？",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "仗打完了，油价回落，国内经济却蔫了：工厂外迁、失业上升、税改承诺被自己人打破。\n" +
      "一个嗓门很大的亿万富翁认真张罗起第三党（两党之外、靠经济不满搅局的那种竞选），把两边候选人一起骂。民调显示他赢不了，却真能抢走一大票。\n" +
      "党部给你打电话：你在本地说得上话，想办法让本党的人「别跑去看那个富翁」。正面开打，还是把话拽回自己选区？有人说他不过是想要一张更大的牌桌，谈妥了就撤。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    id: "gulf91_peace", photo: "era-1991.jpg", grade: "mid", category: "foreign",
    valence: "boon", dyn: true,
    era: ["1990_GULF"], tierMin: 2, tierMax: 5, weight: 10,
    medium: ["print", "radio", "tv"],
    title: "墙倒了，军费还在，有人说该把钱花回国内",
    body: "苏联解体，冷战结束。有人开始喊「和平红利」（把军费转投国内民生与还债）：省下来的钱修桥、办学校、还国债。\n" +
      "也有人警告：一个没了对手的霸权，比从前更需要肌肉。你手上这份「砍还是留」的表决正卡着——你的选区里既坐着军工工厂，也坐着等钱修路的选民，承包商这几天天天在游说。\n" +
      "有人说真威胁已经没了，剩下的军费不过是他们在分钱；日后要是冒出个新对手，今天你砍掉的每一笔都会被人翻出来。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    title: "一档火辣的谈话电台邀你连线",
    body: "一档靠激愤起家的谈话电台点名要「请某某上台对线」：主持人与听众交锋，情绪大于事实。你上回拒过他的采访，被他做成「心虚」播了一整周，这次他直接点你的名。\n" +
      "这类节目专挑政治人物的软肋下手；一段被抓拍的失态能反反复复播上一年，而你的对手这会儿就在监听。连上去痛快，可话筒那头，剪辑的剪刀早就磨好了。有人说他跟某个竞选团队有私交易，这期节目就是替对手挖的坑。",
    choices: [
      {
