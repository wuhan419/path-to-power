...
POTUS.define("event", [
...

  {
    ...
    body: "2011 年的纽约，祖科蒂公园被帐篷占满——这场直指贫富分化的露营抗议，两周来天天上头条，口号是一句「我们是九十九」。"
      + "没有领袖、没有纲领，人人可以发言：这是魅力也是病。里面有你认识的人，也有职业活动家和几个来路不明的人。"
      + "你去送过一次咖啡，现在他们问你：要不要留下来帮他们做「对外沟通」——你有一张会说话的嘴。"
      + "据说市政已经定了清场日期，只等天冷。",
    choices: [
      {
...

  {
    ...
    body: "救市之后，另一边的怒火也烧起来了：反税、反救市、反大政府的茶党把市政厅挤满。"
      + "你选区的市政厅下周开会，议题是一项联邦项目，组织者在电台里喊「坐满会议室」。两份邀请都到了：一份来自愤怒的人群，一份来自吓得想让你去「灭火」的商会。"
      + "愤怒是真的——账单、房贷、「我们的钱救了他们」；据说背后的钱也是真的：智库、电台、家族基金会。"
      + "浪也会退，退潮时浪尖上的人会挂在滩上。",
    choices: [
      {
...

  {
    ...
    body: "听证会开了两天，全美国都在看那些坐着公司商务机来要钱的老板——底特律三巨头（通用、福特、克莱斯勒）在国会哭穷，要几百亿救援贷，上一次轮的是华尔街。"
      + "来听证的路上你经过一家零件厂，停车场的草长了半尺。"
      + "算术很冷：救是几百亿，不救是几十万岗位在圣诞前清零。现在轮到你表态，圣诞节的新闻标题已经排好两个版本。"
      + "有人说三家里只有一家有救，另外两家是搭车的；白宫递出来的条件里，也塞着私货。",
    choices: [
      {
