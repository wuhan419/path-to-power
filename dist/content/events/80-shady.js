...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      rumor: [
        "有人说上个月已经有人做过一样的事，被学校记下了名字。",
        "有人说真正赚钱的不是货，是「知道谁需要」这件事本身。"
      ],
      unknown: [
        "哪一天会有人开始问「他凭什么能办到」。",
        "这条路的尽头是别人递过来的一杯酒，还是一张传票。"
      ],
      terms: [
        { k: "单次生效", v: "只做一次、不留下可持续经营的痕迹。做第二次就不成立了。" },
        { k: "本金", v: "你必须先垫钱。灰色生意没有账期，也没有合同。" }
      ]
    },
    choices: [
      {
        ...
        outcomes: {
          ...
          fail: out("有个家伙拿了货不给钱，还带走了你的名字。本金进了水。",
            { funMul: -0.6, rep: -3, fac: { base: -5 }, flags: ["shady_start"] }),
          critfail: out("学校保安记下了车牌。你没被起诉，但那辆车的登记人是你哥。货和本钱一起没了。",
            { funMul: -1.0, rep: -6, hp: -3, fac: { base: -8, press: -5 }, flags: ["scandal_1", "sold_brother"] })
        }
      },
      {
        id: "small", text: "只做小份，慢慢试水温",
        base: 0.62, mods: [{ src: "attr", key: "INT", w: 0.4 }, { src: "fac", key: "base", w: 0.3 }],
        cost: { fun: 8000 }, stake: { ap: true },
        outcomes: {
          ...
          critfail: out("你找错了人。对方拿了样品，转头照着你说的做了一遍，还做得比你快。",
            { funMul: -0.9, rep: -3, fac: { commercial: -5 } })
        }
      },
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      rumor: [
        ...
        "有人警告你：在他那里借钱，等于在一个不会忘事的人面前低头。"
      ],
      unknown: [
        "他到底替谁管这笔账。",
        "如果你还不上，他会先找你，还是先找你哥哥。"
      ],
      terms: [
        { k: "短期拆借", v: "只借几周。利息按次算，不按月算 —— 越短越贵。" },
        { k: "人情担保", v: "你不需要抵押物，你需要一个愿意为你说话的人。" }
      ]
    },
    choices: [
      {
        ...
        req: { rep: 5 }, stake: { fun: true, ap: true, fav: true },
        outcomes: {
          crit: out("他把钱推过来，还多加了两成：「你这个人我看了很久，值得多押一点。」你第一次意识到，被信任是有价格的。",
            { fun: 260000, contact: { shark: 16 }, fac: { commercial: 6 } }),
          ok: out("钱到手了，说好了秋天还。你们握了手，事情就这么定了。",
            { fun: 160000, contact: { shark: 8 }, flags: ["owes_shark"] }),
          meh: out("他给了钱，但少了两成，说「你现在还不值这个数」。这句话你要记很久。",
            { fun: 90000, contact: { shark: 2 }, flags: ["owes_shark"] }),
          fail: out("他笑着拒绝了：「我借钱给有把握的人，你现在不像。」你从他店里走出去的时候，觉得自己矮了一截。",
            { rep: -3, contact: { shark: -6 } }),
          critfail: out("他借了，但让你在收据上按了个手印，还让旁边的人看了一眼。你成了这条街上「有账在身」的人。",
            { fun: 70000, rep: -5, contact: { shark: 4 }, flags: ["owes_shark", "compromised"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("当天还清，还多给了一点。他点点头说：「规矩人。」在这个社区里，这三个字能当钱用。",
            { fun: 24000, contact: { shark: 12 }, rep: 1 }),
          ok: out("借了，还了，谁也没多说话。你在他那里有了第一条记录。",
            { fun: 12000, contact: { shark: 6 } }),
          meh: out("凑钱的那两天你几乎没睡。钱还上了，人也垮了。",
            { fun: 6000, hp: -4, contact: { shark: 4 } }),
          fail: out("你迟到了一天。他没说什么，只是把利息改了。",
            { fun: -4000, contact: { shark: -3 } }),
          critfail: out("你没能按时凑齐，去求他宽限。他答应了，但这件事在社区里传开了。",
            { fun: -6000, rep: -4, contact: { shark: -8 }, flags: ["compromised"] })
        }
      },
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "这份记录是真的。你能看懂上面的编号和签章，它来自一个本该保密的地方。",
        "涉事的这位先生现在还在位，而且正好卡在你要过的那道门上。",
        "送你东西的人没留名字，说明他希望这袋东西被用掉，而不是被收起来。",
        "持有它本身不违法。用它才违法——但你被抓住的概率取决于你怎么用。"
      ],
      rumor: [
      ...
      unknown: [
        "送东西的人想从这件事里得到什么。",
        "如果你什么都不做，这份纸五年后还有没有用。"
      ],
      terms: [
        { k: "把柄", v: "能让某人坐立不安的东西。它不能换成钱，只能换成沉默和让步。" },
        { k: "有效期", v: "把柄跟着人走。那个人下台、退休或死了，纸就变成了废纸。" }
      ]
    },
    choices: [
      {
        ...
        outcomes: {
          ...
          fail: out("你收起来了，但房东翻过一次你的房间。她没拿走什么，但你从此不放心。",
            { lev: 1, hp: -4, fac: { base: -3 } }),
          critfail: out("你收起来了，但那个牛皮纸袋上留着你的指纹，而它第二天出现在了别人的桌上。",
            { lev: 1, rep: -4, flags: ["scandal_2"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("你只说了三句话，其中一句是那个编号。他请你坐下，给你倒了水，然后答应了你要的那件事——还多答应了一件。",
            { tier: 1, rep: 8, lev: 1, fac: { establishment: 12, press: -6 }, flags: ["compromised"] }),
          ok: out("事情办成了。你没说威胁的话，但你们两个都听见了那句话没说出口的部分。",
            { rep: 5, lev: 1, fac: { establishment: 8 }, flags: ["compromised"] }),
          meh: out("他答应得很痛快，痛快得你怀疑这件事对他来说根本不算什么。",
            { rep: 3, lev: 1, fac: { establishment: 4 } }),
          fail: out("他听完之后笑了，说他三年前就为这件事道过歉、付过代价。你的纸在他眼里已经过期了。",
            { lev: 1, rep: -5, fac: { establishment: -12, press: -8 }, flags: ["scandal_2"] }),
          critfail: out("他没等你说完就按了铃。保安进来的时候他把纸袋推到你面前，说：「这是你的东西，先生。」全程没有一句威胁，但所有人都懂了。",
            { lev: 1, rep: -9, hp: -4, fac: { establishment: -18 }, flags: ["scandal_3", "investigation_open"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("你在后院的铁桶里把它烧了，还把灰搅开。你失去了一个机会，也失去了一个将来会让人半夜敲门的东西。你那天睡得很沉。",
            { rep: 3, fac: { base: 6, agency: 5 }, contact: { fixer: -6 } }),
          ...
          critfail: out("你正在烧的时候，邻居在阳台上看了一会儿。后来有人开始打听「那个在院子里烧东西的年轻人」。",
            { rep: -3, fac: { base: -5 }, flags: ["scandal_1"] })
        }
      }
    ]
  },
   ...
   * ======================================================================== */
  {
    ...
    grade: "minor", category: "shady", medium: "print",
    title: "诊所医生的签名",
    ...
    brief: {
      ...
      terms: [
        { k: "签名", v: "一份带医生签字的纸。它让你合法地消失几天。" },
        { k: "底账", v: "经手人自己留的备份。对你是把柄，对他也一样。" }
      ]
    },
    choices: [
      {
        ...
        outcomes: {
          crit: out("他没敢多问，而且为了保险，还多给了你一份完全不同的记录。你走的时候他手在抖——你知道自己以后还能来。",
            { lev: 1, rep: 1, fac: { base: -2, press: 3 }, contact: { doctor: 6 } }),
          ok: out("他签了。你没说一句难听的话，但两个人都清楚刚才发生了什么。",
            { rep: 1, fac: { base: -3 }, contact: { doctor: 2 } }),
          meh: out("他签了一半就开始拖延。你拿到了东西，但他记住了你的脸。",
            { contact: { doctor: -5 } }),
          fail: out("他很怕，但怕到了极点反而硬了起来：「你报警吧，我明天就关门。」你拿不到签名，还多了一个敌人。",
            { rep: -3, fac: { base: -6 }, contact: { doctor: -16 } }),
          critfail: out("他把这件事说给了同乡会的几位长辈。三个月后，旧城区的每一家店都知道你是什么人。",
            { rep: -6, fac: { base: -12, civil: -10 }, contact: { doctor: -22 }, flags: ["scandal_1"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("你付了钱，还替他算了一笔账：你带来的量能让他的房租轻松几个月。他从那天起把你当成「一个客户」。",
            { rep: 1, contact: { doctor: 14 }, fac: { base: 3, commercial: 4 } }),
          ok: out("钱付了，签名拿到，双方都很客气。这是最干净的一种脏。",
            { contact: { doctor: 8 } }),
          meh: out("他收了钱，但只肯签两张，还让你下次别在白天来。",
            { fun: -6000, contact: { doctor: 2 } }),
          fail: out("他退了钱：「我宁可少赚，也不想让你再进这道门。」",
            { rep: -1, contact: { doctor: -6 } }),
          critfail: out("他收了钱，第二天把所有东西都退给了你的对手，还附上了你的名字。",
            { fun: -6000, rep: -4, contact: { doctor: -18 }, flags: ["scandal_1"] })
        }
      },
      {
   ...
   * ======================================================================== */
  {
    ...
    grade: "mid", category: "shady", medium: ["print", "tv"],
    title: "工会的一声口令",
    ...
    brief: {
      ...
      known: [
        "你之所以能坐在这里：罢工投票那几天，你替他们守了三个通宵的登记台。这件事会员都知道。",
        "他的秘书在电话里说：「你为他们做过事，他想听听你想要什么。」",
        "他的会员里有八千人。他们不一定爱他，但初选那天他们会先看他怎么站。",
        "他真正要的不是钱，是「下一份合同里别把我们卖了」。",
        "他说话很短，而且不喜欢被奉承——被奉承过太多次了。",
        "他上个月刚和厂方谈崩一次，现在手里有火。"
      ],
      rumor: [
      ...
      unknown: [
        "他要的那个承诺，你会不会兑现。",
        "如果他和你对手先谈成，你还有没有第二条路。"
      ],
      terms: [
        { k: "背书", v: "一句话或一纸声明。它的价值不在于内容，而在于谁说的。" },
        { k: "动员", v: "把名单变成到场人数。这是基层政治里唯一真实的东西。" }
      ]
    },
    choices: [
      {
        ...
        outcomes: {
          crit: out("他站起来和你握了手，然后叫进来三个人：「以后这位先生的事，就是我们的事。」你那天带走的是一整套名单。",
            { rep: 9, fav: 1, fac: { labor: 22, base: 10 }, contact: { union_boss: 18 }, flags: ["union_backing", "street_army"] }),
          ok: out("他没说「支持」，只说「我们可以谈谈」。对工会来说，这已经是很重的话了。",
            { rep: 5, fac: { labor: 12, base: 5 }, contact: { union_boss: 10 }, flags: ["union_backing"] }),
          meh: out("他答应「考虑」，然后把你送到电梯口。你知道「考虑」是什么意思。",
            { rep: 1, fac: { labor: 3 }, contact: { union_boss: 2 } }),
          fail: out("他一眼看穿你在开空头支票：「你连自己那一关都过不了，拿什么给我签字？」",
            { rep: -4, fac: { labor: -14 }, contact: { union_boss: -12 } }),
          critfail: out("你承诺得太满，而他正好缺一个可以公开骂的对象。他的会员开始在报纸上认识你的名字。",
            { rep: -8, fac: { labor: -22, press: -10 }, contact: { union_boss: -24 }, flags: ["scandal_2"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("两小时后你记住了十七个名字，还有三个他们真正在意的问题。他最后说：「你是第一个问我们车间温度的人。」",
            { rep: 6, hp: -3, fac: { labor: 16, base: 8 }, contact: { union_boss: 16 } }),
          ok: out("你听完了。没拿到背书，但拿到了一个电话号码，以及他私人的一句忠告。",
            { rep: 3, fac: { labor: 8 }, contact: { union_boss: 9 } }),
          meh: out("你听了两小时，净听到抱怨。有一半是真的，另一半是习惯。",
            { hp: -2, fac: { labor: 3 }, contact: { union_boss: 3 } }),
          fail: out("你在第二十分钟就看了表。他看见了。",
            { rep: -2, fac: { labor: -8 }, contact: { union_boss: -8 } }),
          critfail: out("你中间接了一个电话。他等你挂掉，说：「看来有人比我更重要。」会议就这样结束了。",
            { rep: -4, fac: { labor: -14 }, contact: { union_boss: -16 } })
        }
      },
      {
        ...
        outcomes: {
          crit: out("你选了另一条路，而且走得很稳。后来你算了一笔账：工会这条路更短，但那两小时你换不回来。",
            { rep: 2, fac: { establishment: 8, commercial: 6 } }),
          ok: out("你没去工会大楼。你的支持者里少了一批人，但你的麻烦也少了一批。",
            { rep: 1, fac: { establishment: 4 } }),
          meh: out("你以为两边都能不得罪，结果两边都不太信你。",
            { rep: -1, fac: { labor: -4, establishment: 2 } }),
          fail: out("你的对手先去了。当他站在厂门口的照片见报时，你才明白自己错过了什么。",
            { rep: -4, fac: { labor: -12, base: -6 } }),
          critfail: out("你没去，但手下人替你传了句话，说「那位先生看不上工会」。话传到他耳朵里时已经不是原话了。",
            { rep: -6, fac: { labor: -18, base: -10 }, flags: ["scandal_1"] })
        }
      }
    ]
  },
   ...
   * ======================================================================== */
  {
    ...
    unique: true, grade: "major", category: "shady", medium: ["print", "tv"],
    ...
    brief: {
      ...
      known: [
        "下周表决的是市政服务外包合同——工会八千个岗位的去向就在这一票里。",
        "你现在是当事人：这一票怎么投，全楼都在看。",
        "当年那句「签合同的是我」，双方都没有忘记——包括报纸。"
      ],
      rumor: [
        "有人说他把你们的谈话录了音，就压在办公桌第二层抽屉。",
        "有人说对手已经开出了更好的价：一份不裁员的书面保证。"
      ],
      unknown: [
        "这一票之后，你要么多一个一辈期的盟友，要么多一个一辈子的敌人——工会两种都记得很清楚。",
        "录音存不存在没人知道。但从今晚起，你说话会开始小心。"
      ],
      terms: [
        { k: "市政外包", v: "政府把公共服务（清洁/维修/运输）交给私营公司做。省钱的另一面是工会岗位被替换。" }
      ]
    },
    choices: [
      {
        ...
        outcomes: {
          crit: out("你的发言把外包案挡在了委员会里。当晚工会大楼的灯亮到很晚——他们在给你写感谢信，八千份。", { rep: 12, fac: { labor: 25, base: 10, commercial: -12 }, contact: { union_boss: 20 }, flags: ["civil_win"] }),
          ok: out("票投了，案挡了。他只发来四个字：「下次再谈。」这就是他的「谢谢」。", { rep: 6, fac: { labor: 15, commercial: -8 }, contact: { union_boss: 10 } }),
          meh: out("你投了反对，但议案还是过了。工会知道你尽力了——这年头，「尽力」也算数。", { rep: 2, fac: { labor: 8 }, contact: { union_boss: 5 } }),
          fail: out("你的反对被对手做成了「为了工会损害纳税人」的广告。", { rep: -6, fac: { labor: 6, commercial: -8, press: -6 } }),
          critfail: out("表决前夜，你「被承诺给工会好处」的传闻见了报。合同过了，人情没了，名声也脏了。", { rep: -12, fac: { labor: -8, press: -10, commercial: 6 }, flags: ["scandal_3"] })
        }
      },
      {
        ...
        cost: { ap: 2 },
        outcomes: {
          crit: out("你拿着工会的票和商业的钱当筹码，逼出了一个「三年不裁」的书面修正案。两边的头条都在夸你。", { rep: 14, fac: { labor: 12, commercial: 8, establishment: 8 }, contact: { union_boss: 12 } }),
          ok: out("保证书签了，虽然细则含糊。他收下了：「比你前任强。」", { rep: 7, fac: { labor: 8, commercial: 4 }, contact: { union_boss: 7 } }),
          meh: out("厂方只肯给口头承诺。他听完你的转述，只说了一句：「至少你来传话了。」", { rep: 2, fac: { labor: 3 }, contact: { union_boss: 2 } }),
          fail: out("两边都嫌你骑墙：工会说你软弱，厂方说你多事。", { rep: -5, fac: { labor: -8, commercial: -5 } }),
          critfail: out("你私下对厂方说的「工会其实能接受裁员」被转述给了他本人。这栋楼，你真的不用再进了。", { rep: -10, fac: { labor: -25, base: -8 }, forget: ["union_boss"], notFlags: ["union_backing"], flags: ["scandal_2"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("合同高票通过，预算省了一截，商业派系给你递来了下一张支票。工会那边——你把手机调了静音。", { rep: 3, fun: 200000, fac: { commercial: 14, labor: -10 }, notFlags: ["union_backing"] }),
          ...
          fail: out("你投了支持票，对手把「背叛劳工」做成了整轮广告。你的选区里每一家工厂门口都贴着那张海报。", { rep: -8, fac: { labor: -20, base: -8 }, flags: ["scandal_1"] }),
          critfail: out("投票当天，工会会员把「他答应过我们」的旧传单重印了两万份，撒满了你的选区。签名是你当年的笔迹。", { rep: -14, fac: { labor: -25, base: -12, press: -8 }, forget: ["union_boss"], notFlags: ["union_backing"], flags: ["scandal_2"] })
        }
      }
    ]
  },
   ...
   * ======================================================================== */
  {
    ...
    grade: "major", category: "shady", unique: true, medium: ["print", "tv", "internet"],
    title: "钱进来之后，就洗不干净了",
    ...
    brief: {
      ...
      known: [
        ...
        "如果走非正常渠道，它可以变成一千笔小额捐款、一家咨询公司的服务费，或者一份演讲费。",
        "会计不怕做这件事，他怕的是你会不会在某个下午把他交出去。",
        "监管这一年很忙——它现在会把注意力放在比你这笔钱更大的地方。"
      ],
      rumor: [
        "有人说这笔钱真正的主人和你对手也见过面。",
        "有人说去年有一笔同样结构干净的钱，最后变成了一份起诉书。"
      ],
      unknown: [
        "这笔钱背后的人最终要买什么。",
        "如果有一天你需要把这笔钱吐出来，你吐不吐得出。"
      ],
      terms: [
        { k: "洗钱", v: "把不能见光的钱变成能见光的钱。技术上不难，难在之后你要一直替它保密。" },
        { k: "咨询费", v: "最常见的通道：付你一笔钱，你给一份没有任何人会看的报告。" },
        { k: "披露", v: "把来源写在纸上交给监管机构。写上去就等于把柄交出去。" }
      ]
    },
    choices: [
      {
        ...
        outcomes: {
          crit: out("一千笔小额捐款，每一笔都经得起查。竞选小组第一次不用算着钱花。你在夜里醒来过一次，然后又睡着了。",
            { fun: 1400000, rep: 8, lev: 1, fac: { commercial: 18, base: 6 }, flags: ["black_money", "launder"] }),
          ok: out("钱清了进来。会计把底稿锁进了一个你不知道的地方 —— 他说「这是为了你」，你选择相信他。",
            { fun: 900000, rep: 5, fac: { commercial: 12 }, flags: ["black_money", "launder"] }),
          meh: out("钱进来了，但花了半年才铺开，中间折损了两成。你既没干净也没快。",
            { fun: 520000, rep: 2, fac: { commercial: 6 }, flags: ["black_money"] }),
          fail: out("拆得不够散，一家小银行把几笔转账核在了一起。钱被冻结了四个月，你的竞选日程撞得粉碎。",
            { fun: -120000, rep: -6, fac: { commercial: -8 }, flags: ["scandal_2", "investigation_open"] }),
          critfail: out("会计把底稿带回家了。三个月后，那份底稿出现在一份传票的附件里。",
            { rep: -12, fav: -2, fac: { commercial: -16, press: -12 }, flags: ["scandal_4", "investigation_open", "launder"] })
        }
      },
      {
        ...
        outcomes: {
          crit: out("你把它原原本本写进了公开文件。三天之内有记者来查，查完之后写了一句：「这次是真的干净的。」这句话比钱值钱。",
            { fun: 700000, rep: 14, fac: { press: 16, base: 10, commercial: 6 } }),
          ok: out("披露了。钱变少了，麻烦也变少了。你睡得很好。",
            { fun: 420000, rep: 8, fac: { press: 8, base: 5 } }),
          meh: out("你披露了，但那笔钱的主人不喜欢被写在纸上。他把支票收了回去，还告诉别人你「不懂事」。",
            { fun: 60000, rep: 3, fac: { commercial: -10, press: 6 } }),
          fail: out("你以为披露就没事了，结果监管机构顺着披露又查了三个月。查完没事，但你这三个月什么也没干成。",
            { rep: -3, hp: -5, fac: { commercial: -8, press: 4 } }),
          critfail: out("披露的内容里有一笔你说不清去处的旧账。你本意是澄清，结果打开了一个更旧的口子。",
            { rep: -8, fac: { press: -10, base: -6 }, flags: ["scandal_3", "investigation_open"] })
        }
      },
      {
