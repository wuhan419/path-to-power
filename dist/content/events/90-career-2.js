...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    weight: 12,
    title: "「老板」要收你为徒",
    body: "他说他老了，需要一个「还记得自己为什么进来」的年轻人。翻译过来：他需要一双新的腿，你需要一把旧的伞——所谓保护伞：他替你挡事、给资源，价码是效忠。点了头，投票、站队、提名，都先问他。他给你两周答复，又警告：不要跟任何人谈这次会面。没人说得清他能替你挡多大的雨，以及哪天把伞收回去。",
    choices: [
      {
        id: "accept",
        text: "拜入门下：接过这把伞",
   ...
   * ==================================================================== */
  {
    ...
    body: "权力机关的第一课：法案在委员会生、在委员会死，全体表决只是盖章。名单由党团领袖用铅笔写，下周定稿——橡皮在谁手里，全议会都知道。你在议会的第一年没得罪过任何人，这意味着谁都可以先得罪你。有人说金融委员会要空出一位，头名正被罢免联署缠住。你在走廊里说的每一句话，此刻多半已经摆上了领袖的桌子。",
    choices: [
      {
        id: "lobby_hard",
        text: "全力活动：把名字写进黄金席位",
   ...
   * ==================================================================== */
  {
    ...
    weight: 11,
    title: "他们把你的地盘画没了",
    body: "新的选区地图公示了。你花了十年织起来的票仓，被一条曲线从中间剪开——你最铁的三个县被切进三个不同选区，这叫「蟹切」。地图委员会里坐着你党的人，他们知道这一刀落在谁身上。要反抗只有两条路：州最高法院申诉，或公民公投推翻，都要钱和时间。选民池会自动重算——在那之前你还有一个窗口期。被切走的铁杆选民还认不认你的名字，没人能提前告诉你。",
    choices: [
      {
        id: "fight",
   ...
   * ==================================================================== */
  {
    ...
    body: "「老板」的机器——以他为中心的人脉、名单、席位——只剩一口气，而且打算在同一周里交代完。两个候选人：你，和一个更老、更听话的人；他还没选。这三天你接到的电话全是试探：争、等，还是让。别忘了他还在位——逼太紧，他随时可以让两个人都拿不到。有人说，另一人手里攥着一份名单：这些年进出他门口的人和钱。你打的每一个电话，明天都会以另一个版本回到他耳朵里。",
    choices: [
      {
        id: "claim",
        text: "争：这个席位我要了",
   ...
   * ==================================================================== */
  {
    ...
    body: "新政府的过渡团队在筛人——他们同时在聊四个人，征询不等于任命。桌上有两个部：一个烫手，管钱、上镜；一个冷清，管档案和陵园，媒体和预算都照不到它，行话叫「冷衙门」。冷衙门没人盯，反而能安静把事做成。你的名字一进名单，党部、选区、捐款人的电话会一起来；而接受任命，就意味着把选区交给外人。任命轨道的高光时刻——也可能是被礼貌地放进陈列柜的时刻。",
    choices: [
      {
        id: "hot_seat",
        text: "争取那个烫手的部",
...

  {
    ...
    body: "半年前的那通电话把你带到了这里：蜜月期是六个月，今天是第七个月的第一天。新鲜感过了——出不了实绩，你的名字就会挪进「待优化」那一栏。你的部门出现在了改组名单上，据说要合并；当选人私下问过两次：那个人在干什么？而选区的桩脚只来过一次，聊的还是天气。这份工作比你以为的好，还是比你以为的冷——现在是清账的日子。",
    choices: [
      {
        id: "double_down",
   ...
   * ==================================================================== */
  {
    ...
    body: "你的身体先于日程表提出了动议：连续几个月每天睡四小时之后，手开始抖，人开始走神，你昨天叫错了捐款人的名字。未来三十天的日程上，没有一个空格留给「没有别人的时刻」。这圈子里没人同情「累」——一百个人排队想替你累。硬撑，退半步，还是把重量交给一个可以信任的人，必须选一个。你的身体哪天、以什么方式替你按下停止键，没人预告。",
    choices: [
      {
        id: "push",
        text: "硬撑：谁不是这么过来的",
   ...
   * 纹理：每段都有事发生、都有代价，且靠 flavor 占位符换真面孔。只给小额声誉/派系/人情/属性，绝不写 tier。 */
  {
    ...
    title: "你第一次主持一场像样的听证",
    body: "党把一场关于本地工厂要不要续牌的小听证交到你手上主持。厂里几十号家庭的饭碗指着这张牌，隔壁商户又一门心思指着它关门——两拨人都会到场。{PUB}派了个记者来。地方听证就是公开听取民意的程序，你的第一场练手台：议事规则只背了个大概，什么时候敲锤、谁先发言，全靠临场。背后有人想看你把事办成，也有人在等你出丑。",
    choices: [
      {
...

  {
    ...
    body: "一位党内前辈（{ORG}）托你出面，替一个不方便让建制派露脸的场合「说句话」，或挡下一项提案。没有文件，没有授权，只有一句「你懂的」。应下，你就把自己记进了一条不写在明面上的账；推掉，下次党要出力推你上位时，也会想起你今天的推。办成了，你在机器里的坐标前进一格；办砸了，脏的是你的手，功劳是别人的。机器记住的你，是「靠得住」还是「好用」？",
    choices: [
      {
...

  {
    ...
    body: "{PUB}的记者要跟了你一整天：从{MEET}到傍晚在餐馆里喝冷掉的咖啡，写一篇「本地新面孔」的人物侧写——跟随采访，靠细节和引语立人。头一回有人认真把你写成「人物」：这是台阶，也是靶纸，你说的每一句都可能被引用。稿子怎么写，一半在他笔里，一半在你这一天的言行里。",
    choices: [
      {
