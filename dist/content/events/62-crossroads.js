...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "学区委员会席位空出：门槛低，但得靠双腿一票一票磨。",
        "州参议员团队在招地区组织者：薪水一般，但天天见机器里的人。",
        "两件事不能同时做——竞选季是七乘二十四。"
      ],
      rumor: [
        "据说那位参议员赢面大，跟他的人两年后都能分位置。",
        "据说学区委员会上不了台面，但有人从这儿进了市议会。"
      ],
      unknown: [
        "走哪条路，决定你五年内遇到谁、欠谁人情。",
        "选择会被忘记，选择塑造的圈子不会。"
      ...
      terms: [
        { k: "学区委员会", v: "美国最基层的民选职位，管学校预算。" },
        { k: "地区组织者", v: "竞选团队的地方干员，盯志愿者和投票率。" }
      ]
    },
    title: "第一道分岔：选票还是工牌",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "你带的议题组织做成了两件本地实事，理事会开始谈扩大。",
        "州党机器递来橄榄枝：一个有薪职位，管三个县，条件听协调。",
        "联合创始人说：你去他不拦，但签名页会少一个名字。"
      ],
      rumor: [
        "据说党内职位是跳板，两年内两人从此升到州级任命。",
        "据说拿了基金会的钱就有基金会的议程。"
      ],
      unknown: [
        "党机器给的不是职位，是坐标系。",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "州参议院老议员退休：选区你熟、赢面实在，但版面只在本地。",
        "联邦众议院因重划裂出一个开放席位：全国目光、全国献金。",
        "顾问说得很直白：一个是大鱼小池塘，一个是小鱼大海。"
      ],
      rumor: [
        "据说重划地图是留的口子，金主要个自己人在华盛顿。",
        "据说州参那个席位是留给某家族的，你去就是搅局。"
      ],
      unknown: [
        "去华盛顿，从此活在两台绞肉机之间。",
        "留州府，握的是预算、地图这些实的权力。"
      ...
      terms: [
        { k: "人口重划", v: "每十年按人口普查重划选区。" },
        { k: "联邦众议员", v: "众议院成员，两年一任，全在竞选连任。" }
      ]
    },
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "有望拿提名的总统候选人请你进全国团队：高职、随行。",
        "同时你州州长席位将开放：民调你排第二，第一是现任的继承人。",
        "竞选经理把两页纸拍上桌：一页「跟人」，一页「自立」。"
      ],
      rumor: [
        "据说候选人名单上你是第三个地区主席，前两个已答应。",
        "据说那位继承人握有党内背书，但民调连跌三月。"
      ],
      unknown: [
        "跟对人回报指数级，跟错人只剩回忆文章。",
        "州长是总统的练兵场，也是流放地。"
