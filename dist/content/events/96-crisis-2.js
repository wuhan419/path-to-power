...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    body: "河水凌晨三点漫过了铁路涵洞。选区低洼的三个街区泡在水里，教堂的钟楼成了临时的指挥点。\n" +
      "现在才早上六点，救援最快也要中午到；抽水泵、沙袋、警卫队卡车都在往市里调，谁声音大谁先拿到。\n" +
      "牧师传了话：这三个街区的人正看着你来不来。你现在站在干的高地上，面前有三条路——水里、办公室里、镜头前。\n" +
      "水退之后，谁在水里、谁在镜头前，选区都会记住；重建合同两周内签出，有人已经先动了手。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    title: "最大雇主的通知只给了一页纸",
    body: "选区最大的厂今早在大门贴了通告：十八个月后关停，两千三百个岗位——这厂养了本地两代人，选区几乎一半的选票挂在名册上。\n" +
      "工会的头目中午就把电话打到了你的办公室：「我们现在需要知道，你站在哪一边。」他手底下是八百个会员。\n" +
      "总部远在千里之外，董事会的会议室里没有一把椅子是你的——但你的选区会看你怎么搬这些椅子。县里的筹码只有减税、基建、培训，每样都要有人牵头背期望。\n" +
      "厂关不关，你影响得了却定不了；有人说那块滨水地皮早就被评估过——空着比开着值钱。一年后，失业率会逐字核对今天的豪言。",
    choices: [
      {
...

  {
    ...
    body: "州劳工厅的季度数据出来了，本地报纸把它做成了头版：选区失业率百分之十一，比关厂前翻了一倍。你的对手已经查过这本账。\n" +
      "数字旁边配着你在那十八个月里说过的话——一句一句，像对账单。还有一些家庭仍挂在培训等待名单上，等的是你署过名的那几份申请。\n" +
      "有人说，新雇主的二期其实还在谈——只是要等选举之后才官宣。这一回你是被告还是证人，取决于你先开口讲哪一本账。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    grade: "major", valence: "bane", dyn: true, category: "crisis", unique: true,
    title: "县医院的走廊改成了隔离区",
    body: "疫情是从隔壁县传过来的，现在是你的事了。医院把走廊改成了隔离区，学校停课的通告印了一半。县医院的主治医生是你旧识，他要的只有三样：隔离配合、物资、一个肯出来说话的人。\n" +
      "药房限购，货架下午就空了；有人说疫情被夸大了——说这话的人自己囤了两柜药。所有人都在等一个人出来说话，习惯性地看向办公室里的人，哪怕是最低的那间办公室。\n" +
      "医生给的只是区间，你念出口的那个数字才会被当作准数。病会被忘掉，你说过什么不会。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    grade: "mid", valence: "bane", dyn: true, category: "crisis", unique: true,
    title: "全城黑了四分钟之后",
    body: "晚高峰，全城黑了。红绿灯死了，电梯停了，水厂两个泵站的备用电源没有自动切换——那份检修预算，你上周才签批过。\n" +
      "公用事业公司的电话占线：他们要五天工期、紧急拨款，费率是平时的1.8倍。应急管理办公室在等你表态：什么时候修好？钱从哪来？谁的责任？\n" +
      "这三个问题，答错任何一个都是政治车祸——而它们要的是同一个晚上的答案。有人说去年就有笔检修预算被挪去修了路，批文上有你的会签。你今晚报出的数字，就是标准答案。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "先是经济版的传闻，然后是停车场里的口耳相传。星期五早上七点，选区那家银行门口排了两百人——这家行握着选区一半家庭的存款：工资户、教会账、小店周转金。\n" +
      "柜台后面的现金撑不过中午。挤兑不需要银行真的资不抵债——恐慌只需要一个开头，和一个没人出面的上午。监管的通道有，但很慢，而周一是发薪日。\n" +
      "经理不要你救银行，只要一个大家信的人出来说一句「我也存这」。有人说银行把存款押在了贬值资产上，传闻一天翻三种。你接下去的每句话，要么止住队伍，要么立一块墓碑。",
    choices: [
      {
