...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "新法案生效一年多，调阅的权力长成了机器：禁飞与加查名单从联邦下发到本地机场柜台，\n" +
      "反恐拨款的附加条款写进了县警长的预算表——那笔钱要过你的签字才落得下来。地方执法领了联邦的案件编号当「反恐联络」。\n" +
      "社区里开始有人小声说话：谁在关口被拦下盘问了半小时，谁的执照多审了一轮。有人说名单上早过了十万人，多数是错认。当初联邦来调阅时你站的位置，两边各记了一本账——现在，两本账同时来敲你的门。今天点头开的路，将来查的是谁的户口。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "开战时的「确证」一件也没有落地，检讨报告一份一份印出来，结论都是那句：依据的是有问题的材料。\n" +
      ...
      "党里已经递过话：别解释，别接话。还有人说，一批原始情报至今没有解密。这一次，掌声不在你这边；要不要接这盏灯，才是你的选择。你今晚的说法，明年的听证会会逐字照读。",
    choices: [
      {
