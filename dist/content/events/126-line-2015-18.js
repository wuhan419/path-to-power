...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "六月末的一个早晨，九位大法官以五比四写下结论：婚姻权不因性别而两样。南方几个县的法院门口当天排起两队人——领证的，和举标语的。\n" +
      ...
      "裁定已生效，两拨人都要你在四十八小时内定性；你能改的只有措辞，不是结论。教会要的宗教豁免（以信仰为由拒绝执行平等规则），初选里还会被人一遍遍拿出来问你。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一场晚间祷告会被人打断，多名会众死在自家教堂里。凶手最爱拍那张旗子，照片当天挂遍全网。\n" +
      ...
      "那面旗是南方联邦军队的战旗，如今被普遍读作种族符号。撤旗要走程序，程序此刻在你手上，也可以拖；州里两党的领袖都在等一个本地人先开口。有人说上面早已内定，只缺一个背锅的人。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "为了省下一笔钱，城里的水改从河上取，防腐处理没跟上，管垢里的铅顺着水龙头进了家家户户。\n" +
      ...
      "州府的检测报告显示铅含量偏高。宣布紧急状态（一宣告就能调联邦资源与钱）要的是政治决心；而公开哪批数据，此刻按在你手里。有人说上面早知道，只是没人肯签字。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "城里的夜店在一夜之间成了全国守夜的地方，那家把很多人当家人的铺子再没开门。同一周，州府的拥枪队伍也如期上路。\n" +
      ...
      "动机与他同外界极端势力的关联还在查，没人敢先定口径。本地那家夜店和几家社区组织都在等你的电话。有人说对手早已备好稿子，只等你踩上去。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一封信、不到半天，局长在海外出差时被免了职。原本压在底下的那桩对外调查，一夜之间变成广场上的口号与电视台的辩论。\n" +
      ...
      "免职的说法前后对不上，文件一份也没公布；议会的委员会已在酝酿传召现任官员。有人说换人是想让那桩调查自己降温——这个窟窿会不会长成一个独立调查，就看今晚用哪个词。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一场「统一派」集会把火炬与呐喊带进大学城的夜晚，次日有人开车冲进人群。全国等一句定性，等来的是「两边都有错」。\n" +
      ...
      "集会要许可，镇上的治安归你协调；全国的口径已经定了，地方只能跟或者先跑。有人说对手手里攥着你从前的照片，只等你失态。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一场雨下了一整周，一座城的水位过了屋顶；两周后另一场风把海岛刮回柴油发电机的时代。\n" +
      ...
      "重大灾害宣告要州里申请、联邦核准，资金与调度才放行；警卫队能出动，但得地方开口去请。你选区的收容点已经超员，教堂在收人。有人说重建合同早已批给外州的公司。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一所在职员工与警长互相推责的中学，一夜之间成了全国少年游行的起点；三月那几天，几十座城市同时停课。\n" +
      "拥枪的县、要退出的捐款人、你手机上那条要你「做点什么」的视频，同时在催你。\n" +
      "州议会会期只剩六周，票还没人算过，学生组织者已经约好见你的时间。升龄售购——把购枪年龄从十八提到二十一——是党里没人肯先碰的那条线。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "今年报名参选的人数创下几十年纪录，其中相当一部分是第一次参政的教师、护士与少数族裔女性。一张选票同时改写着两党的面孔。\n" +
      ...
      "本党地方名单一夜多出十几张新面孔，动员机器按人分配，先表态的先挑。你的位子安全，党内的位次不安全。",
    choices: [
      {
