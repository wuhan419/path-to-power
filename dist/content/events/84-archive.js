...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "这份卷宗不在正式序列里：档案室自己的账上也查不到它。",
        "它被人抽出来过：抽它的人想让它留在系统里，却不想被顺着查。",
        "卷宗里有三个签名，其中一个是你所在党内的一位老人。",
        "归档员两点半回来。你还有一小时零十分钟。"
      ],
      rumor: [
        "有人说这条街上有两个人一直在等这份东西被翻出来。",
        "有人说它没被销毁，是销毁它的人自己也要留一份。"
      ],
      unknown: [
        "这上面的签字到底能不能证明什么。",
        "第一个翻到它的人，最后是什么下场。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      terms: [
        { k: "被反噬", v: "你查别人时，别人也在查「谁在查」。" },
        { k: "冷处理", v: "收起来、暂停一切动作。往往最有效。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      terms: [
        { k: "摊牌", v: "双方都亮手里的牌：结束猜测，不结束冲突。" },
        { k: "一次机会", v: "把柄换的让步没有第二次：这次说清楚。" }
      ]
    },
    choices: [
      {
