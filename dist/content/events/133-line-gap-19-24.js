...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "二月，一份十年期「气候与工业动员」决议被摆上众院案头：电力侧近零碳、基建与再培训捆绑拨款。它不是能过关的法案，却先把党切成两截——沿海新人抢着联署，靠化石能源吃饭的州议员夹在连串电话与听证之间。一个刚成军、只占几席的小集团，一夜之间既是盟友，也是标靶。",
    brief: {
      lede: "这不是一场表决，是一次路线点名：你署不署名，初选的价码就重新称一遍。",
      known: [
        "决议只是共同决议，不进表决，只把议题钉上议程。",
        "联署要趁早：慢一步，小集团就把你记进对面。",
        "能源州的电话与厂矿的捐款，同一天塞满你信箱。"
      ],
      rumor: [
        "有人说参院那头根本没打算给这案子排期。",
        "有人说白宫已备好一套更软的版本来踩刹车。"
      ...
      terms: [{ k: "共同决议", v: "只表达立场、不送行政签署的会案。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "入夏到入秋，一位前总统先被联邦特别检察官起诉，随后又被一州检方以干预选举另案起诉：文件、密件、选票，数十项罪名与竞选集会同档期出现。本党喊「迫害」，对手喊「问责」。宪法第三条与第十四条第三款，头一回被当成初选资格问题摆上台面。",
    brief: {
      lede: "起诉书和集会海报贴在同一面墙上：你怎么命名它，就是你怎么报的名。",
      known: [
        "两案分属联邦与州两条线，程序各自独立推进。",
        "本党初选已被这两纸起诉书重新点燃。",
        "第十四条第三款能否套用，学界此刻两边都有人背书。"
      ],
      rumor: [
        "有人说州案在等一个大选前的排期。",
        "有人说本党筹款邮件已把「迫害」做成招牌。"
      ...
      terms: [
        { k: "第十四条第三款", v: "参与叛乱者不得任公职的条款。" },
        { k: "特别检察官", v: "独立于常规检察线的起诉人。" }
      ]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "七月，最高法院以六比三裁定：总统的官方行为享有刑事追诉豁免，能不能起诉要按下级法院对「官方还是私人」的划线重来，原案发回。同月，执政党发生罕见的选举年换人——在任者退选、副手接棒。豁免划了线、换人开了闸，两条线一起压进秋天的选票。",
    brief: {
      lede: "豁免划了线，换人开了闸：这个夏天两次定调，都在为秋天的大选重新标价。",
      known: [
        "裁定是六比三：核心官方行为绝对豁免、其余可查。",
        "案发回下级，赶不赶得上选前开庭没人打包票。",
        "新提名要在八月的党代会上才正式定死。"
      ],
      rumor: [
        "有人说新提名的班底名单已在私下过筛。",
      ...
      terms: [
        { k: "发回重审", v: "上级把案退回下级另作认定。" },
        { k: "官方行为", v: "以总统职权所为，与私人行为相区分。" }
      ]
    },
    choices: [
      {
