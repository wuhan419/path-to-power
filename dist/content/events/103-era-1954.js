   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        ...
        "商会对罢乘恼火（ downtown 生意受影响），种族主义议员想给它扣「外部煽动」的帽子。"
      ],
      rumor: [
...
POTUS.define("balance", {
  tagNames: {
    early_correct: { name: "先见之明", desc: "在麦卡锡塌台前就敢和他切割。", effect: "建制与舆论认可你的嗅觉，但你被贴上了「会看风转」的标签。" },
    loyal_to_a_loser: { name: "对失势者忠诚", desc: "在最不划算的时刻替麦卡锡说过话。", effect: "保守核心念你的情，主流与舆论长期不信任你。" },
    named_names: { name: "点过名字", desc: "在忠诚听证上供出他人换自保。", effect: "你的档案里有了这一笔，随时可能被人翻出来当把柄。" },
    refused_to_name: { name: "拒绝攀咬", desc: "宁可自证也不点别人名字。", effect: "公信力大涨，是日后吹哨、作证类判定的加分项。" },
    civil_ally: { name: "民权同道", desc: "在高压年代护住了一场罢乘。", effect: "基层、教会与民权派长期把你当自己人，建制对你有戒心。" },
    book_defender: { name: "护书人", desc: "为几本「红书」说过话。", effect: "知识与舆论圈记得你，但也给你招来过一次「可疑」的打听。" }
  }
});
