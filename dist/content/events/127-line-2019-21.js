...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "因那通要求乌克兰总统「查一查对手党领选的前副总统」的电话与冻结的军援，9 月众议院启动调查；12 月 18 日，两条弹劾条款（滥权与挡国会）沿党派线表决通过，在任总统成了史上第三个被众院弹劾的人（弹劾是众院定罪、参院审判，不等于罢免）。\n" +
      "白宫称这是政变，反对党说是宪政自救，审判将移师参议院——议事规则归参院多数党领袖定，结局被普遍认为已写好。本地报要你今晚表态，两党的电话都在响：这一站不是法律问题，是 2020 大选的预演；你今晚说的每句话，整年都会被反复重播。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "12 月送到参议院的条款，2 月 5 日原样掷回：两条都未过三分之二，证人一个没传。白宫开起了庆祝会，众议院议长说「历史会记住这次掩盖」。\n" +
      "国家没翻页，只是把这页塞进了投票箱。初选季已经进账，各路人马都在重算：去冬你的姿态，今春值多少钱。也有人说赦免的谈判已谈到下一任提名，有人早把你归了档。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "周六，边境城市的沃尔玛死了 23 人，网上留着一篇斥「入侵者」的宣言，枪手开了几百公里只为挑这家店。周日，俄亥俄州代顿的酒吧街又响起枪声：10 死，凶手 30 秒内被击毙。\n" +
      "全国第三次为同一件事点蜡烛。守夜会的蜡烛还没吹灭，你选区的拥枪户与幸存者家属已各占半场，明晚镇厅都要你到场：一方说语言带血，一方说枪保命。州里的红旗法——法院可临时收走高危者的持枪权——与背景审查，就是明晚的撕扯点。你明晚选的每个词，都会被两边逐字引用。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "3 月 11 日，世卫宣布大流行；白宫当晚还在说「风险很低」，两天后联邦进入紧急状态（由此解锁联邦应急资金与调配权），股指两周内第四次触发停牌熔断。检测与口罩都靠医院自制，而复活节彩蛋游行没几个人宣布取消。\n" +
      "你选区的医院在逐台清点呼吸机，州里说「自己想办法」。真实感染数没人知道——包括官员自己。你还有一个多星期——在感染潮撞上门之前，决定先吓谁：是经济，还是人命。你现在开口，一个月后不是先知就是恐慌贩子。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "5 月下旬，明尼阿波利斯，一名黑人男子被警察跪压近九分钟后再没起来。视频三天传遍全国，四名涉事警察当天即被解职，联邦民权调查已介入。数百座城市走上街头，多数和平，少数几条街在烧，国民警卫队进城。\n" +
      "你所在城市的街面同样紧绷：年轻人要你同跪——NFL 球员带起来的静默抗议姿势——商户要你「周五前恢复秩序」。这个夏天的每个选择，都会被记进明年选战的底稿：你站哪头，另一头就记到哪。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "疫情年投票率冲上一百多年来的高点，几千万张邮寄票要数上好几天——邮寄票后点按州法本就是常规，不是丑闻。选前民调几乎一边倒，可开票夜的「领先」随拆箱顺序反复翻转；多数媒体尚未作决，在任总统已宣布自己赢了，并指控「舞弊」。摇摆州——归属难料、赢者通吃选举人票的州——领先不到一个百分点，重算悬而未决；数十宗诉讼在法院排队，计票官员收到威胁。\n" +
      "两党的电话同时打给你。今年这一题已不只是谁赢，而是输了的人认不认。你今晚站哪队，一月就替谁挡刀。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "1 月 6 日，两院集会点算选举人票——这本是仪式程序——现任副总统到场主持。下午，总统的集会变成冲卡：人群翻过围栏、闯进圆顶，会议中止，两院疏散。离国会不到一公里的增援，批文等足两个小时才到。当天四人死亡，一名警察次日伤重不治。深夜两院复会，计票在凌晨完成。\n" +
      "直播镜头钻进国会走廊的同时，也钻进了你家客厅。你的话机被打爆：一半人说这是爱国，一半人说这是叛乱——他们都要你说个词。你今晚点谁的名，下轮提名就轮到谁点你。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "3 月 16 日夜，亚特兰大近郊三家按摩店接连响起枪声：8 人死亡，其中 6 名是亚裔女性。枪手次日落网，对警员说「我有性成瘾，我只是想结束诱惑」。当地警长第一时间定性「心理健康问题，非仇恨犯罪」，联邦按仇恨罪方向介入调查。\n" +
      "被疫情污名折腾了一整年、铺面一年内关了三成的亚裔商户，这次把请愿信直接递到你案头。你的信箱同时收到另一封金主的提醒：别把这桩事「政治化」。你陪哪边的灵，那边会记你很久。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "撤军期限定死在 8 月 31 日；盟友政府十天内崩盘，总统携巨款出逃，8 月 15 日喀布尔易手，几乎没打巷战。机场闸口外几千人追着舱门；26 日门外自杀式爆炸，13 名美军与逾百阿富汗人丧生；30 日最后一架运输机起飞。\n" +
      "你所在州有替美军当过翻译的难民家庭——「本地雇员」，替美军与使馆做过事、城破后等着被清算的人。材料卡在安检一侧，使馆已暂停放行。老兵组织分两拨找你：一拨要你把人接出来，一拨要华盛顿为此负责。有人说情报圈一周前就判了「政府会掉」。撤离按小时计，名单按关系排。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "集装箱船在外海排队两周，洛杉矶与长滩港头一回宣布 24 小时运转，货还是动不了。9 月消费者物价指数（CPI，通胀的头牌指标）同比涨 5.4%，十三年来最高；卡车司机与仓管成了最抢手的人。圣诞玩具与感恩火鸡，新闻管这叫「供应链」，店铺的账本管这叫「缺货」。\n" +
      "选区老板们催你给句话。反对党已经磨好了一个词：「都是你们搞的」。谁先把这轮涨价叫对名字，2022 年的话语权属谁。",
    choices: [
      {
