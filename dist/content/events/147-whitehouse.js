...
POTUS.define("event", [
  ...
  /* ================= 危机族 ================= */
  {
    ...
    body: "国家安全顾问站在你的床边，话说得很快：飓风比预报提前了，东岸三个州进入紧急状态，而联邦预警的自动拨号系统凌晨升级失败。州长们在电视上说「我们需要白宫」。距离登陆还有十八小时，你的第一句话会在半小时后传遍全网。联邦应急体系的按钮很多，能一次按对的组合只有两三种；任何犹豫都会被剪成那三十秒的「总统不在状态」。",
    choices: [
      {
...

  {
    ...
    body: "食品监管局局长把两份草案放在你桌上：全国召回，或者仅限已发病的四个州。全面召回的账单白宫当场买单，只限四州一旦外溢就成了你知情不报。三家代理商已经请律师放话要告到底；两家报纸嗅到了味道，正在问为什么现在才说。实验室最后一项复核要三天。",
    choices: [
      {
  ...
  /* ================= 立法族 ================= */
  {
    ...
    body: "法案在委员会过了，参院还差七票。多数党领袖给了三条路：你在玫瑰园请那七位参议员一个个吃饭，一次两小时，七个人要一整个月；他替你谈，条款归他定；或者你签行政令，把这件事先做起来，让国会以后自己追——可此后每一任都会被拿它跟你比。记者已经在猜第一条路你会不会走。",
    choices: [
      {
...

  {
    ...
    body: "拨款法案在众院过了，参院按自己的版本退了回来，两版之间只差那一笔附加条款。接受它，门开得成，但那笔钱以后年年要还；硬扛关门，省下的钱由国家公园和联邦雇员替你付。预算授权三十六小时后到期。国家动物园的饲养员已经在问下个月工资从哪儿发，而两党党鞭都说：先眨眼的是你们。",
    choices: [
      {
  ...
  /* ================= 外交族 ================= */
  {
    ...
    body: "凌晨两点四十，国防部长报告：对方一支弹道导弹潜艇编队离港，未走通报渠道。卫星图像有两种解释——例行轮换，或者一次前推。参联会建议把戒备升一级；情报局长建议再等六小时；而莫斯科那条红色的线就在你桌上，接通要三分钟。只是，一次建立在误判上的通话，比一次沉默更贵。",
    choices: [
      {
...

  {
    ...
    body: "专机落地时礼兵已经列队。东道国的外交部长私下提醒你：谈判桌上还剩两条硬条款，主人希望你先出席已公布的仪式。你的行程表上有三个空格，而国内媒体只在等一句「成果」。插一站当地的学校或医院，舆论见效最快，也最容易被说成作秀。",
    choices: [
      {
  ...
  /* ================= 人事族 ================= */
  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "internet"],
    title: "四十八小时和一个名字",
    body: "辞呈只有一行字，理由写「个人原因」，而新闻已经猜到是上周那场预算争吵。参院军事委员会主席打电话来问：明天上午能不能听到名字？你桌上有两个人选：一位是跟着你八年的竞选幕僚长，从没进过五角大楼——他听得懂你的话，可听证会上他的每一次口误都算你的；一位是退役四星上将，党内人人都尊敬他——建制满意，代价是他此后有自己的票仓。",
    choices: [
      {
...

  {
    ...
    body: "他推过来一杯茶，然后说：我们有一个人的名字，他承认了拿总统府的关系谈过两笔生意；稿子下周三见报。他想要的不是许可，是一段你的话——你可以说「我不认识这个人」，也可以说别的。别忘了，「总统拒绝回应」本身就是一种答案。窗外两位摄影记者已经在等你的车出来。",
    choices: [
      {
