 ...
 * 铁律见 docs/EVENT-WRITING-BRIEF.md；投资型回报用 funMul，消费型 ok 档给非钱回报。
 * ==========================================================================*/
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你连着三天站在那扇门上，队伍真的散了。银行撑过了挤提，你的名字和本城的「稳」字绑在了一起。",
            effects: { rep: 15, fac: { base: 16, commercial: 8 }, flags: ["dep_anchor"] } },
          ok: { body: "你劝住了大半人。银行撑过来了，没全信你，但也没忘了你那天站在门口。",
            effects: { rep: 8, fac: { base: 10, commercial: 4 } } },
          meh: { body: "喊了两天，人还是取了钱。银行勉强没倒，你嗓子哑了，落一句「他尽力了」。",
            effects: { rep: 3, hp: -3, fac: { base: 4 } } },
          fail: { body: "你稳住了场面，可第四天银行还是贴了封条。取不到钱的人想起了你劝他们别取的话。",
            effects: { rep: -6, fac: { base: -10, commercial: -6 }, flags: ["scandal_1"] } },
          critfail: { body: "封条贴上那天你就明白：这家银行早在你喊话前就已经空了。你替一个空壳稳住了人群，成了最后一根稻草的替罪羊。",
            effects: { rep: -13, fac: { base: -16, commercial: -10 }, flags: ["scandal_2", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你在贴封条前取空了自己和几家老朋友的存款，安排得滴水不漏。钱保住了，朋友把这份人情记了一辈子。",
            effects: { fun: 120000, fav: 3, contact: { fixer: 10 }, fac: { commercial: 6 } } },
          ok: { body: "你把该取的钱取了出来。别人亏，你没亏，只是走在街上开始有人多看你了。",
            effects: { fun: 80000, fac: { commercial: 3 } } },
          meh: { body: "你取到了一部分，队伍太长，剩下的卡在闸里。你只保住了自己那点。",
            effects: { fun: 20000, rep: -2 } },
          fail: { body: "你取钱的消息先漏了出去，反倒给银行招来更大一波挤提。你既没多保住钱，又背了「放风的人」的名。",
            effects: { fun: 30000, rep: -5, fac: { base: -8, commercial: -6 } } },
          critfail: { body: "你跑得太早也太张扬，被拍到你从后门搬钱箱。储户的钱没保住，你的名声先保不住了。",
            effects: { fun: 40000, rep: -11, fac: { base: -14, press: -10 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你和排队的街坊在冷里聊了一整天，把彼此的难处摸清了。你手上没有钱，却有了一份谁也拿不走的「知道谁在挨饿」的名册。",
            effects: { rep: 4, fac: { base: 8, labor: 5 }, flags: ["knows_hunger"] } },
          ...
          critfail: { body: "你取不到钱，又被人堵在队伍里质问。第二天，「他也取不出」成了整条街唯一的笑话。",
            effects: { rep: -6, hp: -3, fac: { base: -8, commercial: -4 } } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你把老兵的请愿当面拍在市长桌上，还带着两家报纸。清场暂时收了手，你的名字和「替穿军装的人说过话」连在了一起。",
            effects: { rep: 10, fav: 1, fac: { military: 14, base: 8, establishment: -6 }, flags: ["veteran_friend"] } },
          ok: { body: "你既稳住了营里，又把诉求递了上去。钱没马上发，但清场缓了一缓，两边都还认你。",
            effects: { rep: 6, fac: { military: 8, base: 5 } } },
          meh: { body: "你两头传话，两头都觉得你在拖。营地散了，你什么实质也没换来。",
            effects: { rep: 2, fac: { military: 3 } } },
          fail: { body: "市政厅用你的名义安抚了两天，然后趁夜清了场。老兵发现你「原来也是他们的人」。",
            effects: { rep: -6, fac: { military: -12, base: -8 }, flags: ["scandal_1"] } },
          critfail: { body: "清场时起了火，有人把「煽动」的帽子扣到你头上，因为你之前进过营。你没救成他们，还差点把自己搭进去。",
            effects: { rep: -10, hp: -3, fac: { military: -14, establishment: -8 }, flags: ["scandal_2", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你替市政厅把场面说得体体面面，老兵悻悻散去。市长在党内名单上给你记了「关键时刻靠得住」。",
            effects: { rep: 4, tier: 1, fac: { establishment: 12, military: -12 } } },
          ok: { body: "你劝散了营，没动粗。上层满意，老兵不骂你，只是不再信你。",
            effects: { rep: 2, fac: { establishment: 8, military: -8 } } },
          ...
          fail: { body: "你替当局劝场，第二天骑警还是冲了。照片里老兵抱着军旗倒地，你那句「散了吧」成了帮凶。",
            effects: { rep: -6, fac: { military: -14, base: -8 }, flags: ["scandal_1"] } },
          critfail: { body: "营地在「你劝散之后」被烧，有人说正是你拖住的这些人错过了撤离。这条账砸实了砸到你头上。",
            effects: { rep: -11, fac: { military: -18, base: -10, press: -6 }, flags: ["scandal_3"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你没说一句政治话，只是连夜把几个病号和孩子送到了亲戚家。这事没上头版，可营里每个人都记住了你的名字。",
            effects: { rep: 6, hp: -3, fac: { base: 8, military: 8 }, contact: { doctor: 8 } } },
          ok: { body: "你帮着安置了几个人。政治的事你没碰，人道的事你做到了。",
            effects: { rep: 3, fac: { base: 4, military: 3 } } },
          meh: { body: "你帮了几个，帮不完。忙了一夜，第二天营照样被清。",
            effects: { rep: 1, hp: -4 } },
          fail: { body: "你的「悄悄帮忙」被两边都看见了：当局说你通营，营里说你不够意思。",
            effects: { rep: -3, fac: { base: -4, establishment: -4 } } },
          critfail: { body: "你替一个病重老兵找的住处出了事，他被当成「逃跑者」抓了回去，罪名算到你头上。",
            effects: { rep: -6, fac: { military: -8, establishment: -6 } } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        cost: { fun: 40000 }, req: { fun: 40000 }, stake: { fun: true, ap: true },
        outcomes: {
          crit: { body: "路在冬天前修通了，公款陆续到账，你垫的钱连本带利回到你账上，还顺手把沿线的选民变成了你的铁杆。",
            effects: { funMul: 1.4, rep: 8, fac: { labor: 12, base: 10, establishment: 6 }, flags: ["works_chief"] } },
          ok: { body: "路修好了，钱回本了，工头们记住了你这个「不欠薪的牵头人」。",
            effects: { funMul: 0.7, rep: 5, fac: { labor: 8, base: 5 } } },
          meh: { body: "拖拖拉拉总算收了尾，款子勉强盖住你垫的钱。修是修成了，没人特别念你的好。",
            effects: { funMul: 0.25, rep: 2, fac: { labor: 3 } } },
          fail: { body: "款子在半途断了，材料钱打了水漂，工人堵着你要工钱。路没修完，你先欠了一身。",
            effects: { funMul: -0.7, rep: -5, fac: { labor: -10, base: -4 } } },
          critfail: { body: "工程烂尾还出了塌方伤人的事。审计顺着新政的公开账目找到了你的名字：「就是他垫的、就是他管的」。",
            effects: { funMul: -1.0, rep: -11, hp: -3, fac: { labor: -14, establishment: -8 }, flags: ["scandal_2", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "包工头把事干成了，你挂着督办的名分收了工头递来的一份「辛苦钱」，还不用垫一分钱。",
            effects: { fun: 40000, rep: 4, fac: { commercial: 6, labor: 3 } } },
          ok: { body: "路修好了，你署名督办，谁也没亏着。稳妥的一手。",
            effects: { rep: 3, fac: { base: 4, commercial: 3 } } },
          ...
          critfail: { body: "包工头跑了，还带走了一份写着「督办知情」的字据。这顶「挂名」的帽子，突然有了分量。",
            effects: { rep: -9, fac: { establishment: -10, base: -6 }, flags: ["scandal_2", "investigation_open"] } }
        }
      },
      {
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你帮着支锅、给熟人多舀了一勺，照片上你的袖子是脏的。这张比任何竞选海报都管用。",
            effects: { rep: 6, fac: { base: 10, press: 5 } } },
          ok: { body: "你在队里干了一上午。累，但街坊说「他没架子」。",
            effects: { rep: 3, hp: -2, fac: { base: 5 } } },
      ...
      },
      {
        ...
        outcomes: {
          ...
          fail: { body: "你躲镜头的样子被拍了个正着，标题是「他不敢从队伍前走」。",
            effects: { rep: -4, fac: { base: -6, press: -4 } } },
          critfail: { body: "你夺路而走还撞翻了一个排队老人的桶。这一幕被画成了整版漫画，从此跟着你。",
            effects: { rep: -7, fac: { base: -10, press: -8 }, flags: ["scandal_1"] } }
        }
      }
    ]
  }
