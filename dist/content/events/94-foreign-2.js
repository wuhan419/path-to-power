...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "代表团的名单上有你的名字——排在最后一位，但它在。",
      known: [
        "州贸易代表团下周出访：农业、机械、几家找海外买家的企业。",
        "你因帮过其中一家跑手续被塞进名单——管行李、签到、凑翻译。",
        "正式饭局有座次；但大堂、签到队、迟到巴士才是换名片处。"
      ],
      rumor: [
        "据说大使出席头晚酒会，记得每个名字，包括拎包的。",
        "据说商务参赞手里有一笔「友谊采购」额度，看心情给。"
      ],
      unknown: [
        "同机的无名之辈，十年后可能是那边的部长。",
        "你以为的闲聊，可能已在另一份简报里归档。"
      ...
      terms: [
        { k: "贸易代表团", v: "政府或半官方出访团，替本国企业开门牵线。" },
        { k: "商务参赞", v: "使馆里管贸易与投资的外交官。" }
      ]
    },
    title: "你被列进州贸易代表团的出访名单，排在最后一位",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "那张支票的抬头是你没听说过的国内公司——介绍人却带着外交部的口音。",
      known: [
        "你竞选账上吃紧，老熟人领来一位中间人，要送一笔钱。",
        "外国政府不得给美国竞选出钱——但「间接」两字可钻。",
        "对方花样很多：美国子公司、本地合伙人、绿卡者联名。",
        "他们要得很含糊：只请你「多了解问题」，并留了电话。"
      ],
      rumor: [
        "据说那家公司去年才注册，地址是间共享办公室。",
        "据说钱真正来的国家，和账面写的不是同一个。"
      ],
      unknown: [
        "这笔钱自带的不是利息，是账本。",
        "那四个字早晚会变成「你拿过我们的钱」。"
      ...
      terms: [
        { k: "外国献金禁令", v: "外国政府与公民不得向美国竞选捐款或转手。" },
        { k: "白手套", v: "替出资方出面签字走账的名义人。" }
      ]
    },
    title: "有人要通过合法渠道给你的竞选送一笔外国钱",
    ...
    choices: [
      ...
      },
      {
        ...
        note: "干净，而且是一次表态。情报机构会记你一笔好账——但你从此也在某些名单上了，两边的。",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "他记得你女儿的钢琴比赛名次——你只在电话里跟妻子提过一次。",
      known: [
        "某国使馆文化参赞三个月「偶遇」你四次：讲座、晚宴、餐馆。",
        "他从不问机密，只聊人事、日程，聊完总留点小礼物。",
        "外交圈老话：文化参赞十个有九个半是情报口的。"
      ],
      rumor: [
        "据说反谍部门早就注意他，并在看他跟谁吃饭。",
        "据说他打网球的俱乐部里有两位参议员。"
      ],
      unknown: [
        "盯着他的人，从此也看见跟他吃饭的你。",
      ...
      terms: [
        { k: "文化参赞", v: "使馆里管文化交流的外交官，享外交豁免。" },
        { k: "反谍", v: "反间谍：盯外国外交人员的接触网。" }
      ]
    },
    title: "外国使馆的文化参赞对你格外友好",
    ...
    choices: [
      ...
      },
      {
        ...
        note: "把暗的变成明的。情报机构会记你的坦诚——代价是每次饭局前后你都要多写一份「作业」。",
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      known: [
        "联邦把下一批难民分到你的辖区：八十到一百五十人。",
        "安置机构要你「出现在欢迎现场」，一句话能募到一冬的冬衣。",
        "选区选民已吵翻：一半「欢迎」，一半「谁问过我们」。"
      ],
      rumor: [
        "据说名额没定死——县里说「困难」就能分流。",
        "据说反对帖有一半来自同三个账号。"
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "请柬是烫金的，麦克风是开着的——这时外交官也得背稿。",
      known: [
        "有声望的国际论坛请你发言，名字排在参议员与州长之间。",
        "「就任何议题说几句」，意思是啥都可能被记录。",
        "台下坐着媒体、大使和几家智库的人。",
        "通讯主管备了两版稿：一版只有赞美，一版有观点会锋利。"
      ],
      rumor: [
        "据说主办资金里有一两个来源让国务院皱过眉。",
        "有代表团想借机「非正式接触」，名单上有你。"
      ],
      unknown: [
        "台下有人等你出错，有人等你讲完递合作书。",
      ...
      terms: [
        { k: "国际论坛", v: "定期多边会议，言论默认可公开。" },
        { k: "非正式接触", v: "外交黑话：不在日程表上的会面。" }
      ]
    },
    title: "一个国际论坛请你上台发言",
