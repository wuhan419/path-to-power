...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "开战三周，巴格达陷落，雕像被拉倒的画面循环播了一整周。五月一日，总统穿着飞行服降落在航母甲板，身后挂着「任务完成」（宣布对伊主要战事结束）的横幅。「志愿联盟」（未经联合国授权的多国集合）成了最体面的词，支持率正冲峰值。\n" +
      "党部催你出席庆功集会——你早前替这场战争递过支持；本地电视台在找「胜利者」的脸。占领区断水与抢劫的新闻，此刻还排不进晚间头条。有人说五角大楼根本没写完战后方案，而你今晚站的姿势，会跟你很多年。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "十月七日，加州完成史上第二次州长罢免（选民提前投票解除民选官员的程序）：选票上一百三十五个名字，赢的那个从没当过任何公职——他只是在电视上说过「把政府从我们身上挪开」。是财政窟窿与停电把人逼到了墙角，也有人说真正赢的是电台名嘴和真人秀。\n" +
      "本地晚报的社论问：这是闹剧，还是预兆？党部已定调「偶然事件」，你不好公开拆台，可你昨夜想了半宿：这种靠脸的打法会不会卷进你的赛道，此刻没人能答。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "八月十四日下午，从安大略到纽约，电网在九秒里一层层跳闸：一点崩溃拖着相邻区域连锁断电。五千万人没了电——信号灯灭了，电梯停在层间，地铁卡在隧道里，机场停飞。故障起于跨州的监控系统，没人说得清谁该负责；避难所与供水点的求助电话已经打爆。\n" +
      "联邦与州在互相甩锅，媒体在找背锅的人。调查要几个月才有结论，可选民今晚只需要一个能打通的本机号码，那个电话正往你这里打。有人说这是联邦瞒着的新型网络攻击；也没人提前说过：越权把事办成的人，事后是论功还是论罪。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "十二月十三日深夜，临时联盟当局（战后美英在伊设立的军管机构）证实：萨达姆在老家附近的一个小土洞中被抓获，胡子拉碴，没有反抗。「藏洞视频」当晚传遍全球，支持战争的首都们开了香槟，反对的人一时语塞。\n" +
      "这是开战以来最大的一颗糖果：抓捕由美军实施，功劳按级别摊给每一个肯表态的人。本地电视台正在收集「地方人物的第一反应」——你符合人设，而窗口只有今晚。有人说接下来会是全球直播的公开审判；也仍有一批选民在问：武器没找到，这场仗图什么。你今晚的笑脸，日后会被怎么重剪。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "人塔、头套、吊在电线上的裸身囚犯、咧嘴的军犬——照片说明写着：伊拉克，阿布格莱布，巴格达西侧由美军管理的监狱。\n" +
      "照片是真的，调查已指向监狱管理层；白宫的口径是「几颗烂苹果」。可全国都算得过来账：几颗苹果拍不出几百张照片。记者在你门口只留了一个问题：你是震惊，还是不意外。本地的军人家庭和那几个被怀疑的族裔社区都在等你开口。有人供称有些审讯法是上面批准的——你今晚这句，会跟你很久。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "战争、就业、价值观、谁更像个总统——两张竞选班子把全国犁成两块。开票到凌晨，摇摆州俄亥俄（两党无稳拿、逐票争夺的州）的县数只差一点点，出口民调把选区图染成一张红蓝拼贴画，两边都宣布这四年属于自己。\n" +
      "全国级别的操盘手都到了你这片选区，两边的党部都开了价：替谁讲、替谁站台。站哪边就吃哪边的饭，两份好处你拿不到双份。有人说押中这次边，下次划分选区就有你的位置——替你记账的人，写的是你的名字。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "八月二十九日凌晨，风眼登陆；午后堤坝接连决口，八成城市没入水下——那道堤坝是联邦承诺的护城方案。体育馆与会展中心成了最后的孤岛：没胰岛素的老人、等不来救援大巴的居民、等不来冰的遗体。\n" +
      "联邦救灾署（FEMA）先说系统「已经就绪」，几天后又改口。联邦、州、市三级互相甩锅。你辖区有成千选民还在避难所与撤离路上；有人说救灾物资就锁在国民警卫队看守的仓里。水落下去之前，全国的电视都在等一个管事的人——那几天谁在管事、谁躲着，会有人记得。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "那场被保证「会结束这场战争」的战争，成了没完的那场；游说公司的腐败案一桩接一桩。开票夜，对面拿下众院、在参院也净增席位，获胜演说里都是同一个词：「改变」。\n" +
      "中期选举（总统任期过半时的国会改选）里败的一方，当夜就开始换马。电话来自两拨人：一拨在数「谁早就说过不行」，一拨想把你这样的「还能说话的人」递到新多数党门前——新议长办公室正在要一份可接触名单。有人说位子开议前就排完了；而两边的账上，你的名字这一夜都加厚了一层。",
    choices: [
      {
...
/* ============================================================================
 * 世界线 · 2003—2006：本带每年的压力 / 当年真实存在的媒体口径。
