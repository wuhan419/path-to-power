...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "轮到你，因为你是两拨人都说得上话的本地人；两边都来找你表态。",
        "党魁还照老剧本等「稳赢」，手机里的民粹已不在乎招牌叫什么。",
        "无论哪边赢，都有大半选民觉得对方「不配治国」。"
      ],
      rumor: [
        "对手推文是境外农场放的，自家爆款又甩锅给对方。",
        "有人说老报纸和电视台早定了要捧谁，只是不承认。"
      ],
      unknown: [
        "这场失灵是意外，还是往后选举的新常态。",
        "今晚压的一边，四年后也许正是你想掀的桌。"
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "假料瞄准你摇摆选民最敏感的那根神经——你上了目标名单。",
        "越正经逐条反驳越像替它二次传播；越轻描淡写越像默认。",
        "平台没有编辑部，也没有责任主体，你连「告谁」都要先想半天。"
      ],
      rumor: [
        "造料的是你对手，还是只为流量的内容农场？",
        "平台早知道它在扩散，只是愤怒最留得住用户。"
      ],
      unknown: [
        "先污染后难治理的打法会不会成选举的标配。",
        "你辟谣投入的钱，明天会不会被那机器再榨。"
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "轮到你，因为这笔竞选预算你能拍板；党内已传隔壁效果吓人。",
        "定向投放能提效，但「校准模型」要交出选民个人数据。",
        "一旦这类「用隐私换胜选」的操作被曝光，反噬会比不用还惨。"
      ],
      rumor: [
        "有人说其数据是从社交平台灰色接口「顺」来的。",
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "本地计票归你协调，两拨人都盯着你手里还没开的那几箱票。",
        "邮寄票延迟清点是制度写明的常规，却让当夜结果「反着走」。",
        "你此刻说错一个字，都会被解读成「他们在偷偷干什么」。"
      ],
      rumor: [
        "有人说这几箱「迟到」票被做了手脚，或只是借口。"
      ],
      unknown: [
        "「不信结果」种下就会年年发芽。"
      ],
      terms: [
        { k: "开票滑坡", v: "迟到票后点，领先者被反超属正常现象。" }
      ]
    },
    choices: [
      {
