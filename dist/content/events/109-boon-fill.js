...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      lede: "一股新风吹遍全国,{CITY}也在急着找一张能代表它的年轻面孔——他们找上了你。",
      known: [
        "新组织{ORG}有钱有想法,缺个本地信得过的人牵头。",
        "他们看中你「不像老党建」。上车要么起飞要么被甩下。"
      ]
    },
    title: "新崛起的草根组织请你牵头{CITY}的运动",
    body: "组织者把一叠空白活动申请表推给你:「我们要的是自己人。你要不要,和我们一起把{CITY}翻个个儿?」",
    choices: [
      {
        id: "ride_wave",
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "谁都不反对的活动:体面、还能上电视。协会想找人牵头。",
        "他们要的是别办成党派活动。你若接,就把全国镜头借到本地。"
      ]
    },
    title: "退伍军人协会请你主办一场欢迎凯旋军人的仪式",
    body: "协会老兵在{PLACE}拍你肩膀:「我们不想要政客,想要个还相信这套的人。就你吧。」",
    choices: [
      {
        id: "host_rally",
        text: "主办这场凯旋仪式",
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "本地应急乱成一团:献血、捐物、寻亲。社区缺个理顺的人。",
        "这不是竞选,是救灾。这时扛起担子,名字就绑定「靠得住」。"
      ]
    },
    title: "危机那几天，社区推你出来牵头应急互助",
    body: "{CITY}的消防工会、教堂、学校校长凑到一起说:「我们不认得大人物,只认得你会办事。这摊,你带个头。」",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "人人设话术的年代,一句朴素实话反成了稀缺品,被疯转。",
        "涨粉是真,盯你也多了。这波流量是烟花还是本金,看你。"
      ]
    },
