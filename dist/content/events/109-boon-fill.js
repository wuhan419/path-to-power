...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    title: "新崛起的草根组织请你牵头{CITY}的运动",
    body: "这股新风吹遍全国,你所在的地方也在急着找一张能代表它的年轻面孔。组织者把一叠空白活动申请表推给你:「我们要的是自己人。你要不要,和我们一起把{CITY}翻个个儿?」出钱的那家新组织有钱有想法,缺的只是一个本地信得过的人牵头;他们看中的就是你「不像老党建」。上车要么起飞,要么被甩下。",
    choices: [
      {
        id: "ride_wave",
        ...
        outcomes: {
          crit: { body: "你{MEET},把一场地方动员办成全国样板,年轻的脸被写进这波浪潮的史书——捐款、志愿者、地方党部一夜之间全归你调度。", effects: { rep: 1.4, fac: { base: 14 }, voters: { warm: 600, diehard: 120 }, fun: 0.4, attr: { CHA: 2 } } },
          ...
          fail: { body: "热潮里你慢了半拍,风头被更激进的人抢走,建制派借着{PUB}的社论说你「煽动」。", effects: { rep: -0.5, fac: { establishment: -3 }, voters: { oppose: 200 } } },
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "全国都在给沙漠里的子弟兵点烛。协会老兵在{PLACE}拍你肩膀:「我们不想要政客,想要个还相信这套的人。就你吧。」这场仪式谁都不反对,体面,还能上电视;他们只提一条:别办成党派活动。你一旦接下,就是把全国的镜头借到本地。",
    choices: [
      {
        id: "host_rally",
        text: "主办这场凯旋仪式",
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "{CITY}的消防工会、教堂、学校校长凑到一起说:「我们不认得大人物,只认得你会办事。这摊,你带个头。」本地应急正乱成一团:献血的、捐物的、找人的,人人都在问「我能做点什么」。这不是竞选,是救灾;这时候扛起担子,名字就跟「靠得住」绑死了。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "你只是对着镜头说了几句大实话,一觉醒来被转了几十万次。手机从早响到晚,陌生人的私信涌进来:「终于有个不说套话的了。」也有冷笑的:「等着看他翻车。」人人设话术的年代,朴素实话反倒成了稀缺品。涨粉是真,盯着你的眼睛也多了——这波流量是烟花还是本金,看你。",
    choices: [
      {
        id: "keep_authentic",
        text: "继续说大实话,不请团队包装",
        ...
        mods: [{ src: "attr", key: "CHA", w: 0.3 }, { src: "attr", key: "INTG", w: 0.2 }],
        outcomes: {
          crit: { body: "你连着几条实话都戳中了,拥趸以万计地涨。{CITY}的人把你当成「跟我们一样的那一个」。", effects: { rep: 1.2, fac: { base: 13 }, attr: { CHA: 2 } } },
      ...
      },
      {
        ...
        mods: [{ src: "attr", key: "CUN", w: 0.3 }, { src: "attr", key: "CHA", w: 0.2 }],
        outcomes: {
          crit: { body: "你把评论区的人喊到{PLACE}扫街拜票。别人还在数播放量,你已经有了一支志愿队。", effects: { rep: 1.0, fac: { base: 14 }, attr: { CUN: 2 }, fun: 0.2 } },
