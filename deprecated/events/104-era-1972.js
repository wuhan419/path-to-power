...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "竞选总部所在的大厦夜里响了警报，五个人因为「胶带堵锁眼」被按在地上。\n" +
      "警方在他们身上搜出现金和一台相机。白宫当晚的说法是「一桩三流的窃案」。\n" +
    ...
    choices: [
      ...
      },
      {
        ...
        stake: { fun: true },
        outcomes: {
          crit: { body: "你一口咬定「就是窃案」，替上层顶住了整波追问。白宫记下了你的可靠，一笔「辛苦费」不动声色地到了你背后。",
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    medium: ["print", "tv"],
    title: "有人送来一信封封口钱，不让你问数目和来路",
    body: "一个中间人把信封放在你办公室的角落，说「各位的律师费大家凑一凑」，没提金额，也没提谁签的字。\n" +
