 ...
 * 结构契约与写作铁律见 docs/CONTENT-SCHEMA.md（§11）。
...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      terms: [
        { k: "摩尔", v: "1912 年进步党的标志是一只公摩尔，用来在选票上给不识字的选民指认。" },
        { k: "选票准入", v: "一个新政党要在每州单独凑够签名才能印上选票，组织机器被老党垄断时极难。" }
      ]
    },
    choices: [
      {
        ...
        cost: { fav: 1 }, stake: { ap: true },
        outcomes: {
          crit: { body: "你的登记员把新党的摩尔送进了半个州的票站。老罗斯福在这里赢了，你成了新秩序里「最早信他的人」。",
            effects: { rep: 1.5, tier: 1, fac: { base: 16, establishment: -10 }, flags: ["progressive_soul"] } },
          ok: { body: "新党在本郡站住了脚。你没到大红大紫，但基层从此认你这条敢换旗的汉子。",
            effects: { rep: 0.8, fav: 0.5, fac: { base: 10, establishment: -6 } } },
          meh: { body: "你换了旗，选票却没跟着换。进步党在本郡拿了个不痛不痒的第三名。",
            effects: { rep: 0.1, fac: { base: 3, establishment: -3 } } },
          fail: { body: "老罗斯福输了，建制派重新合拢。你被本党当成「那个分裂的人」，机器开始绕着你转。",
            effects: { rep: -0.4, fac: { establishment: -12, base: -3 } } },
          critfail: { body: "你押得太满，本党输了大选，报纸把你写成「替对手清场的叛徒」。两党都不再要你的人。",
            effects: { rep: -0.75, fav: -1, fac: { establishment: -18, base: -6 }, flags: ["party_traitor"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "大选后你两头都能说上话：新党记得你站台的情，老党没丢你上供的账。你升了一级，谁都没恨你。",
            effects: { rep: 0.5, tier: 1, fac: { base: 5, establishment: 5 } } },
          ok: { body: "你赌对了格局没赌对边。没大涨，但没塌，退路一条不少。",
            effects: { rep: 0.25, fac: { base: 3 } } },
          meh: { body: "两头都觉得你不够意思，又都懒得跟你计较。你成了个「谁也不得罪也谁不信」的人。",
            effects: { rep: -0.05 } },
          fail: { body: "两边事后都对上了账，发现你两头递话。谁都没赢，你两头失信。",
            effects: { rep: -0.2, fac: { establishment: -5, base: -4 } } },
          critfail: { body: "你的骑墙被两家报纸同时写了出来。「机会主义」这四个字第一次和你的名字印在一起。",
            effects: { rep: -0.5, fac: { establishment: -8, base: -8 }, flags: ["scandal_1"] } }
        }
      },
      {
        id: "stay", text: "不换旗。守住本党这块牌子",
        note: "规避路：不赌。机器欠不欠你人情另说，至少这一步没走错。",
        base: 0.72, mods: [{ src: "attr", key: "INTG", w: 0.4 }],
        outcomes: {
          crit: { body: "分裂潮退去后，机器记着「这人没跑」。党魁在闭门名单里替你留了位子。",
            effects: { tier: 1, fac: { establishment: 10, base: 3 } } },
          ok: { body: "你没换旗。这年头没落好处，但党内你的位子稳着。",
            effects: { fac: { establishment: 6 } } },
          meh: { body: "你守着本党，看着新党把话题全抢走。稳是稳，就是没人再提你。",
            effects: {} },
          fail: { body: "党机器把分裂的账算到「不够热心」的人头上，你被划进去了。",
            effects: { fac: { establishment: -7 } } },
          critfail: { body: "你留下替本党说话，反被进步派报纸当成「托拉斯的看门狗」点名。脸没丢尽，生意都黄了半截。",
            effects: { fac: { base: -5, press: -5 } } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你在厂门口念出了那份工时表。杂志加印一期，你的名字和「敢说话」印在了一起，工会第一次主动来要你的电话。",
            effects: { rep: 1.75, fac: { base: 12, press: 10, commercial: -10 }, contact: { columnist: 10 }, flags: ["muckrider"] } },
          ok: { body: "你顺势成了「要求透明的人」。厂方恼火，但报纸站在你这边。",
            effects: { rep: 1, fac: { base: 7, press: 6, commercial: -6 } } },
          meh: { body: "你跟着喊了整改，稿子照发，厂方照旧。你既没借到火，也没真挡着。",
            effects: { fac: { commercial: -5, press: 5 } } },
          fail: { body: "记者转头写了一篇「连某某议员都在替厂方打掩护」，把你顺带钉进了稿子里。",
            effects: { rep: -1, fac: { press: -8, base: -4 } } },
          critfail: { body: "那些收据里有一张牵到你的旧捐款。报道的标题从工厂改成了你。",
            effects: { rep: -2, fac: { press: -12, commercial: -8 }, flags: ["scandal_2", "investigation_open"] } }
        }
      },
      {
        id: "bury", text: "花钱请律师，把这期稿子压下去",
        note: "消费型：一笔压稿钱买沉默。压得住是你赢，压不住就变成「他心虚要封口」的头条。",
        base: 0.5, mods: [{ src: "attr", key: "CUN", w: 0.4 }, { src: "res", key: "fun", min: 1.5, w: 0.2 }],
        cost: { fun: 1.25 }, req: { fun: 1.25 },
        outcomes: {
          crit: { body: "律师抓住了两处硬伤，杂志主动撤了稿。厂方把你当「能平事的人」，下一笔政治捐款打到了你的池子。",
            effects: { rep: 1, fac: { commercial: 12, establishment: 6 }, fun: 0.75 } },
          ok: { body: "稿子被压了半版，改成了不痛不痒的「双方各执一词」。你没出名，但厂方欠你一份人情。",
            effects: { rep: 1, fav: 1.25, fac: { commercial: 8 } } },
          meh: { body: "钱花了，稿子还是照发，只是晚了一周。你买了个「尽力过」。",
            effects: { rep: 0.1, fac: { commercial: 3 } } },
          fail: { body: "律师的信被记者当成了新料，标题变成「有人出钱堵我的嘴」。你反而送了他一个更好的故事。",
            effects: { rep: -1.25, fac: { press: -10, commercial: -6 }, flags: ["scandal_1"] } },
          critfail: { body: "封口不成，还留下白纸黑字的付款凭证。这不再是工厂的事，是你的事。",
            effects: { rep: -2.5, fac: { press: -14, base: -8 }, flags: ["scandal_3", "investigation_open"] } }
        }
      },
      {
        id: "dodge", text: "不压不捧，只回应一句「相信程序」",
        note: "规避路：不拱火也不封口，体面离场。发不了也摔不着。",
        base: 0.68, mods: [{ src: "attr", key: "INT", w: 0.35 }],
        outcomes: {
          crit: { body: "你一句克制的回应让记者没抓到爆点，稿子发了但你干净离场。有人开始觉得你「分寸拿得住」。",
            effects: { rep: 0.8, fac: { establishment: 5, press: 3 } } },
          ok: { body: "稿子发了，你的名字出现在中段，不痛不痒。你什么都没赌，也什么都没丢。",
            effects: { rep: 0.2 } },
          meh: { body: "你的场面话被剪成一段「他什么也没说」。不算坏事，只是没用。",
            effects: { rep: -0.2 } },
          fail: { body: "记者追着要你对童工表态，你含糊了三次，第四次念出「程序」时记者笑了。",
            effects: { fac: { base: -4, press: -4 } } },
          critfail: { body: "你躲过了这场，可下期的封面把「逃避追问」做成了整版。躲，本身成了新闻。",
            effects: { fac: { press: -6, base: 0 } } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你的念词被报纸整版转载，另一城的选举权协会来函邀你当名誉理事。你上了一个「敢替无声者说话」的档位。",
            effects: { rep: 1.5, fac: { base: 12, press: 8, establishment: -8 }, flags: ["suffrage_friend"] } },
          ok: { body: "你站了台，码头上果然有人起哄，但你没退。街上的户主记住了这张脸。",
            effects: { rep: 1, fac: { base: 8, establishment: -5 } } },
          meh: { body: "你去了，话说到一半被一阵口哨盖过去。姿态摆了，效果一般。",
            effects: { rep: 0.4, fac: { base: 3, establishment: -3 } } },
          fail: { body: "党部把你站台的照片寄给了本党的金主，附了一句「他疯了」。",
            effects: { rep: -0.8, fac: { establishment: -10, commercial: -6 } } },
          critfail: { body: "游行被砸场，你在推搡里摔了一跤，报纸拍到你坐在地上扶着一名游行者。标题是「议员的狼狈」。",
            effects: { rep: -1.5, hp: -0.8, fac: { establishment: -8, base: -3 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你那封措辞得体的陈情书被递进了州议会，成了首次听证桌上少见的「来自党内的声音」。没人给你登报，但办事的人记住了你。",
            effects: { rep: 1, fav: 1, fac: { base: 6, establishment: 4 } } },
          ...
          fail: { body: "游行者觉得你比挡道的还气人——「有胆量就别只写封信」。",
            effects: { rep: -0.6, fac: { base: -6 } } },
          critfail: { body: "那封没署名的信被对手挖出来，两边传成「他其实两头递话」。你的分寸成了你的把柄。",
            effects: { rep: -1, fac: { establishment: -6, base: -6 }, flags: ["scandal_1"] } }
        }
      },
      {
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你既拿了钱，又在这次并购里演得像个真中立的人。大亨满意，账上的钱和你的把柄同时变多。",
            effects: { fun: 44.5, rep: 1.5, lev: 1, fac: { commercial: 12, establishment: 6 } } },
          ok: { body: "钱进了你背后的池子，你下次表决「恰好缺席」。谁都没抓到什么。",
            effects: { fun: 28, lev: 1, fac: { commercial: 8 } } },
          meh: { body: "钱是拿了，可你心里没底，下次表决反而露了怯，两头都没落稳。",
            effects: { fun: 13.5, rep: -0.8, fac: { commercial: 3 } } },
          fail: { body: "大亨觉得你「收了钱还不办事」。这笔钱变成了你欠他、且他随时会讨的东西。",
            effects: { fun: 22, rep: -2, flags: ["compromised"] } },
          critfail: { body: "车厢里有人记着你说的每一句。三个月后，一份记录你「用沉默换了多少钱」的草稿开始在小圈子流传。",
            effects: { fun: 16.5, rep: -4, fac: { press: -10, base: -8 }, flags: ["black_money", "scandal_2", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你把这顿饭连人带菜端上了报纸。大亨的并购在舆论里黄了，你成了「托拉斯啃不动的人」。",
            effects: { rep: 5, fac: { base: 12, press: 12, commercial: -14 }, flags: ["trustslayer"] } },
          ok: { body: "报道出来了，大亨不太疼，但你挣到了「不收这份钱」的名声。",
            effects: { rep: 2.5, fac: { base: 8, press: 6, commercial: -8 } } },
          meh: { body: "记者信你但不敢写。你手里多了一段好故事，暂时换不成别的。",
            effects: { rep: 0.8, contact: { columnist: 6 } } },
          fail: { body: "大亨一句「他疯了，在编故事」就把你打发了。你既丢了钱途，又被当成不稳定的人。",
            effects: { rep: -1.5, fac: { commercial: -10, establishment: -6 } } },
          critfail: { body: "你反咬一口，可他先放出了你上一次私下求他的记录。谁更脏，报纸有了新答案。",
            effects: { rep: -3.5, fac: { press: -8, commercial: -12 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你淡淡起身离开。大亨反而高看你一眼，日后有笔干净的钱正大光明地给了你——有些人只尊重拒绝过他的人。",
            effects: { rep: 2, fac: { base: 6, commercial: 4 } } },
          ...
          fail: { body: "你的「不给面子」传开了，本城的钱从此绕着你走。清白的代价是穷。",
            effects: { rep: -0.8, fac: { commercial: -8 } } },
          critfail: { body: "你下车太急，第二天的报道说「某某议员被大亨拒之门外」——清白没证成，倒像你没资格上桌。",
            effects: { rep: -2, fac: { commercial: -8, establishment: -4 } } }
        }
      }
    ]
  }
