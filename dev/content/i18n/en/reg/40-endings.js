  ...
  content: {
    ending: [
      ...
      { id: "career_president_great",
        title: "The Two-Term President",
        body: "You won reelection, filled the chair for eight full years, and walked out with approval still above the midpoint — hardly anyone has managed all three at once. From 1980 to 2025 your name went into the textbooks, and it went in clean." },
      { id: "career_president_adequate",
        title: "The President Who Held the Line",
        body: "You survived the midterm audit in the White House, were never carried out mid-term, and never wrote your own name into an article of impeachment. You left with approval still above forty — in this country that counts as a successful presidency." },
      { id: "career_president_flawed",
        title: "The President With the Longest File",
        body: "You did run this country, and you did spend those years as a war of attrition: approval sliding, scandal and investigation taking the space that should have been yours. History did not deny you came — it only filed you behind the presidents who held the office." },
      { id: "career_president",
