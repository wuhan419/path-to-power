...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "早上八点，宿舍楼与工程楼先后响枪。到中午，三十二个名字被贴上网，最小的十九岁。\n" +
      "下午两点，大学的追悼会排定了座位，致辞里有地方官员的名字，而校方不想在这个厅里听到「立法」两个字；本地台把话筒对准每一位到场的人。你县里那家心理健康中心，去年被州预算砍掉一半人手——砍那笔钱的那一票你投了赞成，记录在案。州长办公室已经放话：今年不重开精神卫生法。有人说枪手的门诊材料还锁在县教育局的柜子里；你今天说出口的这句，会进某一份卷宗。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "八月的一个礼拜里，两只靠房贷证券吃饭的基金被冻结赎回，「次级贷款」（放给信用不足者的房贷）第一次上了电视。\n" +
      "你收到的消息更近：县教师退休金存放的那家银行，正是发这批贷款的那一家。抽钱要董事会表决，公开理由只能写「审慎」两个字；留下，分行承诺不抽本地贷，抽走，建商先失血。财政主管带着报表来敲门——你去年的竞选捐款里就有这家银行分行的钱。分行行长说：先跑的人，就是踩死它的人。有人说总部早把钱抽走了，账上是空的；先动的手算聪明还是算背叛。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "选前所有民调都指着一个方向：如果今晚赢，他是第一个坐进那把椅子的黑人。排队投票的人从学校体育馆绕到街角，有人在车里哭。开票前夜两党都在抢本地的票站（投票日监票与开票的据点，由地方党部调度），志愿者从来不够。\n" +
      "本地两拨人同一天找上你：一拨要你立刻把竞选机器并过去；一拨提醒你，潮水退得比涨得快，而你明年还要在这片街上握手。你的对手已经在照片墙上挂好了全国候选人的旗。党部的数据就在你手边：本县去年差两千票输掉。有人说这股风会连刮八年；你今夜的站位，会被记几年。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "十二月的华盛顿在吵一笔紧急贷款：把通用与克莱斯勒从破产线上拽回来。条件是写死的——砍岗位、关工厂，联邦拿股权和话语权。\n" +
      "你的县有一座配件厂和一条整车物流线，五千个饭碗挂在它的订单上。厂方递来联名信，要你替它去华盛顿说句好话；工会的人已经在党部门口等你开口。你去年收过那座配件厂的捐款。有人说厂里早把订单往邻州挪了；你这一票会被记几年，不止一个人正在数。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "方案签字那天，全国的评论在吵它到底算不算数。你手边的东西更实在：一张修了二十年的桥图、一座漏水的学校体育馆、一份「就绪工程」（图纸与许可齐全、拨款即可开工）的排队表——你的项目在上面排了十年。\n" +
      "州的分配口径两周后下来：项目要报州里，本地得先出配套和环评。同一天，两家承包商各自递来一份合作意向，都写着我们做过。名单是公开的，抢到第一笔的钱会被记四年。有人说州里早把活内定给了自家县；你抢到的是工程还是债，也得四年后才知道。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "为了不让体系塌下去，联邦给那家保险巨头注了几千亿美元。三月的一个礼拜，电视上放出它发给高管的一亿六千五百万奖金单。\n" +
      "奖金合法，合同是救市之前就签好的。全国在骂，你的党部也在骂——因为你的竞选账上，去年收过这家公司本地分公司的三笔钱；而这座县里，那个分公司还雇着一千多个人。电话里说：今晚之前，你要不要讲点什么。有人说名单是总部漏给记者的，为的是逼人辞职；你说出口的那一句，会一路跟着你。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "四月底，外地一个小镇因为几例高烧的孩子关掉了学校。几天后本州报了第一例，而检测试剂盒只够确诊，不够筛查：本地多数病例永远不会被记上一例。这病最后有多重，此刻没人知道。\n" +
      "学区总监打来电话：停课两周，要学区与县共同签字，责任就写在名字上。县医院只剩八张观察床，重症得转去市里。五月有州考、有毕业礼，双职工家庭没人带孩子，还有两周不发薪的水厂临时工。有人说州里压着数字不报，怕影响旅游季；你签下的是哪个字，没人能替你判。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "十一月的一个上午，得州一处大军营的诊所里响起枪声，十三个人再没走出来。开枪者是军中的医生，现场有人喊过一句阿拉伯语。\n" +
      "当天傍晚，全国的争论从「为什么」换成了「该叫什么」：恐怖袭击，还是军方口径里的「内部威胁」（组织内部的人发动的袭击）。军方的调查结论还没出，党部已经要你先表态。基地的征兵处就挂在本地高中里，家属会当面问你；本县还有一座上周刚被报纸点名过的清真寺。你手里管着州反恐联络站的预算。有人说这名枪手早被同僚举报过，没人理。你选的这两个字，护住谁、砸了谁。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "四月的一个晚上，墨西哥湾一座钻井平台起火爆炸，十一人没有回来。两天后油开始冒，公司新闻稿第一句是：责任不止在我们。\n" +
      "你管着三个海岸县：三千多张捕鱼执照、两家假日旅馆、一个夏天。州里说要告联邦，县里说要人先到。赔偿得走公司自己设的理赔办事处（先签先领的窗口），材料一户一户自己交；州检方的集体诉讼已经写好，只差地方背书。替平台干活的岸上承包商就雇在你县里，去年还给你捐过钱。渔会的人问你：谁替我们记账。有人说公司在按人私下买和解书；油什么时候上岸，是海流说了算。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "七月底，一个网站把阿富汗战争的几万份原始日志（军方前线的行动记录，非官方发布）一次摊开：阵亡者名单、线人代号，也有一句提到本州。八月，更大的一批在路上。\n" +
      "国务院说这是安全问题，可反泄密的口径由司法部定，地方插不上话。你认得的两个人同一天打来电话：一个是本地周报主编，他说要跟着登；一个在国民警卫队，他说你的名字已经被人问起。党部要你喊追责，报馆那边要你护住印刷间。有人说名单上的人早被转移了。你先说的那一句，会被引用两年。",
    choices: [
      {
