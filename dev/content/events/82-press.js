...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    body: "本市报纸的第七版有一个专栏，每周三次，每次六百字。写它的人今年五十一岁，\n" +
      ...
      "他不收钱，他缺的是一个独家：三个月来他写的都是别人写过的题。这专栏是全镇唯一还会被人逐字读完的东西，" +
      "而他的记性极好——你今晚随口说的一句，八年后可能出现在某一栏里。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "你比读者早三天知道那篇稿子要写什么。\n" +
      ...
      "写稿的人二十年没撤过一篇稿，可登不登是总编说了算。他儿子在私立学校，一年学费六万。" +
      "有人说第三件事是有人特意递到他手上的。真要撤稿，编辑部悄悄拿掉，纸面上不留痕。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "这一次是别人来找你。\n" +
      ...
      "动手的不是你的对手，是一份只觉得这故事好的报纸；稿子里你的身份是「那位议员的朋友」。" +
      "压稿的办法很多，代价都落在你身上；换料是塞进一件更大的事，因为版面有限。主编这个月正发愁：报道团队要缩两个人。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "那家媒体要卖了。\n" +
      ...
      "本地发行量它排第二，可「没人敢在这版面上撒谎」它排第一。一过户你就是媒体老板，党内立刻多一层提防。" +
      "编辑独立留得越多它越有用，留得越少它越听话。也有人说它是被人挤到要卖的：本地最大的广告主刚撤了。",
    choices: [
      {
