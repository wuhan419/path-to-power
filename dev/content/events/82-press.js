...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    grade: "minor", category: "media", medium: "print",
    title: "第七版上的那支笔",
    ...
    brief: {
      ...
      known: [
        ...
        "他记性极好，你今天随口说的一句，可能会在八年后的某篇稿子里出现。"
      ],
      rumor: [
      ...
      unknown: [
        "他今天来，是打算写你，还是只是来吃饭。",
        "他真正想从你身上得到的，是一篇稿子，还是一个立场。"
      ],
      terms: [
        { k: "专栏", v: "固定的版面，固定的读者。它给的不是曝光，是「被认真对待」的资格。" },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: pOut("他当场把笔记本翻到新的一页。三周后那篇专栏里你的名字出现了四次，而且每一次都在句子的前半段。",
            { rep: 7, contact: { columnist: 18 }, fac: { press: 12, base: 5 } }),
          ok: pOut("他记下了，也写了。措辞很有分寸，分寸得让你怀疑他是不是在替你把话留着。",
            { rep: 4, contact: { columnist: 9 }, fac: { press: 7 } }),
          meh: pOut("他用了你那条料，但主角不是你。你的名字出现在第六段的括号里。",
            { rep: 1, contact: { columnist: 3 }, fac: { press: 2 } }),
          fail: pOut("你把料喂给了错的人：他查了三天，证明你说错了一个细节，然后把这件事写进了专栏。",
            { rep: -3, contact: { columnist: -8 }, fac: { press: -6 } }),
          critfail: pOut("那条料牵扯到一个你还没准备好得罪的人。稿子见报的第二天，那个人替你记住了这件事。",
            { rep: -5, contact: { columnist: -12 }, fac: { press: -8, establishment: -8 }, flags: ["scandal_1"] })
        }
      },
      {
        ...
        outcomes: {
          crit: pOut("你们喝到十一点，他讲了他那一次输掉的选举。走的时候他说：「你比他们有意思。」这句话不是稿子，但比稿子有用。",
            { rep: 3, contact: { columnist: 14 }, fac: { press: 9 } }),
          ok: pOut("一顿饭，一句「以后有事可以找我」。他说的「有事」是什么意思，你们都没细问。",
            { rep: 1, contact: { columnist: 7 }, fac: { press: 4 } }),
          ...
          critfail: pOut("你在这个馆子里被人看见了。第二天有一句话开始在传：「那个人已经在请记者喝酒了。」",
            { rep: -3, contact: { columnist: -8 }, fac: { press: -6, base: -5 } })
        }
      },
      {
        ...
        outcomes: {
          crit: pOut("你什么都没做，他反而来了。他那篇稿子的标题是「一个还没有开口的人」——这是他二十二年里写得最好的六百字。",
            { rep: 6, contact: { columnist: 12 }, fac: { press: 10 } }),
          ok: pOut("他后来还是写了你，写得不好不坏，像一篇提前写好的讣告练笔。",
            { rep: 2, contact: { columnist: 4 }, fac: { press: 3 } }),
          ...
          critfail: pOut("三个月后你才知道，那顿饭本来是有人安排给别人的。你只是恰好坐进了那个位子。",
            { rep: -3, fac: { press: -5, establishment: -4 } })
        }
      }
    ]
  },
   ...
   * ======================================================================== */
  {
    ...
    grade: "mid", category: "media", medium: "print",
    title: "下周四见报",
    ...
    brief: {
      ...
      known: [
        "写稿的记者二十年来没有撤过一篇稿 —— 他自己就是这一版最硬的那根骨头。",
        "终审权在总编手上，不在记者手上。",
        "总编有一个正在上私立学校的儿子，学费一年六万。",
        "总编最怕的不是你，是另一家报纸在同一天登出一件比这更大的事。"
      ],
      rumor: [
        "有人说那三件事里的第三件，是有人特意递到这个记者手上的。",
        "有人说总编和你的对手在三年前吃过一次饭。"
      ],
      unknown: [
        "稿子里到底有几句是能证实的。",
      ...
      terms: [
        { k: "撤稿", v: "编辑部主动拿掉一篇稿子。它不会被写在纸面上，但所有人都知道发生过。" },
        { k: "先发制人", v: "自己先把更小的那件事说出去。用小的换大的，用的不是钱，是时机。" }
      ]
    },
    choices: [
      {
      ...
      },
      {
        ...
        outcomes: {
          crit: pOut("你只打了一个电话，没提稿子，只提了一个编号和一年前的一个下午。第二天总编亲自把那篇稿子从版面上拿了下来，还顺手换掉了那个记者的线口。",
            { rep: 4, fac: { press: 4, establishment: 8 }, flags: ["compromised"] }),
          ok: pOut("稿子撤了。撤得很突然，编辑部里传了三天闲话，但没有人知道是谁打的电话。",
            { rep: 2, fac: { press: -2, establishment: 6 }, flags: ["compromised"] }),
          meh: pOut("稿子压了两周，最后还是登了——只是换了个人署名。你损失了一份把柄，换到两周。",
            { rep: -1, fac: { press: -6 }, flags: ["compromised"] }),
          fail: pOut("你找的那个人已经不是你以为的那个人了。他把电话内容原样转述给了那个记者。",
            { rep: -5, fac: { press: -14, establishment: -8 }, flags: ["scandal_2"] }),
          critfail: pOut("你以为你在威胁一个人，其实你在训练一个人：他从此明白了你有多怕被写。这笔账他记了很多年。",
            { rep: -7, fac: { press: -12, establishment: -12 }, flags: ["scandal_3", "investigation_open"] })
        }
      },
      {
        ...
        outcomes: {
          ...
          fail: pOut("登了，而且那三件事被证明得非常干净。你花了四个月，什么都没做成。",
            { rep: -5, fac: { base: -6, press: -4 } }),
          critfail: pOut("登了。那天早上你第一次在便利店被人当面质问。你没有生气，你只是忽然明白了一个很实际的问题：这个人下次还会投你吗。",
            { rep: -7, fac: { base: -10, establishment: -6 }, flags: ["scandal_2"] })
        }
      }
    ]
  },
   ...
   * ======================================================================== */
  {
    ...
    grade: "mid", category: "media", medium: ["print", "radio", "tv"],
    title: "一条本来会登出来的稿子",
    body: "这一次是别人来找你。\n" +
    ...
    brief: {
      ...
      known: [
        "这篇稿子是真的。你在里面的角色是「那位议员的朋友」——这个称呼会跟着你走很远。",
        "动手的人不是你的对手，是一份跟你无冤无仇的报纸，它只是觉得这个故事好。",
        "这一版的主编正在为一件事发愁：他的报道团队下个月要缩编两个人。",
        "你手上有三样东西可以交换，而那篇稿子只有一次机会。"
      ],
      rumor: [
        "有人说写这篇稿子的人，两年后想去华盛顿跑线。",
        "有人说这篇稿子的作者和你的对手上过同一所大学的校友会。"
      ],
      unknown: [
        "如果你把这篇稿子压下去，写它的人会不会换个方式再写一次。",
        "那个把票许给你的人，知不知道自己马上就要被写出来。"
      ],
      terms: [
        { k: "压稿", v: "让一篇真稿子不发。技术上有二十种办法，代价都在做这件事的人身上。" },
        { k: "换料", v: "用一条更大的新闻把版面占掉。版面是有限的，这是这个行业唯一公平的地方。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "这家媒体的发行量在本地排第二，但它「没有人敢在它的版面上撒谎」的名声排第一。",
        "老板的两个儿子只想快点拿到钱，不在乎买家是谁。",
        "买下之后你会成为「媒体老板」——这个身份会让你在党内立刻变成一个被警惕的人。",
        "你也可以不当老板，只当一个能让主编接电话的人。便宜得多。"
      ],
      rumor: [
        "有人说它是被挤到要卖的：本地最大的广告主最近撤了。",
        "有人说真正想买它的是你的对手，出价比你高，但要求先清掉两个记者。"
      ],
      unknown: [
        "你买下它之后，还写得出原来那些话吗。",
        "如果有人用你自己的报纸来查你，你打算怎么办。"
      ],
      terms: [
        { k: "发行量", v: "能换成广告收入的读者数量。和政治影响力不是同一件事。" },
        { k: "编辑独立", v: "买下之后你打算保留多少。留得越多，它越有用；留得越少，它越听话。" },
        { k: "沉没成本", v: "你每年要往里面填的钱。这笔钱不会给你带来选票，只带来「没人敢反驳你」。" }
      ]
    },
    choices: [
      {
        ...
        cost: { fun: 1500000 }, stake: { fun: true, fav: true },
        outcomes: {
          crit: pOut("交割那天你走进编辑部，只说了一句话：「版面的事，以后还是你们定。」没有人辞职，六个月后发行量涨了一成。你成了那些人真心愿意守着的老板。",
            { fun: -1500000, rep: 14, fac: { press: 22, establishment: 8, commercial: 8 }, flags: ["owns_media"] }),
          ok: pOut("你成了老板。第一天早上你在自己报纸的第三版上看到一篇不完全顺着你的报道，你没有打电话。这就是你要的。",
            { fun: -1500000, rep: 9, fac: { press: 14 }, flags: ["owns_media"] }),
          meh: pOut("买下来了。第一个月就有两个记者辞职。新来的两个写得没那么好，但更好说话——你换到了你想换的东西，也失去了你买它的理由。",
            { fun: -1500000, rep: 2, fac: { press: -6 }, flags: ["owns_media"] }),
          fail: pOut("买下来了，然后钱开始漏。第二年的亏损比会计算的多一倍，而你的对手开始在广播里说「那位先生最近很关心新闻自由」。",
            { fun: -2200000, rep: -6, fac: { press: -12, establishment: -8 }, flags: ["owns_media", "scandal_1"] }),
          critfail: pOut("买下来之后你才发现，它亏损的真正原因是：它手上有一桩还没了结的老官司，而卖方在尽调文件里把那三页夹在了中间。你连它一起买了。",
            { fun: -2600000, rep: -10, fac: { press: -16, commercial: -12 }, flags: ["owns_media", "scandal_2", "investigation_open"] })
        }
      },
      {
        ...
        outcomes: {
          crit: pOut("你没有买它，你只是成了它最大的广告主，以及主编每周二下午的那杯咖啡。这个国家里真正有效的媒体控制，从来不在产权证上。",
            { rep: 6, fac: { press: 12, commercial: 6 } }),
          ...
          fail: pOut("主编把钱退了回来，还写了一篇短评，题目叫「本刊不接受任何形式的版面赞助」。",
            { fun: -240000, rep: -4, fac: { press: -12 } }),
          critfail: pOut("你只拿到了一个许诺，却已经在两顿饭里把名字说出去了。三个月后那家媒体被你的对手买走，而它记得你曾经想买它。",
            { fun: -240000, rep: -5, fac: { press: -10, establishment: -6 }, flags: ["scandal_1"] })
        }
      },
      {
