...
POTUS.define("event", [
   ...
   * ------------------------------------------------------------------ */
  {
    ...
    body: "计票结束，你差四个点——就是那种「再多两周就能翻」的输法，比大败更难受。\n" +
      "宴会厅的支持者还站着，等你上台；稿子只写了赢的版本。这一夜的讲话，会决定这次失败是句号还是逗号。\n" +
      "还有没人提但躲不掉的：竞选账户还欠着尾款——印刷厂、广告档期、你自己垫的部分。有人说党内已经在谈下次换个更年轻的，说的就是你。今晚谁还站在厅里，两年后才知道谁会第一个回来。",
    choices: [
      {
   ...
   * ------------------------------------------------------------------ */
  {
    ...
    body: "初选对手出现了：本地高中的一位老师，一个议题，零知名度，竞选经费不到你的十分之一。你的民调领先三十个点，顾问说：不用理他。\n" +
      "他咬住的就是你跟着党领导层投下的那一票——基层正恨着它。真正的题目不是能不能赢，是**怎么**赢——以及别输。\n" +
      "有人说你的记录里还有两票和这议题有关，他还没挖到。三十点的领先在单一议题初选里到底值多少，没人试过。",
    choices: [
      {
   ...
   * ------------------------------------------------------------------ */
  {
    ...
    body: "那张没按党意投的票有价目表了：州里的经费停了，联合筹款晚宴除了你的名，选区党部公开说下次初选要推自己的人。\n" +
      "你在全国媒体上成了「有骨气的人」——这名声在党内一分不值。明早九点的谈话，决定你是低头、出走、还是开战。\n" +
      "已经有人递话：下次表决「回来」，这一切都可以当没发生。但党能开除你的职位，开除不了你选民认不认你——明早进门前，想清楚这句。",
    choices: [
      {
   ...
   * ------------------------------------------------------------------ */
  {
    ...
    title: "三家记者同时打来",
    body: "一件你以为早已翻篇的旧事被挖了出来，另外两家正在跟进。48 小时，三家媒体。后天的公开露面躲不掉——取消比出席更显眼。\n" +
      "团队连夜写了三版应对，彼此矛盾。你的第一句话，就是整个故事的标题。\n" +
      "有人说这批稿的时机是对手买下的：稿子真，时机是定制的；第二篇更狠的还压在编辑手里，等你的第一反应。「不理它」这招，有些年代有效，有些年代致命。",
    choices: [
      {
   ...
   * ------------------------------------------------------------------ */
  {
    ...
    body: "医生把话说得很轻，意思很重：再这么下去，身体会先替你辞职。病根就在日程表上——一周六个活动、跨州红眼航班、车里对付的那几顿。\n" +
      "中期检查在四个月后，没有任何规定要你现在公布什么。你最怕的不是病，是他们知道你病了之后看你的眼神。有人说华府惯例是小病大养、大病照常投票，反例也有。\n" +
      "可没人能告诉你：休息半年，位子还在不在——政治没有暂停键。",
    choices: [
      {
   ...
   * ------------------------------------------------------------------ */
  {
    ...
    body: "孩子的比赛、结婚纪念日、三个县的日程——你只能选一个在场。这是家里第七次为竞选取消安排；上次全家一起吃饭，还是上次连任成功那晚——那也是工作餐。\n" +
      "没有争吵。比争吵更糟的是那句：「我只是想知道这样还要多久。」家里的开销靠另一半的收入撑着，公职薪水填不平你缺席的窟隆。\n" +
      "这道题从你宣布参选那天就在桌上，今天它到期了。十年后孩子怎么讲这一段，那才是最终评分。",
    choices: [
      {
