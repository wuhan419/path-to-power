...
(function () {
  ...
  POTUS.define("event", [
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      title: "两名记者同时在查你的旧账",
      body: "电话打到办公室，问话客气，问题不客气。\\n你怼过新闻界太多次——现在他们在拼一份关于你的档案。\\n约你「聊聊过去」的那位，问的全是你以为没人记得的细节；你当众怼过的专栏作家，这半月写你写得格外勤。编辑部在等你这次怎么回应——回应的方式本身就是素材。他们手里是有实货，还是只想吓你开口解释，你分不清。",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "这不是一篇稿子，是一场战役：版面统一、口径统一、火力翻倍。\\n他们不是在报道你——他们是在收尾。\\n连投四周的系列稿早排好了版面，你的名字是第一集；报业老板在行业聚会上放话，要翻掉你这一页。广告商跑得比稿子快，已经开始撤你的关联项目。有人说最后一集压着一份你从没见过的文件。",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      title: "党给你寄了一张听证会的传票",
      body: "议题叫「不当影响」，范围没有边界，时间由他们定。\\n主席秘书好意提醒你：出席时「态度比证词有用」。\\n两位老资格公开说「该有人管管他了」，没点名；下一轮拨款与提名，你的位子往后挪了三排。他们是想收服你，还是想除掉你——没人给你答案。",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "没有红头文件，没有正式通知——但整个党都在传阅同一份名单。\\n机器碾人不点火，只关闸：钱、门路、排期，一夜之间全部「流程中」。\\n你的办公室搬去了租赁楼层，手续齐全，理由叫「装修」；一位「明日之星」已开始替你选区的旧选民「代言」。名单不很长，你在第二个。硬顶是殉道还是自毁，取决于你的选民还认不认你。",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "钱没有说要抛弃你，钱只是开始「重新评估」。\\n在华盛顿，这两种说法是同一句话。\\n往年必邀你的三场晚宴，今年一封请帖都没来；政治行动委员会的续约谈判，开口就是「先看看年底的民调」。有人在替一个「更稳的人选」试探捐款池——钱缩回去，是还在观望，还是已经在给对手上膛？",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "新的竞选者、新的报告、新的银行额度——他们不是不投你，是投了你的替身。\\n钱不说绝话，钱只做预算。你的政治生涯被做成了预算科目。\\n一个你从没听过的人宣布参选：纲领抄你的，经费是你的三倍，银行给他的授信比给你的顺手。闭门会上的说法是：他值多少钱，我们就出多少钱——买他下桌。这是围猎，还是分手费谈判？",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "暗账、跟拍、假旗提案——政敌的情报部门成立了，虽然没人给它发编制。\\n名单的第一页只有一行字：他怎么倒，我们挑哪个。\\n你的助理连续两晚在停车时被人拍照，同一部车，不同的角度；他们请的顾问以脏活出名，名片上只印「咨询」。一份「重点对象清单」在对手内部流出，你在前五，旁边照例会有一栏备注：「可用资源」。这是威胁清单，还是任务清单？",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "一场不能不去的集会，一条人人都知道的动线，一句「可信威胁」。\\n政治暗杀是这个国家的传统艺能——它只在有人决定试一试的时候才叫意外。\\n集会已公布了两周，场地开放，名单不知漏在了哪里。安保主管问你去不去——他把「建议取消」说得很轻，像在替你说。对手那边，已有人在讨论出事后谁来接任。取消只保你一次；去不去，决定的是从此以后你怕不怕。",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "审查重启、电话换机、旧部被约谈——不是查案，是建档。\\n系统的笔比政敌的刀慢，但笔一旦写完，刀就有了坐标。\\n你上一回通过这道审查，还是在这个系统怀疑你之前。审查表新添一栏「境外接触申报」，格子刚好够写三行。内部流传一份「风险人物」清单，你在上面，评语四个字：可利用，或可摧毁。档案是什么时候开始存在的，比里面有什么更要命。",
      choices: [
        {
     ...
     * ------------------------------------------------------------------ */
    {
      ...
      body: "线人有编号，细节有时间戳，卷宗在等一个签名——你的。\\n诬告最高级的形态，是把「莫须有」写成符合全部流程的样子。\\n一个你从没见过的「线人」，描述了你参与的三场从没发生过的会面，细节准得可怕；两名你认识的人被分开「协助了解」，问的是同一套问题。要证明一桩没发生过的事，需要的不是清白，是权限。",
      choices: [
        {
