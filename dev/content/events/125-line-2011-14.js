...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "总统在十点半走进椭圆形办公室，讲了一句「我们正义已经得到」。十年、近三千条人命、几万亿美元，收在一段十一分钟的录像里。\n" +
      "你所在的街区当晚有人按喇叭，也有人在算另一件事：仗打完了，那驻军还在不在、回来的兵谁来管。",
    brief: {
      lede: "一件没人能反对的好事落在你手上——问题是你接多少，会不会显得在蹭。",
      known: [
        "全国情绪一致向上，反对的声音这一周说不出话。",
        "本地电视台要的是「反应」，两句话就够，谁的都能播。",
        "驻阿部队没撤，退伍军人事务的案子还在你桌上排着。"
      ],
      rumor: [
        "有人说情报早到了几周，只等选举周期挑日子。",
        "有人说击毙地点离首都卫戍区只有半小时路。"
      ],
      unknown: [
        "这股上扬的士气能撑过几个月。",
   ...
   * ==================================================================== */
  {
    ...
    body: "两党为抬高借贷上限吵了整整两个月，标准普尔在周五收盘后把美国评级下调一级。电视把这事讲成世界末日，你的电话被本地小老板打爆：贷款、信用卡、养老金。\n" +
      "财政部说钱还够，国会说都是对方害的。镜头要你回答一个问题：这笔账该谁还。",
    brief: {
      lede: "两个党都把自己说成踩刹车的人，你要挑的是一个不被撞的位置。",
      known: [
        "评级已下调，但美元没崩，市场可能下周就涨回去。",
        "本地银行开始收紧贷款，两家商户已在问要不要裁员。",
        "党部要你支持「负责任方案」，基层要你反对任何让步。"
      ],
      rumor: [
        "有人说白宫早备好了另辟蹊径的方案。",
        "有人说削减条款里塞好了承包商的私货。"
   ...
   * ==================================================================== */
  {
    ...
    body: "夜里十点半，火箭弹落进沙漠边上的旧办公楼，之后是九小时的枪声与打不通的求援电话。大使死了。\n" +
      "第二天上午，官方说法先讲「一部抗议视频」，安全理由又被撤销。全国电视台开始问同一个问题：那九小时里，谁在给谁打电话。",
    brief: {
      lede: "一场悲剧正在变成一桩问责；越早定性越安全，越晚定性越贵。",
      known: [
        "同一处馆点先前被袭击过，安全申请被驳回过。",
        "大选前六周，任何一句「程序还在走」都会被反复回放。",
        "本地有退伍情报与军方关系的人，正在等你开口。"
      ],
      rumor: [
        "有人说是预设目标，不是临时暴动。",
        "有人说最初几小时其实有可动的救援。"
   ...
   * ==================================================================== */
  {
    ...
    body: "风暴潮灌进地铁隧道和地下室，七个城区停电，供暖油车进不来。有人在加油站排了一夜，有人在用手电筒给胰岛素保鲜。\n" +
      "大选前一周。联邦救援要文件、州长有配额、电视台想看你身上有没有泥。",
    brief: {
      lede: "选举前一周的天灾，救人是账，抢镜头也是账。",
      known: [
        "联邦援助要走程序，最快也要几周才落到人头上。",
        "本地电网属私营，抢修顺序由合同而不是人情定。",
        "你的办公室有发电机、有冰、有空的电话线。"
      ],
      rumor: [
        "有人说配電早晚会修好，先给富人区。",
   ...
   * ==================================================================== */
  {
    ...
    body: "计票到凌晨两点就结束了。赢家拿到第二个任期，输家的电话没人接，而你所在的党在一夜之间同时决定了两件事：谁留下来，谁负责。\n" +
      "本地电视台要你说一句「这对本区意味着什么」。真正的问题是你明天的名字要出现在哪一份名单上。",
    brief: {
      lede: "别人在庆功或哀悼，你要在结果刚出的六个钟头里决定自己站哪一边。",
      known: [
        "赢家连任，党内人事从现在起按新账重排。",
        "本地选票结果与全国方向并不完全一致。",
        "两个派系都已经在拉人，名单周五前上报。"
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "两周之内，全国的注意力会从花圈移到草案，你只有一次表态机会。",
      known: [
        "本区小学明天要复课，保安和牧师都不够。",
        "州里的购枪背景审查草案已经在起草。",
        "党内的枪支选票在下一场选举里仍是要命的。"
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "一座城在追查，同时也在乱猜；乱猜的部分会算到说话的人头上。",
      known: [
        "线索很真，公开的部分很少，媒体在抢空白。",
        "本地有几家少数族裔商铺被误当成目标。",
        "紧急通告要求商户闭门、公共交通停摆。"
   ...
   * ==================================================================== */
  {
    ...
    body: "六月开头，两份报纸先后登出程序性文件：电话记录与网络数据的批量调取。一周之内，「我们打了多少通电话」成了全国的口头禅。\n" +
      "情报系统说这是合法且救过命的；科技界说这单要黄了；而你的本地律师开始问：当事人和我说话，你还录不录。",
    brief: {
      lede: "同一批文件，一边叫叛国一边叫公益；你选哪个词都会被另一批人记住。",
      known: [
        "程序是法院特庭批的，公开范围由行政部门决定。",
        "本地两家企业已说合同在受影响，承包商更紧张。",
        "你的办公室自己就用着外包的电话与云服务。"
      ],
      rumor: [
        "有人说文件比登出来的多得多。",
   ...
   * ==================================================================== */
  {
    ...
    body: "拨不出钱的联邦雇员被通知回家，国家公园上了锁，签证与检查排成长队。中期选举前一年，你的电话一半是问公园能不能进，另一半是问房贷批不批得下来。\n" +
      "同一件事在两种口径里：一种是守住原则，一种是拿别人的工资当人质。",
    brief: {
      lede: "停摆把原则之争变成了排队的人；谁替排队的人说话，谁就占了下一轮的位置。",
      known: [
        "本地有几百家靠联邦合同和小企业贷款过活的店。",
        "两党支持率都在往下掉，选民在找一个人负责。",
        "继续决议只能撑到年底，问题还会再来一次。"
      ],
      rumor: [
        "有人已经在起草甩锅用的联合声明。",
   ...
   * ==================================================================== */
  {
    ...
    body: "午后的枪声之后，那条街在十天内变成了两个国家：一边举着名字游行，一边是装甲车与闪光弹的夜。国家警卫队进驻，记者被扣。\n" +
      "大陪审团要等到秋天。你的电话一边说「他手上没枪」，另一边说「你敢不信警察试试」。",
    brief: {
      lede: "定性与程序之间隔着一群愤怒的人；每早说一句都更像答案，也更像站队。",
      known: [
        "尸检与弹道已做，但卷宗不对外，只有大陪审团能看。",
        "本地警力的构成与街区人口明显不一致。",
        "两次和平游行之间确实有人砸了三家铺子。"
      ],
      rumor: [
