...
POTUS.define("event", [
    ...
    choices: [
      {
        ...
        cost: { ap: 1, rep: 1 }, stake: { ap: true, fav: true },
        outcomes: {
          crit: eOut("你讲了六分钟，其中五分钟在讲你母亲来这个国家的第一年。散场的时候没有人跟你握手，他们只是把手放在你肩膀上。这个社区从此记住了一件关于你的事。",
            { rep: 6, contact: { preacher: 18, brother: 6 }, fac: { church: 16, base: 12, civil: 8 }, flags: ["enclave_base"] }),
          ok: eOut("十分钟，讲了该讲的，不咸不淡。散场后有三个人来跟你说话，其中一个问了你的电话。",
            { rep: 3, contact: { preacher: 9 }, fac: { church: 8, base: 6 } }),
          meh: eOut("你讲得很得体，得体得像一份简历。台下的人礼貌地听完了。",
            { rep: 1, contact: { preacher: 3 }, fac: { church: 3 } }),
          fail: eOut("你讲了七分钟的政策。第五分钟起，后排开始有人走动。",
            { rep: -2, contact: { preacher: -6 }, fac: { church: -6, base: -4 } }),
          critfail: eOut("你在讲台上提到了一个这个社区正在吵的旧事，还站错了边。散场之后有人在门口等你，不是为了握手。",
            { rep: -5, contact: { preacher: -14 }, fac: { church: -14, base: -10, civil: -6 }, flags: ["scandal_1"] })
        }
      },
      {
      ...
      },
      {
        ...
        outcomes: {
          ...
          fail: eOut("你没去。牧师第二天通过一个共同的朋友问了一句「他是不是看不上我们」。这句话被转述了三次。",
            { rep: -2, contact: { preacher: -6 }, fac: { church: -6 } }),
          critfail: eOut("你没去，而那天的讲台上站着你的对手。他讲了六分钟，散场的时候有人替他按住了电梯门。",
            { rep: -4, contact: { preacher: -10 }, fac: { church: -10, base: -8 } })
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: eOut("你问对了。他们说的是街区改造款的申请材料 —— 一份需要有人去市政厅盯三个月的材料。你真的去盯了。三个月后这条街的门面换了七十扇。",
            { rep: 6, contact: { brother: 8, fixer: 10 }, fac: { civil: 14, base: 10, commercial: 6 }, flags: ["enclave_base"] }),
          ok: eOut("你问出来了，也办成了。不是大事，但他们记住了「这个人问问题的时候会记笔记」。",
            { rep: 3, contact: { fixer: 6 }, fac: { civil: 8, base: 5 } }),
          meh: eOut("你问了，他们说「没什么事，就是认识一下」。你知道这不是真话，但你没继续追。",
            { rep: 1, contact: { fixer: 2 }, fac: { civil: 2 } }),
          fail: eOut("你问得太直接了。七个人里有两个开始收拾茶具 —— 在他们的语言里，这叫送客。",
            { rep: -2, fac: { civil: -6, base: -3 } }),
          critfail: eOut("你答应了一件你办不到的事，而且当场说得很满。三个月后这条街上所有人都知道你「说了不算」。",
            { rep: -5, fac: { civil: -14, base: -8, commercial: -6 }, flags: ["scandal_1"] })
        }
      },
      {
      ...
      },
      {
        ...
        outcomes: {
          crit: eOut("你喝了两壶茶，听到了这条街三十年的历史，包括谁跟谁为什么结了仇。你什么都没承诺，但你是第一个愿意听完的人。",
            { rep: 3, contact: { fixer: 8, preacher: 4 }, fac: { civil: 8, base: 5 } }),
          ok: eOut("茶喝完了，寒暄也完了。你记住了三个名字，这就比大多数人做得多。",
            { rep: 1, contact: { fixer: 4 }, fac: { civil: 4 } }),
   ...
   * ======================================================================== */
  {
    ...
    grade: "mid", category: "civil", medium: "print",
    title: "三个投票站",
    ...
    choices: [
      {
        ...
        cost: { ap: 2, rep: 3 }, stake: { ap: true, fav: true },
        outcomes: {
          crit: eOut("你在市政厅门口开了一场十五分钟的记者会，说的全是数据。第二天方案被退回重审。一年后那三个站的双语选票使用率变成了原来的四倍 —— 因为从那天起有人开始问了。",
            { rep: 12, contact: { columnist: 12, preacher: 10 }, fac: { civil: 20, base: 14, press: 12, establishment: -10 }, flags: ["enclave_base", "civil_win"] }),
          ok: eOut("报纸写了。方案推迟了一年，第二年用了个折中的办法：两个站保留，一个站撤掉。你没法全赢，但你让这件事变得有档案可查。",
            { rep: 7, fac: { civil: 13, base: 8, press: 8, establishment: -6 } }),
          meh: eOut("有人写了。篇幅很小，登在地方版，第二天就没有下文了。方案照旧。",
            { rep: 2, fac: { civil: 5, base: 3 } }),
          fail: eOut("你站出来了，但话说得太重。选务处主任在委员会上把你描述成「想把行政问题政治化的人」。方案通过了。",
            { rep: -3, fac: { civil: 4, base: 2, establishment: -12, agency: -8 } }),
          critfail: eOut("你站出来之后，这件事变成了「某某人为了选票在闹」。三个站的双语选票如期取消，而且这一次没有人再提。",
            { rep: -6, fac: { civil: -6, base: -8, establishment: -12, press: -8 }, flags: ["scandal_2"] })
        }
      },
      {
        ...
        outcomes: {
          crit: eOut("你带着一份现成的替代方案去见他：把三个站的成本改由社区基金会承担一半。他在文件上签了字，还在备注里写了一句「由社区自筹解决」。那三个站保住了，而且没有人输。",
            { rep: 8, contact: { fixer: 8 }, fac: { civil: 12, establishment: 8, base: 8 }, flags: ["civil_win"] }),
          ok: eOut("他答应把撤并推迟两年。两年里你可以做很多事。",
            { rep: 4, fac: { civil: 7, establishment: 4 } }),
          meh: eOut("他收下了材料，也收下了你的客气。方案改了一个字：把「撤掉」改成了「并入邻近站点」。",
            { rep: 0, hp: -2, fac: { civil: 2, establishment: 1 } }),
          fail: eOut("他非常有礼貌地告诉你，他只是一名公务员。三天后方案按时通过。",
            { rep: -2, fac: { civil: 2, establishment: -4 } }),
          critfail: eOut("你去找他的这件事被人报了上去。委员会里有人问：「为什么有人要先找主任，再上报纸？」",
            { rep: -4, fac: { civil: 3, establishment: -10, agency: -6 } })
        }
      },
      {
        ...
        outcomes: {
          crit: eOut("他没有写行政决定，他写了一千七百个人的名字是怎么从名单上消失的。这篇稿子后来被别的报纸转载了十一次。",
            { rep: 10, contact: { columnist: 14 }, fac: { civil: 16, press: 14, base: 10 }, flags: ["enclave_base", "civil_win"] }),
          ok: eOut("稿子登了，选务处第二天改口说「暂时不撤」。你什么都没站出去，事情就成了。",
            { rep: 5, contact: { columnist: 8 }, fac: { civil: 9, press: 8 } }),
          meh: eOut("他写了，但写偏了：整篇在讲行政部门的预算困境。方案没有被撤回。",
            { rep: 1, contact: { columnist: 2 }, fac: { civil: 3, press: 2 } }),
          fail: eOut("他压了三周，最后说「这个题材今年写过了」。你浪费了二十天里最重要的那一周。",
            { rep: -2, contact: { columnist: -4 }, fac: { civil: -3, press: -2 } }),
          critfail: eOut("稿子见报的同一天，那位主任公开了另一份数据，证明这三个站去年只用了四张双语选票。你举的那一面旗被拆成了算术题。",
            { rep: -5, contact: { columnist: -8 }, fac: { civil: -8, base: -6, press: -8 }, flags: ["scandal_2"] })
        }
      },
      {
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: eOut("你让他们挂了靠。协会章程、值班表、禁止携带物品的清单，全是按你的意思写的。巡逻队跑了十一个月，这条街的夜间报案数降了六成，没有出过一件事。",
            { rep: 8, contact: { union_boss: 10, preacher: 8 }, fac: { civil: 16, base: 12, labor: 8, agency: -10 }, flags: ["enclave_base", "street_patrol"] }),
          ok: eOut("巡逻队成立了。有人不满意，但到了冬天，街上确实安静了一些。",
            { rep: 4, fac: { civil: 10, base: 8, agency: -6 }, flags: ["street_patrol"] }),
          meh: eOut("巡逻队成立了，跑了两个月，然后因为值班排不开而解体。街上的抢劫案回到了原来的样子。",
            { rep: 1, hp: -4, fac: { civil: 3, agency: -3 } }),
          fail: eOut("巡逻队成立的第三周，两个年轻人把一个路人堵在了巷口。没有人受伤，但警察来了两辆车。",
            { rep: -5, hp: -4, fac: { civil: 2, base: -4, agency: -14 }, flags: ["scandal_2"] }),
          critfail: eOut("你支持的巡逻队和警方在现场起了冲突，还上了本地新闻。这件事之后，两边的账都记在了你的名字上。",
            { rep: -8, hp: -5, fac: { civil: 3, base: -6, agency: -18, press: -8 }, flags: ["scandal_3", "investigation_open"] })
        }
      },
      {
        id: "police", text: "不搞巡逻队，去把警力要回来",
        base: 0.55, mods: [{ src: "attr", key: "INT", w: 0.4 }, { src: "fac", key: "agency", w: 0.4 }],
        cost: { ap: 2, fun: 8000 }, req: { fac: "agency", min: 10 },
        outcomes: {
          crit: eOut("你在预算听证会上把八个街区的等候时间做成了一张表，念了三分钟。一个月后这条街多了一个夜间巡逻车组，而且是常驻的。",
            { rep: 7, fac: { agency: 16, establishment: 8, base: 8, civil: 6 } }),
          ok: eOut("警局答应每周多加两班车。不多，但街上的人看得见警灯。",
            { rep: 4, fac: { agency: 10, base: 5 } }),
          meh: eOut("他们非常客气地听完了，然后说今年的编制已经定了。",
            { rep: 0, hp: -3, fac: { agency: 3, base: -2 } }),
          fail: eOut("你在听证会上说得太直接，让一位副局长当场难堪。车没加，那条街的等候时间变成了四十一分钟。",
            { rep: -3, fac: { agency: -8, base: -6 } }),
          critfail: eOut("你替警局说话这件事被那二十三个老板听说了。他们开始怀疑你到底是哪一边的人 —— 这条街上最怕的就是这个怀疑。",
            { rep: -6, fac: { civil: -12, base: -10, agency: 4 } })
        }
      },
      {
        ...
        outcomes: {
          crit: eOut("三个小时，吵了两次，最后谈成了一件小事：巡逻队负责打电话，警局承诺十分钟内接线。有时候两边不需要互相信任，只需要一个电话号码。",
            { rep: 10, contact: { union_boss: 8, fed: 8 }, fac: { civil: 12, base: 12, agency: 10, establishment: 6 }, flags: ["enclave_base"] }),
          ok: eOut("会开完了，两边都没有当场走人。这本身就是一个结果。",
            { rep: 5, hp: -4, fac: { civil: 7, base: 7, agency: 5 } }),
          meh: eOut("会开了四个小时，最后什么也没定。两边都对你很客气，两边都认为你在替另一边说话。",
            { rep: 0, hp: -5, fac: { civil: 2, base: 2, agency: 2 } }),
          fail: eOut("第三十分钟就吵起来了，一位老板说了不该说的话。会后那两位穿制服的先生对你说：「以后有事直接找我们。」",
            { rep: -3, hp: -4, fac: { civil: -6, base: -6, agency: 4 } }),
          critfail: eOut("会议记录被谁传了出去。两边都从里面挑出了对自己有利的句子，然后同时开始怀疑是你放出去的。",
            { rep: -7, hp: -5, fac: { civil: -10, base: -8, agency: -8, press: -6 }, flags: ["scandal_2"] })
        }
      },
      {
   ...
   * ======================================================================== */
  {
    ...
    grade: "major", category: "career", unique: true,
    ...
    choices: [
      {
        ...
        cost: { ap: 3, rep: 2 }, stake: { ap: true, fav: true },
        outcomes: {
          crit: eOut("你站起来了，只说了两句话：「我不搬走。不管选上选不上，我下个月还来这儿。」然后你听见椅子响成一片。这一年你多了四千个会替你敲门的人。",
            { tier: 1, rep: 14, contact: { preacher: 20, brother: 10, union_boss: 10 }, fac: { civil: 22, base: 18, church: 12, establishment: -8 }, flags: ["enclave_base", "enclave_standard"] }),
          ok: eOut("你接下了。第二天早上六点，就有三个人站在你的门口等着派活。",
            { tier: 1, rep: 9, contact: { preacher: 14, brother: 6 }, fac: { civil: 15, base: 12, establishment: -6 }, flags: ["enclave_base"] }),
          meh: eOut("你接下了，但是你在会上多说了一句关于「资源整合」的话。屋子里安静了一下，然后有人换了个话题。",
            { rep: 4, contact: { preacher: 6 }, fac: { civil: 8, base: 6 } }),
          fail: eOut("你接下了，但你提了一个条件：班底要由你的人来选。这句话在这个地下室里等于说「你们不懂竞选」。",
            { rep: -3, contact: { preacher: -8 }, fac: { civil: -8, base: -6 } }),
          critfail: eOut("你接下了，然后这件事在两星期内传到了党内。你同时变成了两边都在观察的人 —— 而这两边都不喜欢被观察。",
            { rep: -6, contact: { preacher: -10 }, fac: { civil: -10, base: -6, establishment: -14 }, flags: ["scandal_1"] })
        }
      },
      {
        ...
        outcomes: {
          crit: eOut("你推的是这条街上一个开了十九年餐馆的人。他赢了。五年之后，那个位子上的人做每一个决定之前，都会先打一个电话问一句「公所那边怎么说」。这个电话打给你。",
            { rep: 10, contact: { preacher: 16, fixer: 14, lobbyist: 10 }, fac: { civil: 14, base: 12, establishment: 12 }, flags: ["enclave_base", "kingmaker", "enclave_standard"] }),
          ok: eOut("他赢了，你站在人群后面。没有人知道是你出的钱，但需要知道的人都知道。",
            { rep: 6, contact: { preacher: 10, fixer: 8 }, fac: { civil: 9, base: 7, establishment: 6 }, flags: ["kingmaker"] }),
          meh: eOut("他输了，输得很难看。你出的钱没有人提起，但你自己把那笔账记下了。",
            { rep: -1, contact: { preacher: 3 }, fac: { civil: 3, base: 2 } }),
          fail: eOut("他输了，而且他在败选演说里提到了所有帮过他的人 —— 除了你。这条街上最尴尬的事就是这样被记住的。",
            { rep: -4, contact: { preacher: -6, fixer: -6 }, fac: { civil: -6, base: -4 } }),
          critfail: eOut("他赢了，然后半年后开始装作不认识你。你出的钱、你的人、你的名单，最后培养的是别人的资本。这在这个行业里有个很旧的名字。",
            { rep: -6, contact: { preacher: -10 }, fac: { civil: -10, base: -8, establishment: 4 }, flags: ["scandal_1"] })
        }
      },
      {
        ...
        outcomes: {
          crit: eOut("你说：「明年这时候如果我还没走，你们再问我一次。」屋子里有人笑了。这三年里他们每年都问你一次，而每一次你都还在。这才是最贵的东西。",
            { rep: 8, contact: { preacher: 14, brother: 8 }, fac: { civil: 16, base: 10, church: 8 }, flags: ["enclave_base"] }),
          ok: eOut("你谢绝了。他们没有勉强，还留你吃了一顿饭。这个社区对你的看法没有变，只是这件事落到了别人头上。",
            { rep: 4, contact: { preacher: 8 }, fac: { civil: 8, base: 5 } }),
          meh: eOut("你谢绝了，理由说得有点绕。屋子里的人开始收拾椅子。",
            { rep: 1, contact: { preacher: 2 }, fac: { civil: 2 } }),
          fail: eOut("你谢绝之后多解释了两句。在他们听来，那两句的意思是「我看不上这个位子」。",
            { rep: -4, contact: { preacher: -8 }, fac: { civil: -10, base: -6 } }),
          critfail: eOut("你谢绝了，然后三个月后又去找他们要支持 —— 这次是为了你自己的一个项目。他们给了，但从那天起你在他们的账本上换了一个分类。",
            { rep: -7, contact: { preacher: -16 }, fac: { civil: -16, base: -10, church: -8 }, flags: ["scandal_2"] })
        }
      }
    ]
  }
