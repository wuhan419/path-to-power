...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "十一月的开票夜，农业州与南方一块块翻色——参院净丢九席，多数党鞭换了人；对面的众院差距同时扩大。" +
      ...
      "党部里你的电话两线同时响：一线要你谈路线，一线要你闭嘴。",
    brief: {
      lede: "多数丢了，路线要重算，所有人都在等你先开口。",
      known: [
        "参院多数已失手，总统任期后段进入否决模式。",
        "人事与拨款议程全部重排，委员会椅子等着重分。",
        "本地捐款人已来电话，问你跟哪条线。"
      ],
      rumor: [
        "有人说白宫早内定拿几个败选席位当代价。",
      ...
      terms: [{ k: "中期选举", v: "总统任期过半之年的国会全面改选。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "八月中，一支境外武装把本国记者处决的录像放上流媒体，四十八小时内循环在每一块屏幕上；九月底，" +
      "首例输入性传染病确诊入院，十月初病人离世、两名本地护士相继阳性——急诊筛查、禁令请愿与「安全」立法拉满排队。国会赶在中选前表决，每个人都要显得强硬。\n" +
      "你手上只有一张牌：这个星期之内，你必须对两件还没搞清楚的事各说一句话。",
    brief: {
      lede: "恐慌同时来了两趟，都赶在选举之前。",
      known: [
        "两件事定性都未定，都在等本地人物先开口。",
        "选前窗口只剩几周，表态会被印进广告。",
        "本地急诊筛查能力有限，缺口名单在你桌上。"
      ...
      terms: [{ k: "输入性病例", v: "在境外感染、入境后发病的确诊个案。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "七月，主要大国与德黑兰签下框架协议：核查换制裁解除，技术附件厚过一本电话簿。" +
      ...
      "游说预算与捐款一夜分成两极，两边都在订你的档期。",
    brief: {
      lede: "协议才签两周，它已经变成一场忠诚考试。",
      known: [
        "初选会把协议当必问题，回避不了一整年。",
        "两边捐款与游说都在订你的档期。",
        "技术附件没几个人读完，表态只剩情绪。"
      ...
      terms: [{ k: "核查换解禁", v: "以开放核设施检查换取制裁分阶段解除。" }]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      ...
      terms: [{ k: "选举年惯例", v: "大选年内不推进最高院提名的政治先例。" }]
    },
    choices: [
      {
