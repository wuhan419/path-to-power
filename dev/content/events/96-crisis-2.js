...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "洪水把选区分成两半：泡在水里的一半，和看着的一半。",
      known: [
        "低洼三个街区进水，救援队「最快中午到」——现在才早上六点。",
        "牧师传话：你的人在这看你来不来。这三街区你稳拿。",
        "抽水泵、沙袋、警卫队卡车都在往市里调，谁声音大谁先拿到。"
      ],
      rumor: [
        "县应急主任和你对手是猎友，排队顺序能商量。",
        "外州承包商先遣车已进县界，清理合同还没签人就到了。"
      ],
      unknown: [
        "水退后谁在水里、谁上镜，选区会记住。",
        "重建合同两周内签出，是下轮的起点。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "一页纸通告，两千三百份人生，和你的一整个下午。",
      known: [
        "这厂养了选区两代人，两千三百岗位背后是几乎一半的选票。",
        "工会头目说得很直：他有八百个会员，现在需要知道你干什么。",
        "县里筹码有限：减税、基建、培训——每样都要有人牵头背期望。"
      ],
      rumor: [
        "总部还在等两个州的报价，「拯救」这个词有标价。",
        "厂里的地皮早就被评估过了：关厂后那块滨水地更值钱。"
      ],
      unknown: [
        "厂关还是留，你能影响却定不了。",
        "一年后失业率会逐字核对今天的豪言。"
...

  {
    ...
    brief: {
      lede: "数字不讲情面，不讲过程，只讲结果。",
      known: [
        "失业率 11%，比关厂前翻倍。你的对手已经查了。",
        "你在厂门口、听证会、广播里说过的每句话都有存档。",
        "还有两千多个家庭的信箱，一些还在培训等待名单上。"
      ],
      rumor: [
        "对手下一条广告已剪好：你的承诺原声配失业率红线。",
        "新雇主二期工程真的在谈——但要选后才官宣。"
      ],
      unknown: [
        "你种下的有没有发芽，下份季报见分晓。",
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "病看不见，恐惧看得见——恐惧的传播比病快。",
      known: [
        "县医院医生是你旧识，要隔离配合、物资、有人肯出面。",
        "药房限购、教堂取消礼拜、学校今晚紧急开会。信息越少传闻越多。",
        "恐慌要人管，秩序要人立，锅要人背——每个年代都一样。"
      ],
      rumor: [
        "有人说疫情被夸大——说这话的人自己囤了两柜药。",
        "县里储备的物资被调去了有钱的县，单子在某个抽屉里。"
      ],
      unknown: [
        "医生只给区间，可你说的数字会被记住。",
        "大家会忘病毒，不会忘你说过什么。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "两个水泵站备用电源没启动——你上周刚签批过它的检修预算。",
        "公用事业公司要五天加紧急拨款，费率是平时的 1.8 倍。",
        "市政厅外已经聚了人，手机拍的是你办公室那扇亮着的窗。"
      ],
      rumor: [
        "检修预算去年被挹去修路了，批文上有你的会签。",
        "公司早交过风险报告，被两届政府连续无视。"
      ],
      unknown: [
        "你今晚说的数字，就是标准答案。",
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "这家行持有选区一半家庭的存款：工资户、教会账、小店周转金。",
        "经理不要你救银行，只要一个大家信的人出来说「我也存这」。",
        "监管通道存在但很慢。周一是发薪日，存不住钱恐慌会翻倍。"
      ],
      rumor: [
        "银行把存款押在贬值资产上，传闻一天翻三种。",
        "队伍里有人认出经理太太昨天来取过钱——这条最伤人。"
      ],
      unknown: [
        "账本好坏经理也在等，但恐慌不等数字。",
        "你每句话要么止住队伍要么立墓碑。"
