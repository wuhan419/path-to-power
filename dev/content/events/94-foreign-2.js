 ...
 * 每条卡留下的信息差都比普通线重；foreign/agency 派系好感是这条线的货币。
 *
 * 年代敏感的处理折进正文（#41 起背景卡下线）：1960 的冷战与禁运、
 * 1974 的石油与解冻、2008 的全球化与反恐，由正文自己交代清楚。
 *
 * 老规矩：字符串只用「」；每个事件有保底选项（无 cost 无 req）；
 * 标题 + 正文 ≤250 字；正文交代局面但不剧透后果。
 * ==========================================================================*/
...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "贸易代表团下周出发（政府或半官方带企业出门牵线的出访团），你在名单上——最后一位，因帮一家公司跑手续被顺手塞了进去。行李、签到、跑腿都是你的活，但正式饭局讲座次，大堂和迟到的巴士才是换名片的地方。据说使馆的商务参赞手里有一笔看心情给的「友谊采购」额度。你以为的闲聊，可能已经进了另一份简报。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "竞选账上的钱撑不过两个月，老熟人领来的中间人送上一笔「完全合法」的钱：抬头是一家你没听说过的本地公司，数字是你现有账面的一倍。外国政府不得给美国竞选捐款——但经一家美国子公司或「本地合伙人」转手，纸面就干净了。据说那家公司去年才注册，地址是间共享办公室。这笔钱自带的不是利息，是账本。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "那位文化参赞（持外交豁免的使馆文化交流官）三个月里「偶遇」你四次，这次又恰好坐在你旁边——带着你需要的那本书，和一顿饭的邀请。他不问机密，只聊人事和日程，聊完总留点小礼物。外交圈老话：文化参赞十个有九个半是情报口的。他记得你女儿的钢琴比赛名次——你只在电话里跟妻子提过一次。而盯着他的反谍部门（盯外国外交官接触网的反间谍人员），从此也看见跟他吃饭的你。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    title: "一批难民要安置到你的选区",
    body: "联邦把下一批难民分到你的辖区：八十到一百五十人，走的是联邦与志愿机构合作的安置体系。安置机构要你出现在欢迎现场——你的一句话能募到一冬的冬衣。选民已经吵成两半：一半「欢迎」，一半「谁问过我们」。据说名额没定死，县里喊声「困难」就能分流。真正决定选票的是这个话题，不是实际人数。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    title: "一个国际论坛请你上台发言",
    body: "有声望的国际论坛请你发言——这类多边会议的言论默认公开，「就任何议题说几句」的意思是句句上记录。你的名字排在参议员与州长之间，台下坐着媒体、大使和几家智库的人。通讯主管备了两版稿：一版只有赞美，一版有观点会锋利。据说有代表团想安排一场「非正式接触」——外交黑话，不在日程表上的会面——名单上有你。台下有人等你出错，也有人等你讲完递合作书。",
    choices: [
      {
