 ...
 * 铁律见 docs/EVENT-WRITING-BRIEF.md。社交媒体 2008 才有，本包不写 social。
 * ==========================================================================*/
...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "这事砸到每个人头上，而你被推上前台，是因为你既要安抚送儿参军的家庭，又要面对突然被盘问的阿拉伯裔、南亚裔邻居。",
        "支持动用武力与加强监控的民意高到离谱，此刻说「慢一点」等于自毁。",
        "一场没尽头的「反恐战争」和一部新法案，正在以极快的速度成型。"
      ],
      rumor: [
        "有人说情报系统早有线索，只是没人把它们连起来。",
        "有人说政府正借这场恐攻，塞进一批和反恐没多大关系的扩权条款。"
      ],
      unknown: [
        "这场「战争」会打几年、会不会把你自己也送上战场。",
        "今天为你换来掌声的那些监控权，十年后会指向谁。"
      ],
      terms: [
        { k: "爱国者法案", v: "9·11 后迅速通过的大规模扩权反法法案，大幅放宽监听与搜查，争议延续至今。" }
      ]
    },
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "轮到你，是因为辖区的合规与预算从你这条线走，你不点头，联邦来人就得层层找。",
        "配合能换来联邦的信任和一笔反恐拨款；抵触会被记成「不合作」。",
        "调阅是无差别的——今天被查的人里，可能有你最铁的捐助者。"
      ],
      rumor: [
        "有人说这些调阅记录最终会流向选举数据公司，变成「精准打击」的弹药。",
        "也有人说真被盯上的没几个，多数只是走个过场。"
      ],
      unknown: [
        "今天你替他们开的这扇门，将来会不会有人拿着它来查你。",
        "那笔反恐拨款会不会变成绑住你的绳子。"
      ],
      terms: [
        { k: "调阅令", v: "新法授权执法部门索取个人记录的手续，被批评为绕过了传统的司法审查。" }
      ]
    },
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "要你的背书，是因为你这条线能带来一份「地方一致支持」的漂亮材料，喂给全国的怀疑者。",
      ...
      unknown: [
        "多年后「你当时信了什么」会被写进哪一份调查报告。",
        "这场仗会不会真如保证的那样「几天结束、自会带来自由」。"
      ],
      terms: [
        { k: "大规模杀伤性武器", v: "为发动伊拉克战争提出的核心理由，战后被证实情报存在严重误导。" }
      ]
    },
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "这事过到你面前，是因为本地机场的安保预算与人员都归你这条线批，警报每升一级，你的账就紧一分。",
        "「橙色」意味着更高的可见警戒，也意味着媒体每几周就重播一次同一堆烟雾。",
        "本地靠旅游业吃饭的人开始抱怨：天天橙色，客人不敢来。"
      ],
      rumor: [
        "有人说这套警报其实毫无信息量，纯粹为了让人觉得「政府在做事」。",
        "也有人说真有情报被这套分级「稀释」了，老百姓早就对橙色麻木。"
      ],
      unknown: [
        "靠喊危机换来的配合，什么时候会反噬成「狼来了」。",
        "你这次为「橙色」争取的那笔安保拨款,几年后还算不算数。"
      ],
      terms: [
        { k: "色彩警报", v: "9·11 后推出的五级颜色威胁等级，因频繁发布、含义模糊而广受质疑。" }
      ]
    },
    choices: [
      {
...
POTUS.define("balance", {
  tagNames: {
    civil_liberties: { name: "守住自由线", desc: "在最恐高的民意里拦下了过火的扩权条款。", effect: "公信力与舆论长期认可，情报与建制系统对你有戒心。" },
    home_front: { name: "顾家的人", desc: "9·11 后先顾本地军属与被怀疑族裔，不抢着喊打。", effect: "基层口碑扎实，却被鹰派嫌「不够热血」。" },
    proceduralist: { name: "程序把关人", desc: "在配合联邦时坚持每份调阅都留档走程序。", effect: "联邦嫌你繁琐，本地觉得你可靠。" },
    quiet_shield: { name: "暗中挡了一把", desc: "面上配合、暗里给可能被查的人递了信。", effect: "一批社区承你的情，一旦暴露会被系统清算。" },
    wmd_endorser: { name: "曾背书开战", desc: "为伊拉克战争递过早期地方背书。", effect: "当下受上层赏识，战争泥潭化后成为随时被翻的旧账。" },
