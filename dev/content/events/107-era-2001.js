...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "上午的烟还没散，第二座塔也倒了。「本土不会被打」这个假设几小时里彻底作废。\n" +
      "国会两党争先表态要「做点什么」，动武与加监控的民意高到离谱——此刻说一句「慢一点」就等于自毁。一场没有尽头的「反恐战争」和一部放宽监听搜查的新法案（爱国者法案）正以极快的速度成型。\n" +
      "国旗一夜挂满每辆皮卡；你选区里有人刚被无端盘问，也有正在征兵站排队的人。有人说情报系统早有过线索，只是没人把它们连起来。今天你用掌声换来的监控权，十年后会指向谁？",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    title: "联邦来人在你辖区调阅记录",
    body: "新法案给了一纸调阅令：不必法官、不必审查，就能拿走图书馆借阅、银行流水、就医记录。这次要用在你的地盘。\n" +
      "辖区的合规与预算都走你这条线，字得你签。上面递来一句话：「别问，配合就行。」配合换来联邦的信任和一笔反恐拨款，抵触会被记成「不合作」。\n" +
      "可调阅是无差别的：今天被查的，可能就是你最铁的捐助者；你的选民里，也有人正担心是不是自己。你今天开的这扇门，将来会不会被拿来查你？",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "情报摘要摊在桌上：一个「可能被藏起来」的大规模杀伤性武器，一个「可能和恐怖分子挂钩」的政权；每个「可能」下面都印着「尚无确证」。\n" +
      "替你念摘要的情报官员自己在私下摇头，可决策层已经在倒计时。民调还在高位，此刻反对这场仗的政治成本高得没人肯付——他们要的是你这条线递上去的一份「本地一致支持」。\n" +
      "有人说，真正想打这一仗的人上一仗就没打完。你今天信了什么、是谁让你信的，将来会被写进哪份报告？",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    medium: ["print", "tv"],
    title: "本土威胁等级又调成了「橙」",
    body: "一套五色的「威胁警报」（9·11 之后的五级色阶）挂上了全国新闻，隔三差五就在「高」与「警戒」之间跳，从没降回过「蓝」。橙色就是更高警戒：本地机场加派了警察，告示牌上写着「如发现可疑请报告」。\n" +
      "机场安保预算归你批：颜色每升一级，你的账就紧一分；靠游客吃饭的商店已经在抱怨。有人说这套警报根本没有信息量，只是要显出政府在做事——喊多了，下一回真出事还有谁信？",
    choices: [
      {
