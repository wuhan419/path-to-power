...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    body: "你花两个下午摸清一件事：城里想往上爬的年轻人都要同一样东西，却找不到地方买。你找到了货源。\n" +
      ...
      "中间人不见生面孔，钱要你先垫：灰生意没有账期，也没有合同。你唯一的优势是这条街上认得你脸的人还不算多。" +
      "有人说上个月有人这么干过，名字被学校记了下来。迟早有人会问：他凭什么办得到。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "社区里有个做皮具生意的人，私下也放贷。他不签合同——在这个社区，靠的是熟人和面子，赖账的比签字的少。\n" +
      ...
      "他比银行贵得多，也快得多、安静得多：只借几个星期，利息按次算，不要抵押物，要一个肯替你说话的人。" +
      "有人说这笔钱并不属于他，他上头还有一层。你若还不上，他先找你还是先找你哥——这句他没说。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "有人把一个牛皮纸袋塞给你就走，连名字都没留。里面是一份复印的人事记录：某位在职官员三年前签过一份文件，\n" +
      ...
      "你现在握着足以让一个人就范的把柄。\n" +
      "他还站在位子上，正好卡着你要过的那道门。拿着不犯法，用才犯法；这种纸跟着人走——人一退，它就作废。" +
      "有人说第二份已经在某家报社的抽屉里。你更好奇的是，塞给你的人想从这件事里拿到什么。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "旧城区有家挂着双语招牌的医务中心，进门得先说清楚自己不是来找麻烦的。\n" +
      ...
      "这里最赚钱的生意不是看病，是替人签掉几天时间：纸他签得起，执照他赔不起。他有个女儿还在念书。" +
      "有人说他留了一本底账，记着所有让他签过字的人——你不知道他今天会不会往里再加一个名字。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "工会大楼的会议室一股咖啡和旧地毯味。头目听你讲了十分钟，只问了一句：「你要我的人替你做什么？」\n" +
      "这句话答错，你这辈子都不用再进这栋楼。\n" +
      "他有八千会员，初选那天他们先看他会怎么站。你替他们守过三个通宵的登记台，会员认得你。" +
      "他要的不是钱，是下份合同里别把他的人卖了。有人说他正在挑接班人——这件事比合同重要。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "市议会下周要表决一份外包合同，电话响了，是工会头目本人。\n" +
      ...
      "外包就是把公共服务交给私营公司做：账上省钱，岗位跟着走。八千个岗位压在你这一票上，全楼都在看你怎么投。" +
      "当年那句「签合同的手是我们的人」，你记得，报纸也记得。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "有人要给你一笔大到无法拒绝的钱，唯一的条件是别问他从哪来。\n" +
      ...
      "走正规渠道，三天之内会有四个人知道它从哪来；不走，它就变成小额捐款、咨询费、演讲费。" +
      "披露是把来源写进公开文件——写上去，等于交出自己的一角。\n" +
      "会计不怕这单生意，他怕的是某个下午你会把他交出去。有人说去年有一笔结构一模一样的钱，最后变成了起诉书。",
    choices: [
      {
