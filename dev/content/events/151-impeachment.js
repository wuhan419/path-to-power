...
POTUS.define("event", [
  {
    ...
    brief: {
      lede: "众院司法委员会凌晨通过了条款。你的支持率已连续四个月躺在危险线以下。",
      known: [
        "参院要三分之二才算定罪，而你自己党里已有四位参议员没有替你说话。",
        "把责任推给一位下属能换来几张票，但那名人会带着他知道的一切离开。",
        "辞职是三条路里唯一不会被投票羞辱的一条，也是唯一一条回不去的。"
      ],
      unknown: [
        "那卷你还没读完整的问询纪要里，最后三页写着谁的名字。"
      ]
    },
    title: "条款已经送上来：三分之一的人准备投票，包括你自己人",
    body: "众院在午夜通过了两条弹劾条款，措辞比草稿更克制，因此显得更狠。参院的多数党领袖给你留了一句话：他还数得出五十一票，但他不确定五十一票里有几位愿意在电视上坐在你旁边。你的支持率连续四个月低于警戒线，而调查还开着。白宫律师在你左手边，幕僚长在右手边，两个人给的建议是同一句话的反面。",
    choices: [
      {
