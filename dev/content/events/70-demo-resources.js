    ...
    choices: [
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 16, fac: { base: 18, press: 12 }, attr: { CHA: 4 } }
          },
          ok: {
          ...
          fail: {
            ...
            effects: { rep: -6, fac: { base: -6, press: -8 } }
          },
          critfail: {
            body: "你当场翻脸拍了桌子。画面循环播放了一整周。",
            effects: { rep: -12, fac: { base: -14, press: -16 }, flags: ["scandal_3"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 10, fac: { establishment: 10, commercial: 8 } }
          },
          ok: {
            body: "程序被拖成了迷宫，最后不了了之。",
            effects: { rep: 5, fac: { establishment: 5 } }
          },
          meh: {
            body: "你安全了，但纳税人买单的账被媒体翻了出来。",
            effects: { rep: 1, fac: { base: -5, press: -4 } }
          },
          fail: {
            body: "对方看出你在用钱拖延，舆论站到了他们那边。",
            effects: { rep: -5, fac: { base: -9 } }
          },
          critfail: {
            body: "律师团当庭爆出另一桩旧案，你连辩白的机会都没有。",
            effects: { rep: -11, fac: { base: -14, press: -12 }, flags: ["scandal_4"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 6, fac: { establishment: 12 } }
          },
          ok: {
          ...
          critfail: {
            ...
            effects: { rep: -10, fac: { establishment: -14, press: -14 }, flags: ["scandal_4"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 12, fac: { establishment: 20 } }
          },
          ok: {
            body: "你的老关系替你说了话。风暴被按在纸面之下。",
            effects: { rep: 7, fac: { establishment: 12 } }
          },
          meh: {
          ...
          critfail: {
            ...
            effects: { rep: -9, fac: { establishment: -16, press: -10 }, flags: ["scandal_3"] }
          }
        }
      },
      {
        ...
        outcomes: {
          ...
          meh: {
            body: "有人拍到你当天在高尔夫球场。",
            effects: { rep: -3, fac: { base: -6, press: -5 } }
          },
          fail: {
            body: "缺席被解读为心虚，媒体用了三个礼拜讲这件事。",
            effects: { rep: -7, fac: { base: -10, press: -10 } }
          },
          critfail: {
            body: "你的「病」被查出是伪造的证明。这一条比原指控更致命。",
            effects: { rep: -12, fac: { base: -14, press: -14 }, flags: ["scandal_4", "investigation_open"] }
          }
        }
      }
    ]
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 12, fun: 900000, fac: { commercial: 22 } }
          },
          ok: {
          ...
          fail: {
            ...
            effects: { rep: -5, fac: { commercial: 3, press: -9 } }
          },
          critfail: {
            body: "账目出了问题，你花的钱成了一条洗钱线索。",
            effects: { rep: -9, fac: { commercial: -12 }, flags: ["launder", "investigation_open"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 8, fun: 250000, fac: { commercial: 16 } }
          },
          ok: {
            body: "你被记住了名字。",
            effects: { rep: 4, fun: 60000, fac: { commercial: 8 } }
          },
          meh: {
          ...
          fail: {
            body: "礼物的价签没撕干净。",
            effects: { rep: -5, fac: { commercial: -8, press: -6 } }
          },
          critfail: {
            body: "送礼被定性为贿赂，检方开始过问。",
            effects: { rep: -10, fac: { commercial: -14, agency: -10 }, flags: ["scandal_4"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 14, fac: { base: 14, commercial: 10, church: 8 } }
          },
          ok: {
            body: "有人被打动了，虽然没给钱。",
            effects: { rep: 6, fac: { base: 8, commercial: 4 } }
          },
          meh: {
          ...
          fail: {
            body: "有人中途开始看手机。",
            effects: { rep: -4, fac: { commercial: -8 } }
          },
          critfail: {
            body: "你说到激动处骂了在座的一个人。宴会提前散了。",
            effects: { rep: -9, fac: { commercial: -18, base: -6 } }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 15, fac: { press: 18, base: 12, commercial: -12 } }
          },
          ok: {
            body: "新闻有了，金主们觉得你很危险。",
            effects: { rep: 6, fac: { press: 10, commercial: -8 } }
          },
          meh: {
            body: "稿子发在第三版。没人读到。",
          ...
          fail: {
            ...
            effects: { rep: -6, fac: { press: -4, commercial: -10 } }
          },
          critfail: {
            body: "你把金主惹毛了，也把记者得罪了。两边同时开火。",
            effects: { rep: -10, fac: { press: -12, commercial: -16 }, flags: ["scandal_3"] }
          }
        }
      }
    ]
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 10, fav: 2, fac: { establishment: 14 } }
          },
          ok: {
            body: "事情谈成了，代价是你会连着一周靠咖啡活着。",
            effects: { rep: 5, fav: 1, hp: -3, fac: { establishment: 7 } }
          },
          meh: {
          ...
          fail: {
            body: "他让助理在楼下打发了你。",
            effects: { rep: -3, hp: -3, fac: { establishment: -6 } }
          },
          critfail: {
            body: "你半夜出现在他家门口这件事，被写成了一封恐吓信。",
            effects: { rep: -9, hp: -4, fac: { establishment: -14, press: -10 }, flags: ["scandal_3"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 7, fav: 1, fac: { establishment: 10 } }
          },
          ok: {
            body: "拖住了。明早再说。",
          ...
          critfail: {
            ...
            effects: { rep: -10, fac: { establishment: -16 }, flags: ["tape_out", "scandal_3"] }
          }
        }
      },
      {
        ...
        outcomes: {
          crit: {
            ...
            effects: { rep: 4, fac: { establishment: 6 } }
          },
          ok: {
            body: "事情办妥了，助理第二天辞了职——但走前把整个流程写成了一页纸留给你。",
            effects: { rep: 5, attr: { CUN: 1 } }
          },
          meh: {
            body: "助理去了，对方没开门。",
            effects: { fun: -20000 }
          ...
          fail: {
            ...
            effects: { rep: -5, fac: { establishment: -9 } }
          },
          critfail: {
            body: "助理被收买了，带去的东西落到了对方手里。",
            effects: { rep: -9, fac: { establishment: -15 } }
          }
        }
      },
      {
        ...
        outcomes: {
          ...
          fail: {
            body: "他记住了你那个晚上没接电话。",
            effects: { rep: -4, fac: { establishment: -9 } }
          },
          critfail: {
            body: "那通电话决定了你的一个任命。你知道的时候，名单已经公布。",
            effects: { rep: -10, fac: { establishment: -14, agency: -8 } }
          }
        }
      }
    ]
