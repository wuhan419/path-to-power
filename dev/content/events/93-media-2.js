...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "你说的每一句都是素材，你没说的每一个停顿也是。",
      known: [
        "这份刊物专挑「正在往上走的人」写，你最近有了曝光度。",
        "那个记者上一篇写的同行三个月没接受任何采访。",
        "他不做问答做还原——会写你迟到的姿势和助理的眼神。",
        "刊物风格：不用脏字杀人，把细节放一起让读者自己得结论。"
      ],
      rumor: [
        "他采访你之前已经跟你圈子里三个人聊过了。",
        "他手上有一段你私人场合的录音，还没决定用不用。"
      ],
      unknown: [
        "他心里标题定了没有，见报那天才知道。",
        "你随口的漂亮话印在纸上还是你的话吗。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "文章印出来后，署名是你的，著作权是它的。",
      known: [
        "搜索你的名字跳出来的头一条就是那篇特稿。",
        "对手团队把其中三句做成了剪辑素材反复用。",
        "另一家刊物想做「回应版」，正向你团队要采访。"
      ],
      rumor: [
        "「回应版」的记者是那位作者的前同事，两人有旧怨。",
        "你的对手正在给那家刊物喂你的旧料。"
      ],
      unknown: [
        "不回应，那三句会不会长成你的标签。",
   ...
   * ======================================================================== */
  {
    ...
    body: "你在演讲里用了两年的那个数字 —— 每次讲都有掌声的那个 ——\n" +
      ...
      "明天出刊。你的团队在等你表态。",
    brief: {
      lede: "数字不全是假的，但它不再是真的了——这就是事实核查存在的理由。",
      known: [
        "这数字你引用了两年，至少十几个场合用过，录音都在。",
        "核查文章明天出刊，标题已定，语气很硬。",
        "来源是三年前的估算，连原作者都说被误用了。",
        "认错要一次认完；半认半不认会被两边各打一次。"
      ],
      rumor: [
        "把这件事递给核查栏目的人来自你对手的团队。",
        "原作者愿意帮你说话——只要你先公开认错。"
      ],
      unknown: [
        "你的支持者里有几成会看到那篇核查。",
   ...
   * ======================================================================== */
  {
    ...
    body: "选举年，辩论定在三周后。对手、主持人的风格、提纲的传闻范围，\n" +
      ...
      "排练室已经订好了，就等你进屋。",
    brief: {
      lede: "辩论不是回答问题的地方，是塑造「哪种人」的地方。",
      known: [
        "这场辩论大概率是你这一年观看人数最多的一晚。",
        "对手有一个众所周知的弱点，也有一套反击套路。",
        "过去六届辩论：赢的都只讲了一件事，输的什么都想讲。",
        "主持人喜欢追问不回答的人。追到第三次观众会记住。"
      ],
      rumor: [
        "对手团队已拿到提纲，正针对你的三个旧立场写台词。",
        "那天的主持人是你一位捐助者的旧识。"
      ],
      unknown: [
        "哪种风格能赢——赢了的人才回头解释。",
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "匿名的东西只负责一个任务：让人对你产生「那种感觉」。",
      known: [
        "你正在往上走，有了曝光度——无名小卒不值得贴纸。",
        "三个半真半假的事实各有真壳：查证成本极高，反驳听起来像辩解。",
        "印刷品能从纸和墨水追到印厂；网上帖子追到头常是注销账号。"
      ],
      rumor: [
        "传单上的用词和你对手阵营某笔杆子的习惯很像。",
        "这批纸的动作很专业，不像几个生气的人干的。"
      ],
      unknown: [
        "谁出的钱、谁动的手——经常不是同一个人。",
        "投票日前会再来一波吗。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "他不是来采访你的，是来通知你的。",
      known: [
        "你身上正背着风波，他正是从那件事开始盯上你的。",
        "他跟一条线可以跟五年，稿子不多但每篇都砸在点上。",
        "他打过三个大人物，倒了一个，剩下两个学会了先给他回电话。",
        "他不接受收买也不喜欢被冷落——喂他会写得客气，堵他写得更勤。"
      ],
      rumor: [
        "他年轻时被大人物毁过一次前程，从此专门盯人。",
        "他的编辑给了他指标：一年把你写上头版三次。"
      ],
      unknown: [
        "他先从哪下手——你也有不想翻的清单。",
        "第三年，是他版面先没还是你耐心先没。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "打了两年，你们互相塑造了对方。这本书是句号还是最后一颗子弹。",
      known: [
        "书里大概率以你为主角之一——写得坏，那个版本也会留下来。",
        "他的时间线每一条都属实，这一点最麻烦：你无法起诉事实。",
        "团队里有人说该拒绝：书反正会出，别给封面添你的配合。"
      ],
      rumor: [
        "出版社给的预付金不小，压力下书会更有戏剧性。",
        "他已在接触你当年最不希望出现的那个人。"
      ],
      unknown: [
        "书里关于你的那章标题是名词还是动词。",
