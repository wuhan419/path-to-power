...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    body: "一份全国性刊物的记者来了，要给你做一个整版人物特稿 —— 写的不是你的观点，是你这是个什么人：\n" +
      "观点能澄清，人设不能。他跟着你三天：两场活动、一顿晚饭、一次车程。\n" +
      "他不做问答做还原 —— 你迟到的样子、助理的眼神都是素材。他问的问题都很客气，\n" +
   ...
   * ======================================================================== */
  {
    ...
    body: "那篇特稿见报已经一阵子了，但它没有安静地躺进档案室 —— 搜你的名字，头一条就是它。\n" +
      "有人开始用文中的句子介绍你，对手把其中三句做成素材反复断章引用。\n" +
      "更麻烦的是：那家刊物的对手刊物想做一个「回应版」，正向你的团队要采访 —— 听说往那边递旧料的，就是对手。\n" +
      "文章印出来，署名是你的，纸是人家的。不回应，那三句话会不会自己长成你的标签？",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "你在演讲里用了两年的那个数字 —— 每次讲都有掌声的那个 ——\n" +
      "被一家事实核查栏目查了。结论很干脆：来源是三年前的一份估算，而且连那份估算的作者都说被误用了。\n" +
      "这个数你在十几个场合引用过，每一场都留着录音。明天出刊，标题已定，语气很硬，你的团队在等你表态。\n" +
      "认错要一次认完 —— 半认半不认，会被两边各打一次。\n" +
      "两年后人们记得的是那个数字，还是你认错的样子？这没人能替你算。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "选举年，辩论定在三周后 —— 大概率是你这一年观看人数最多的一晚。\n" +
      "对手、主持人的风格、提纲的传闻范围，你的团队把一切都贴在了墙上 —— 除了一个问题：你要做一个什么样的自己。\n" +
      "对手有一个众所周知的弱点，也练好了一套反击套路；主持人偏爱追问不回答的人，追到第三次观众会记住。\n" +
      "过去六届辩论：赢的都只讲成了一件事，输的什么都想讲。排练室已经订好了，就等你进屋。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "有人在半夜把它们贴了出来。内容全是「关于你」的：三个半真半假的事实，\n" +
      "一个被夸大四倍的数字，和一句手写的、阴冷的暗示。每条半真半假都有真壳：查证成本极高，反驳听起来像辩解。\n" +
      "你的团队从投票站门口、杂货店布告栏、和汽车雨刮器下面各揭回来一张 —— 这是印刷品，纸和油墨一路查得到印厂。\n" +
      "你正在往上走 —— 无名小卒不值得费这些胶水和墨水。出钱的和动手的，往往不是同一只手。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "那位记者约你在一家咖啡馆见面，开门见山。\n" +
      ...
      "这样写出来的东西你没法说我不公平。」你最近的风波给了他理由。他知道，你也知道。\n" +
      "这条线他能跟五年，稿子不多，每篇都砸在点上；他不接受收买，也不吃冷落那一套。\n" +
      "他先从哪下手 —— 你也有不想翻的清单。",
    choices: [
      {
      ...
      },
      {
        ...
        outcomes: {
          crit: m2("你寸土不让，但你的记录干净到让他跟了半年一无所获。他真的遵守了打招呼时的承诺：写出来的每一篇都对得起事实 —— 也包括那篇写你「滴水不漏」的。",
            { rep: 0.9, fac: { press: 6 }, attr: { INTG: 2 }, flags: ["med2_press_enemy"] }),
      ...
      },
      {
        ...
        outcomes: {
          ...
          ok: m2("你摸到了他的短处，通过中间人递了过去。他没撤，但稿子的频率肉眼可见地降了。你们心照不宣。",
            { rep: 0.3, lev: 1, attr: { CUN: 2 }, fac: { press: -6 }, flags: ["med2_press_enemy", "compromised"] }),
   ...
   * ======================================================================== */
  {
    ...
    body: "两年过去，跟你的那位记者已经成了你生活的一部分。\n" +
      ...
      "上个月他写了一篇长文，把你这三年做过的事排成了一张时间线 —— 每一条都属实，而你没法起诉事实。\n" +
      "现在他递来一个邀约：他要写一本书，想最后采访你一次。书写得再坏，那个版本也会留下来。\n" +
      "关于你的那一章，标题是个名词还是个动词？",
    choices: [
      {
      ...
      },
      {
        ...
        outcomes: {
          crit: m2("书出版了。你的部分全部来自公开记录和他人转述 —— 他是个好记者，写不出你没能给出的把柄。书评说这一章「冷静得近乎敬意」。",
            { rep: 1.25, voters: { diehard: 300, warm: 500 }, fac: { press: 6 }, flags: ["med2_press_book"] }),
          ok: m2("书出了，风波一场。你在书里是一个沉默的、不肯解释的身影 —— 有人读出傲慢，有人读出骨气。",
            { rep: 0.6, voters: { warm: 300 }, flags: ["med2_press_book"] }),
      ...
      },
      {
        ...
        outcomes: {
          ...
          ok: m2("你的书先出了。两本书各有各的读者，叙事权至少分了一半。",
            { rep: 1.5, funMul: 0.1, voters: { warm: 200 }, fac: { base: 5 }, flags: ["med2_press_book"] }),
