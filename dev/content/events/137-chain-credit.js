...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "去年八月那两只基金的事，如今全国有了大名：次贷。你县里的收房通知一周贴过一条街，法院台阶上摆起了法律援助的折叠桌。\n" +
      "昨晚来电显示上那个你不想忘掉的名字，是分行行长：他手里两位客户早早押了房价下跌（做空：跌了才赚），看对了方向，账面翻了几倍，那只基金还留着席位。电话那头的热情里夹着一层别的意思——他要的不只是替你高兴：县退休金的去向，你去年在董事会上表过态，他要的正是这个答案，和你叫得动的那些名字。\n" +
      "有人说这通电话已经打给过三个人。今天买进的名额，明天会写进披露表。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "这一年的华盛顿，银行老板一个个被请上证人席，对着镜头回答同一问题：你们当时知不知道。\n" +
      "改革法案在两党之间交换条款，危机后新设的监管机构已有名字，还差一张成立的票；两个委员会的邀请函落到你桌上，温度明显不同。街上的愤怒从两头烧过来：一头问谁该坐牢，一头问谁在为「大政府」买单。\n" +
      "听证材料袋里也有你的名字：2008 年那通电话、那笔钱、你说过的话，卷宗里都有。你不是头排被审的人，可聚光灯斜对面的座位恰好空着。豁免条款最后是谁写的？法案全文没人读完过。",
    choices: [
      {
