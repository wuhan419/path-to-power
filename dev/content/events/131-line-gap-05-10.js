 ...
 *     risk 卡保底五档净值压在 ±0.35 份内；经济只写系数；brief 交代认知边界；
...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    brief: {
      lede: "当捐款与合同捆成一条链，整条链都是案子。问题是谁的名字先被念出来。",
      known: [
        "说客的客户名单里有本地的承包商。",
        "你党部去年收过一笔经他事务所过手的捐款。",
        "参院已对数名在任议员启动伦理调查。",
      ...
      rumor: [
        "有人说参院正在起草一份对在任参议员的谴责案。",
        "有人说案卷里捐钱的人全列上了，只会起诉几个。"
      ],
      unknown: [
        "这案子会不会洗到地方。",
        "你的捐款进的是哪一份清单。"
      ...
      terms: [
        { k: "游说登记", v: "注册说客须公开委托人、议题与金额。" },
        { k: "工程款夹带", v: "议员塞进拨款法案的定向建设项目。" }
      ]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一月底，最高法院的确认听证走到表决前最后一里。在野党第一次成规模地把冗谈威胁摆上桌面，把议事规则本身逼成了议题：终结辩论的门槛要不要改，悬了三个礼拜。\n" +
      "最后五十八比四十二，确认通过。「司法哲学」这个词，第一次进了酒馆的争论。",
    brief: {
      lede: "被审的不只是提名人，还有参院自己：规则能不能被用来赢一次。",
      known: [
        "你州律师协会已就提名人公开表态。",
        "两党都在催你交一份「司法哲学」立场。",
        "表决门槛改不改，全看中间几位怎么坐。",
      ...
      terms: [
        { k: "冗谈", v: "少数党用连续发言挡表决，需超级多数才能终止。" },
        { k: "终止辩论动议", v: "结束冗谈进入表决的程序动议。" }
      ]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "十二月，占领国的特别法庭宣判：前国家元首犯反人类罪，处以绞刑，赶在新年前执行。行刑当天，一段现场手机录像就在网上传开——喊叫、讨价还价、最后一瞬。\n" +
      "那一周，那里的教派报复杀戮成倍往上翻。国内的晚间节目反复放这段录像，问的已经不是正义，是值得不值。",
    brief: {
      lede: "录像走进客厅那一刻，战争的账改由普通人家来算。",
      known: [
        "审判由当地法庭主审，联邦检方在幕后出力。",
        "手机从行刑现场流出，内部调查还没结案。",
        "本镇征兵站的开放日已经推迟了一次。",
      ...
      terms: [
        { k: "反人类罪", v: "对有平民的系统性杀戮，法庭最重的罪名。" },
        { k: "教派清洗", v: "两大教派逐城逐街地互相报复杀戮。" }
      ]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一月初，战争统帅在全国电视讲话里宣布向巴格达增兵两万一千人。参院已经换了主人：三周之内，拨款案被夹上撤离时间表，白宫回敬一份否决声明。\n" +
      "党团里的人开始按这一条线重新排队。你县国民警卫队第二拨开拔的家属，还在等你一句准话。",
    brief: {
      lede: "战略之争变成了程序之争：谁掌参院，谁就能摸钱袋。",
      known: [
        "夹了时间表的拨款案已排进表决。",
        "你州的军工厂订单挂在战争预算上。",
        "党团已有同事为战争公开反水。",
      ...
      terms: [
        { k: "增兵", v: "限期加派部队，试图扭转占领局势。" },
        { k: "拨款夹带", v: "把政策条款夹进钱袋案，很难单独摘掉。" }
      ]
    },
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "一月下旬，最高法院对一家非营利组织诉联邦选举委员会案落槌：公司与工会的独立政治支出，政府不得设限。留下的唯一规矩是——不得与候选人协调。\n" +
      "几个月内，「超级政治行动委员会」开张，募款上不封顶。筹款的算术一夜改写，当年中选的开销，照预期贵成了历史纪录。",
    brief: {
      lede: "闸门开了：从此不缺钱，缺的是被肯替你花钱的那张名单。",
      known: [
        "独立支出合法，红线只有「协调」二字。",
        "你委员会的募款上限还在，对手的不在。",
        "已有两家超级委员会在你州踩点。",
      ...
      terms: [
        { k: "超级政治行动委员会", v: "可无限募款，只禁与候选人协调。" },
        { k: "独立支出", v: "不经竞选阵营、自买自放的政治广告。" }
      ]
    },
    choices: [
      {
