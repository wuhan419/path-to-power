...
POTUS.define("event", [
  {
    ...
    brief: {
      lede: "药价法案众院已过、参院还差四票，一位绝症患者的母亲在你车队前的警戒线外静坐到第十一天。",
      known: [
        "公开她的病历强推原案能点燃舆论，但等于把一个家庭的痛摆上货架。",
        "接受药厂起草的「自愿降价」版本，票数马上够，可条款里的漏洞会慢慢长大。",
        "不动法案只发一份行政指引，最省政治资本，也最像什么都没做。"
      ]
    },
    title: "警戒线外的第十一天，和参院还差的那四票",
    body: "党团干事把计票板立在你面前：四票，卡在一位连任不稳的州议员身上。药厂的说客在门外等着递「自愿降价」的替代文本。那位母亲的静坐照片已经在电视上循环到第七天，记者天天在车队入口问你会不会看她一眼。幕僚长低声提醒你：距离党团定死的强制投票日只剩七十二小时。",
    choices: [
      {
  ...
  },
  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "internet"],
    brief: {
      lede: "党内要在选年前拿出一张「看得见的胜利」，你的税改草案里那条中产减税会把赤字曲线拉长十年。",
      known: [
        "按党的版本签，票仓满意，可赤字测算会在选后被对手翻出来当武器。",
        "砍掉自己竞选时承诺的那一条，能换来两党票，也会留下一道背信的口子。",
        "让财政部先出评估拖过选年，谁也不得罪，谁也都拿不到东西。"
      ]
    },
  ...
  },
  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "internet"],
    brief: {
      lede: "西部大旱第四年，科罗拉多河流域要重新分水，两个州长已经联名起诉第三个州。",
      known: [
        "联邦强制配额能立刻定分晓，也会同时得罪两个州的选民。",
        "只补农业用电不碰水权，能缓解眼前，可水还是不够分。",
        "把案子留给法院，最像中立，也意味着丰枯都由法官和天气说了算。"
      ]
    },
  ...
  },
  {
    ...
    brief: {
      lede: "你的第二届：投票权与重划选区法案卡在参院的冗长辩论里，改规则是毁掉这个机构还是输掉下一场选举。",
      known: [
        "公开要求废除冗长辩论能强行开门，也会在历史上留下你砸规矩的名字。",
        "私下劝两位老参议员弃权，成事安静，风险是谈话一旦被录下来。",
        "把这件事交给司法部去打官司，你全身而退，代价是法案被拖到任期之外。"
      ]
    },
    title: "最后一届，和那道拦在六十票门前的规矩",
    body: "这是你的第二段，也是选民还能用票根跟你说话的最后一段时间。投票权与重划选区法案卡在参院的冗长辩论规则里，六十票的门槛像一道永远抬不起来的闸门。党内年轻人已经开始数下一任会是谁，老参议员提醒你：改这条规矩，要么毁掉这个机构的体面，要么让你下一场选举输掉整个参院。你不再连任，唯一还烧得起的，是手里剩下的那点政治资本，和你想在离开前留下什么。",
    choices: [
      {
