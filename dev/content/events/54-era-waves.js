...
POTUS.define("event", [
  ...
  {
    id: "wave_draft_low",
    grade: "major", unique: true, category: "foreign", era: ["1960_CAMELOT"],
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你在军队里干得漂亮，带了一枚勋章和一口流利的履历回来。社区把你当英雄。", effects: { rep: 14, fac: { base: 12, military: 10 }, flags: ["wave_veteran"], hp: -6 } },
          ok: { body: "两年后你完整地回来了。没立大功，也没缺零件——这在那个年代已经算好结果。", effects: { rep: 8, fac: { base: 8, military: 6 }, flags: ["wave_veteran"], hp: -8 } },
          meh: { body: "你回来了，但带回了失眠和一点不敢碰的东西。人们谢你，你不知道怎么接。", effects: { rep: 5, fac: { base: 5, military: 4 }, flags: ["wave_veteran"], hp: -14 } },
          fail: { body: "东南亚的两年把你磨掉了半层。回来那天没有人接机，报纸头版在登别的事。", effects: { rep: 2, hp: -22, fac: { base: 3 } } },
          critfail: { body: "你躺在野战医院里过了三个月。回国后体检委员会给你定了伤残等级——和一生的雨天关节痛。", effects: { rep: 4, hp: -30, fac: { base: 5, military: 3 }, flags: ["wave_veteran"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你以顶尖成绩毕业，律所的录用函在手，征兵委员会再也没来找过你。", effects: { attr: { INT: 4 }, fun: 120000, rep: 2, flags: ["wave_deferred"] } },
          ok: { body: "文凭到手，兵役躲过。有些酒局里你会被问「你那时候在哪」，你学会了一句话带过。", effects: { attr: { INT: 3 }, fun: 60000, flags: ["wave_deferred"] } },
          meh: { body: "读是读完了，但成绩平平。你总觉得那三年是在别人的人生里躲雨。", effects: { attr: { INT: 1 }, flags: ["wave_deferred"], fac: { base: -3 } } },
          fail: { body: "毕业那年政策收紧，缓征被取消。你还是去了，只是比别人晚、且更愤怒。", effects: { hp: -12, rep: 3, flags: ["wave_veteran"] } },
          critfail: { body: "伪造缓征材料的传闻在县里传开了。没有证据，但从那以后征兵委员会的人见了你不点头。", effects: { rep: -6, fac: { base: -8 }, flags: ["wave_deferred", "scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你的发言被地区报纸整版刊登。一夜之间，全县的反战青年都有了名字喊。", effects: { rep: 12, fac: { base: 15, press: 8, military: -15 }, flags: ["wave_antiwar"] } },
          ok: { body: "你成了本地反战圈子的联络人。名单在你手里越滚越长。", effects: { rep: 7, fac: { base: 10, military: -10 }, flags: ["wave_antiwar"] } },
          meh: { body: "游行上电视了，镜头扫过你的脸只有一秒半。 FBI 的档案里那一秒可能更长。", effects: { rep: 4, fac: { base: 6, military: -8, agency: -5 }, flags: ["wave_antiwar"] } },
          fail: { body: "游行被冲散，你被拘留了一夜。父亲来保你的时候没有说话。", effects: { rep: 1, fac: { base: 4, military: -12, agency: -8 }, flags: ["wave_antiwar", "scandal_1"] } },
          critfail: { body: "你被拍了照：站在烧征兵卡的人群最前面。那张照片后来被用了二十年。", effects: { rep: -4, fac: { base: 5, military: -18, agency: -10, church: -8 }, flags: ["wave_antiwar", "scandal_2"] } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "拨款通过。总统在你的州提到「负责任的年轻议员」，党务系统把你的名字往上提了一格。", effects: { fac: { establishment: 12, military: 10, base: -6 }, rep: 5 } },
          ...
          critfail: { body: "几年后战争败局已定，你当初的发言被剪进纪录片，标题是「他们当时都知道些什么」。", effects: { rep: -8, fac: { base: -15, press: -8 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你的反对演说被三大电视网转播。一夜之间，全国的和平派都知道了你的名字。", effects: { rep: 14, fac: { base: 15, press: 10, establishment: -10, military: -12 }, flags: ["wave_antiwar"] } },
          ok: { body: "你投了反对票，成了党内「负责任的反对者」名单上最年轻的名字。", effects: { rep: 8, fac: { base: 10, establishment: -8, military: -8 }, flags: ["wave_antiwar"] } },
          meh: { body: "反对票没挡住拨款，但你的选区办公室收到了七百封感谢信。", effects: { rep: 4, fac: { base: 8, establishment: -6, military: -6 } } },
          fail: { body: "领导层兑现了威胁：你的委员会任命没了，办公室的预算也被砍到骨头。", effects: { rep: 3, fac: { base: 6, establishment: -12, military: -6 } } },
          critfail: { body: "反对票让你被扣上了「不爱国」的帽子。下次退伍军人协会的活动，你是被点名的那一个。", effects: { rep: -5, fac: { base: 5, military: -18, establishment: -10 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          ...
          fail: { body: "「胆小鬼」的说法在选区传开了。你解释了三次，越解释越像。", effects: { rep: -4, fac: { base: -6 } } },
          critfail: { body: "你缺席的照片（当晚在一家餐厅）被人拍了，寄给了报社。", effects: { rep: -7, fac: { base: -10, press: -6 }, flags: ["scandal_1"] } }
        }
      }
    ]
  },
...

  {
    ...
    grade: "mid", unique: true, category: "civil", era: ["1960_CAMELOT"],
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你在人群里听完了那篇演讲。回程的大巴上，有人提议你竞选当地的学区委员会——全场鼓掌。", effects: { rep: 14, fac: { base: 14, church: 6, agency: -4 }, flags: ["wave_civil60"] } },
          ok: { body: "你去了，你站了一天，你的嗓子哑了。回来的那个星期，登记站的志愿者翻了三倍。", effects: { rep: 8, fac: { base: 10, church: 4 }, flags: ["wave_civil60"] } },
          meh: { body: "你在人群的外围。听得不太清，但电视转播补上了。你参与了一个数字：二十五万分之一。", effects: { rep: 4, fac: { base: 6 }, flags: ["wave_civil60"] } },
          fail: { body: "大巴在州界被拦了三个小时，你们到的时候人群已经散了。你只赶上了垃圾和标语。", effects: { rep: 1, fac: { base: 3, agency: -3 }, flags: ["wave_civil60"] } },
          critfail: { body: "回程的大巴在南方某镇被围了半夜。没死人，但你答应自己不再谈那天的事。", effects: { hp: -8, fac: { base: 5, agency: -8 }, flags: ["wave_civil60"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "游行那天你登记了两百个新选民。三个月后，这批人成了本地选举的变量——一个属于你的变量。", effects: { rep: 10, fac: { base: 12, labor: 4 }, attr: { INT: 2 }, flags: ["wave_civil60"] } },
          ok: { body: "登记站的日子平静而具体：表格、铅笔、和一个个第一次写下自己名字的人。", effects: { rep: 6, fac: { base: 8 }, flags: ["wave_civil60"] } },
          meh: { body: "登记的进度慢得让人绝望。你开始理解为什么有人等不及要上街。", effects: { rep: 3, fac: { base: 5 } } },
          fail: { body: "登记站被砸了两次。第三次你把表格搬回了自己家。", effects: { rep: 2, fac: { base: 6, agency: -5 }, hp: -4 } },
          critfail: { body: "你收到一封装着弹壳的信。你把登记站挪进了教堂地下室，也把这件事告诉了警方——没有下文。", effects: { hp: -6, fac: { base: 4, agency: -8 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          ...
          critfail: { body: "你在信箱里看到邀请函的复印件——全县都收到了，只有你假装没看见。这话后来传到了牧师耳朵里。", effects: { fac: { base: -8, church: -8 }, rep: -3 } }
        }
      }
    ]
  },
  ...
  {
    id: "wave_gasline_low",
    grade: "mid", unique: true, category: "crisis", era: ["1974_WATERGATE"],
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你的互助名单成了一个微型组织：三百个家庭，每一家都欠你一个人情。地方报纸给了你一个外号：「排队律师」。", effects: { rep: 12, fac: { base: 15, labor: 6 }, flags: ["wave_gasline"] } },
          ok: { body: "互助运转起来了。老人们不再凌晨排队，你的名字在队伍里被口口相传。", effects: { rep: 7, fac: { base: 10 }, flags: ["wave_gasline"] } },
          meh: { body: "互助搞了两周就散了——油够用了。但你认识的那些人还在。", effects: { rep: 4, fac: { base: 6 }, flags: ["wave_gasline"] } },
          fail: { body: "有人指控你插队给自己的车加油。是误会，但误会传得比澄清快。", effects: { rep: -2, fac: { base: -4 } } },
          critfail: { body: "协调现场吵起来，推搡中一位老人摔倒住院。你陪着去的医院，付了账单，但报纸标题只写了前半句。", effects: { rep: -6, fac: { base: -8, press: -6 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你的读者来信被登成专栏，配了你拍的队尾照片。编辑问你要不要写系列。", effects: { rep: 10, fac: { press: 12, base: 6 }, flags: ["wave_gasline"] } },
          ok: { body: "来信登了，署名带职业。加油站的人说：写得像。", effects: { rep: 6, fac: { press: 8, base: 4 } } },
          meh: { body: "登在读者来信版的中缝，标题被编辑改小了两号。", effects: { rep: 3, fac: { press: 4 } } },
          fail: { body: "没有被刊登。你收到一封标准格式的退稿信。", effects: { fac: { press: 2 } } },
          critfail: { body: "照片里一辆车的牌照被放大见报，车主被邻居怀疑「占了便宜」，砸了他家窗户。你登门道歉，对方没开门。", effects: { rep: -5, fac: { press: 4, base: -10 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "配额批下来了。老板们凑了一笔「感谢费」——你收了一张加油卡，其余的让他们捐给了教会。", effects: { fun: 80000, fac: { commercial: 10, base: 4, church: 3 }, lev: 1 } },
          ok: { body: "配额批了一半，老板们还是谢你。你留了个印象：这个年轻人能办事。", effects: { fun: 30000, fac: { commercial: 8 } } },
  ...
  {
    id: "wave_leak_offer",
    grade: "major", unique: true, category: "scandal", era: ["1974_WATERGATE"],
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你在听证的关键时刻把文件摊在桌上。全场哗然。报纸叫你「那一代人的深喉接收端」——措辞复杂，但意思是英雄。", effects: { rep: 16, fac: { press: 14, base: 8, establishment: -12 }, lev: 2, flags: ["leaker_hero"] } },
          ok: { body: "文件换到了你想要的东西：一次提名、一张票、一个位子。没人知道代价是什么，包括你。", effects: { rep: 5, lev: 2, fac: { establishment: 6, press: 3 } } },
          ...
          critfail: { body: "事情炸了，而且方向不对：调查顺着文件查到了你。联邦检察官对你提出了指控。", effects: { rep: -12, fac: { press: -10, establishment: -14, agency: -10 }, hardEnd: "prison" } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "主席收下袋子，第二天公开表扬了「一位不愿透露姓名的年轻同事」。你在体制内的信用存折开了户。", effects: { rep: 6, fac: { establishment: 12, agency: 6 } } },
          ...
          critfail: { body: "主席把泄密的嫌疑引到了你身上——毕竟袋子在你手里待过十分钟。澄清花了一年。", effects: { rep: -8, fac: { establishment: -8, agency: -6 }, flags: ["leaker_suspect", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          ...
          critfail: { body: "你的拒绝被当成了表态——「他知道了，而且他站在那边」。两边你都说不清了。", effects: { rep: -4, fac: { establishment: -8, press: -6 }, flags: ["leaker_suspect"] } }
        }
      }
    ]
  },
  ...
  {
    id: "wave_occupy_low",
    grade: "mid", unique: true, category: "civil", era: ["2008_CRASH"],
    ...
    title: "帐篷城的第三周",
    body: "公园里的帐篷没有减少的迹象。你去送过一次 donated 咖啡，现在他们问你：要不要留下来帮他们做「对外沟通」——你有一张会说话的嘴。",
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你成了帐篷城的声音之一：镜头找你，捐款经你，警方的档案也给你立了页。冬天来之前，你已经把运动里认识的两百个人存进了自己的通讯录。", effects: { rep: 15, fac: { base: 16, labor: 8, commercial: -10, agency: -6 }, flags: ["wave_occupy"] } },
          ok: { body: "你在帐篷里过了六个星期。清场那天你被抬走的样子上了地区新闻——没有名字，但你的选区都看见了。", effects: { rep: 9, fac: { base: 12, commercial: -6, agency: -4 }, flags: ["wave_occupy"] } },
          meh: { body: "你参与了，也看清了：一群好人、无领袖、和无限延长的大会。你带着笔记本离开。", effects: { rep: 5, fac: { base: 8, commercial: -4 }, attr: { INT: 2 }, flags: ["wave_occupy"] } },
          fail: { body: "清场那晚你不在。第二天你去收拾东西，公园已经冲洗干净，像什么都没发生过。", effects: { rep: 2, fac: { base: 4 } } },
          critfail: { body: "一段你的发言视频被剪了：掐头去尾之后，你像在号召冲击银行。原视频三千播放，剪辑版三十万。", effects: { rep: -8, fac: { base: 6, press: -10, commercial: -12 }, flags: ["scandal_2", "wave_occupy"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "工会的大巴开进了公园：食物、热水、和几百个有编制的抗议者。两个月的松散运动第一次有了后勤。所有人都记住了是谁牵的线。", effects: { rep: 10, fac: { base: 8, labor: 14 }, flags: ["wave_occupy"] } },
          ok: { body: "牵线成功了一半：工会出了声援声明，但没出大巴。已经比大多数「联盟」走得远。", effects: { rep: 6, fac: { labor: 9, base: 4 } } },
          ...
          critfail: { body: "你安排的会面照片流出：标题写的是「工会高层密会占领领袖」。双方的公关部门同时找你谈话。", effects: { rep: -5, fac: { labor: -8, base: -6, press: -6 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          ...
          critfail: { body: "你转的那条「占领」口号来自一个后来被证实是假账号的帖子。截图留下了。", effects: { rep: -3, fac: { press: -4 } } }
        }
      }
    ]
  },
...

  {
    ...
    brief: {
      lede: "三 Koch 兄弟的账单、两条创始人的推文、和一个雨天的市政厅。",
      known: [
        "救市通过之后，一封电视记者的 rant 视频点燃了另一边的怒火：「我们要开一个茶党」。全美的市政厅会议开始出现愤怒的人群。",
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你的三分钟发言被拍了竖屏，一周五十万播放。三个月后，你被邀请在州级集会上压轴。", effects: { rep: 14, fac: { base: 14, commercial: -6, establishment: -10 }, flags: ["wave_tea"] } },
          ok: { body: "会议室的人站起来为你鼓掌。商会的邀请函第二天被撤回了。", effects: { rep: 8, fac: { base: 10, establishment: -6, commercial: -4 }, flags: ["wave_tea"] } },
          meh: { body: "你讲得不错。人群激动的原因你理解了七成——剩下三成你不敢深想。", effects: { rep: 4, fac: { base: 6, establishment: -3 } } },
          fail: { body: "你被起哄了：人群要的是怒吼，你给的是分析。有人喊「下一个」。", effects: { rep: -2, fac: { base: -4 } } },
          critfail: { body: "你引用的一组数据被当场戳穿是错的。竖屏照样传了五十万——配的标题是「精英的傲慢」。", effects: { rep: -9, fac: { base: -8, press: -8 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你把会议主持住了：怒气没有消失，但议程走完了。商会当场决定支持你「更进一步」。", effects: { rep: 5, fac: { commercial: 12, establishment: 8 }, fun: 100000 } },
          ...
          fail: { body: "「灭火」的照片传开了：你站在台上，台下全是愤怒的手指。标题替你选了边。", effects: { rep: -5, fac: { commercial: 5, base: -10, press: -4 } } },
          critfail: { body: "你私下跟商会说的「这帮人迟早散」被人录了音。录音在人群的邮件列表里转了一个月。", effects: { rep: -10, fac: { base: -14, commercial: 4, press: -6 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        base: 0.6, mods: [{ src: "attr", key: "INT", w: 0.3 }],
        outcomes: {
          crit: { body: "你收了两百份问卷和一百多个联系方式。半年后，无论哪边参选的人，都来问你要过名单。", effects: { rep: 6, fac: { base: 6, commercial: 4, press: 4 }, contact: { fixer: 8 }, flags: ["wave_tea"] } },
          ok: { body: "名单攒起来了。做记录的人不会被骂，也很少被记得——暂时。", effects: { rep: 3, fac: { base: 3, press: 3 } } },
          meh: { body: "两百份问卷，一半是愤怒的涂抹。你学到的是：愤怒有语法。", effects: { attr: { INT: 2 }, rep: 2 } },
          fail: { body: "举着写字板的人在人群里格外显眼。有人抢过你的板子摔了。", effects: { fac: { base: -4 }, hp: -2 } },
          critfail: { body: "你的名单被怀疑是「给谁做的」。无论你怎么解释，板子上那两百个名字看起来都像情报。", effects: { rep: -4, fac: { base: -6, agency: -4 }, flags: ["scandal_1"] } }
        }
      }
    ]
  },
...

  {
    ...
    grade: "major", unique: true, category: "crisis", era: ["2008_CRASH"],
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "救援案通过，条件里你塞进了工人退休金的保护条款。工会的通讯把你的照片印在了头版。", effects: { rep: 12, fac: { labor: 16, base: 8, commercial: -4 } } },
          ok: { body: "你投了支持。密歇根的报纸谢了你，别州的社论问你「下一个是谁」。", effects: { rep: 5, fac: { labor: 10, base: 4, commercial: -2 } } },
          meh: { body: "票投了，案过了，条件把你原本想要的条款稀释成了一句「原则性关切」。", effects: { fac: { labor: 6, base: 2 } } },
          fail: { body: "救援通过了，但一年后工厂还是关了两条线。工会怪条件太松，报纸怪你太软。", effects: { rep: -4, fac: { labor: 2, base: -6 } } },
          critfail: { body: "你在听证上替高管辩护的那段话，被剪进了茶党的全国广告：「你的钱，他的商务机」。", effects: { rep: -12, fac: { labor: -6, base: -14, press: -8 }, flags: ["scandal_3"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你的反对演说逻辑严整，被财政鹰派奉为「那一年最好的一段」。三个州的筹款邀请飞来。", effects: { rep: 10, fac: { base: 8, commercial: 8, labor: -14 }, fun: 150000 } },
          ok: { body: "你投了反对。案还是过了，但你的立场清晰得可以印在传单上。", effects: { rep: 4, fac: { base: 6, commercial: 5, labor: -10 } } },
          meh: { body: "反对票没挡住什么，只表达了什么。表达在政治里也算工作。", effects: { fac: { base: 3, labor: -6 } } },
          fail: { body: "选区的工会把你的画像贴在了本地会议的门口——靶心的位置。", effects: { rep: -5, fac: { labor: -16, base: -6 } } },
          critfail: { body: "你反对救助的第二天，你选区最大的零件厂宣布关门。新闻发布会你被问了十一次「现在呢」。", effects: { rep: -12, fac: { labor: -18, base: -12 }, flags: ["scandal_2"], fall: 1 } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你牵头拟的修正案成了最终版本：钱分批、条件带钩、政府持股。报纸说这是「教科书式的中间路线」。", effects: { rep: 14, fac: { labor: 8, commercial: 6, base: 6, establishment: 8 }, attr: { INT: 2 } } },
          ok: { body: "修正案采纳了大半。救援带上了缰绳——缰绳握多紧，以后见分晓。", effects: { rep: 6, fac: { labor: 5, commercial: 4, establishment: 5 } } },
          meh: { body: "条件加了，但执行条款被删了。你知道那才是牙齿。", effects: { rep: 2, fac: { labor: 3, commercial: 2 } } },
          fail: { body: "两边都拒绝了你：一方说太少，一方说太多。中间派的地盘比想象的窄。", effects: { fac: { labor: -4, commercial: -4, base: -3 } } },
          critfail: { body: "你的方案被《华尔街日报》和工会报纸同一天骂——两边用的词几乎一样：天真。", effects: { rep: -7, fac: { labor: -8, commercial: -6, press: -6, establishment: -5 } } }
        }
      }
    ]
  },
  ...
  {
    id: "wave_busing",
    grade: "mid", unique: true, category: "civil", era: ["1974_WATERGATE"],
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你在体育馆说了那句被人记住的话：「法律不公平的时候，我们改法律；法律公平而我们不做的时候，我们改的是自己。」人群分裂成掌声和跺脚。", effects: { rep: 12, fac: { base: 12, church: 4 }, flags: ["wave_busing"] } },
          ok: { body: "你支持了命令，也组织了家长陪护队让开学那天平安过去。", effects: { rep: 7, fac: { base: 8 }, flags: ["wave_busing"] } },
          meh: { body: "你支持的姿势被双方批评：一方嫌太冷，一方嫌太热。", effects: { rep: 3, fac: { base: 4, church: -2 } } },
          fail: { body: "你为此失去了一次地方选举。你的签名桌被掀了一张。", effects: { rep: -3, fac: { base: 5, church: -6 } } },
          critfail: { body: "你被画进了对手的漫画：西装革履，把孩子塞进校车。漫画贴满了选区。", effects: { rep: -9, fac: { base: -8, church: -8, press: -4 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你的数据质询让学区退了半步：两条线路重画，你的街区回到步行范围。家长们叫你「街区的律师」。", effects: { rep: 10, fac: { base: 8, church: 6 }, fun: 50000 } },
          ok: { body: "挑战部分成功：低年级不跨区了。够开庆功会，不够平息愤怒。", effects: { rep: 6, fac: { base: 6, church: 4 } } },
          meh: { body: "官司排队排到了明年。家长的热钱先冷了一半。", effects: { rep: 3, fac: { base: 3 } } },
          fail: { body: "法院驳回了。你的街坊觉得被你带着白忙了一场。", effects: { rep: -4, fac: { base: -6 } } },
          critfail: { body: "媒体翻出了挑战案的捐款名单——头几名来自学区的地产商。你的「程序之战」变成了「利益之战」。", effects: { rep: -10, fac: { base: -10, press: -8, commercial: 4 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "联席会开了六次，吵了六次，第七次达成了一份双方都签的过渡方案。市报的专栏说这座城市欠你一个人情。", effects: { rep: 14, fac: { base: 10, church: 4, press: 6, establishment: 5 }, flags: ["wave_busing"] } },
          ok: { body: "会议没有奇迹，但两边家长第一次知道对方也叫孩子的小名。你攒下的东西比协议值钱。", effects: { rep: 6, fac: { base: 6, press: 3 } } },
          meh: { body: "联席会开了三次就停了：一边的代表接到「别去了」的电话。", effects: { rep: 3, fac: { base: 3 } } },
          fail: { body: "两边都嫌你和气：调解人收到的感谢通常在十年后，如果有的话。", effects: { rep: 1 } },
          critfail: { body: "一次会议在肢体冲突中结束，镜头拍到你站在中间张着手——照片很戏剧化，对谁都不利。", effects: { rep: -6, fac: { base: -6, press: -6, church: -4 }, flags: ["scandal_1"] } }
        }
      }
    ]
  }
