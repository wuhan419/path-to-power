...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "官方一句话，换汇牌价一夜间变脸。跑得快的赚钱，跑得慢的替别人接盘。",
      known: [
        "公报已经写完，签的是五个国家的名义——汇率不动也得动。",
        "中间人手里有渠道，但要你先把钱换成他能动的形式。",
        "你的现钱躺在地方银行的定期里，取出来要损失一笔利息。"
      ],
      rumor: [
        "有人说财政部内部有人提前两周就知道要发公报。",
        "有人说隔壁那位做进出口的老板已经换了三次汇，赚得没人信。"
      ],
      unknown: [
        "这次是政策，还是又一次「消息灵通者先富」。",
        "如果日元不涨，谁赔——你，还是给你递话的人。"
      ],
      terms: [
        { k: "换汇仓位", v: "把钱押在另一种货币上，赚的是汇率差，不是利息。" },
        { k: "渠道费", v: "中间人不白跑：先付一笔，事后不退。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "开盘二十分钟，报价机上的数字就不像真的了。你认识的每个人都同处在一种状态：手握现金，不知道该怎么花。\n" +
      "下午两点，一位机构清算的熟人打来电话：有几家信托在按三折甩抵押良好的头寸，明天中午之前没人接盘就强制平仓。",
    brief: {
      lede: "崩盘不是价格跌了，是没有人出价。有现金的人在这一天决定很多年后的事。",
      known: [
        "报价延迟、成交单靠喊，交易所自己也说不清哪一笔是真的。",
        "被强制平仓的那几家，抵押物是实在的——只是没人敢接。",
        "你手上的现钱够吃下一单，但吃了就取不出来。"
      ],
      rumor: [
        "有人说几家大行早就在内部平掉了仓位，只剩散户在跌。",
        "有人说联邦储备今晚就会表态给流动性。"
      ],
      unknown: [
        "这是价格的底部，还是更大一场清算的开头。",
        "在这一天捡便宜，将来会不会被算成「靠别人的灾难发财」。"
      ],
      terms: [
        { k: "强制平仓", v: "保证金不够就被卖掉持仓，价格与价值无关。" },
        { k: "折价接盘", v: "现金换别人的必需品——利润来自对方的时间不够。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "货币狙击不是打仗，是比谁先撑不住：外汇储备、企业外币债、还有政治信心。",
      known: [
        "央行的美元储备在两周内少了一大截，还在往外流。",
        "本地企业借的是外币，本币一贬值，它们的债务自动变大。",
        "有基金在公开场合说这种汇率「不可持续」，说完继续抛。"
      ],
      rumor: [
        "有人说某个本地大户和那几家基金之间有账户往来。",
        "有人说邻国已经悄悄放弃了挂钩，只等我们跟着动。"
      ],
      unknown: [
        "守住汇率要花光储备，放弃汇率要赔进企业——哪一条更贵。",
        "把矛头指向「外国投机客」，是分析还是挡箭牌。"
      ],
      terms: [
        { k: "货币狙击", v: "集中抛售一种货币，逼其贬值后再低价买回。" },
        { k: "外币债", v: "借的是外币，还的是本币——贬值即加债。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "第一季度的支票还是按老数字寄来，封面印着一家你从没见过的管理公司。\n" +
      "你手上那笔钱当初是被当作「比国债多一点收益」卖给你的。现在你翻到说明书第八页，看到一句话：底层资产的信用质量不再复核。",
    brief: {
      lede: "结构性产品最可怕的不是复杂，是它按时付钱——按时到没人愿意去看它凭什么付钱。",
      known: [
        "两家次级房贷机构接连出事，报上的措辞是「流动性问题」。",
        "你的产品里混着他们放出去的贷款，比例没人肯给准数。",
        "客户经理建议你别卖：现在卖是最低价。"
      ],
      rumor: [
        "有人说大机构早在半年前就把同类仓位处理掉了，只剩本地账户。",
        "有人说评级机构下周会动手，但先通知了几家大客户。"
      ],
      unknown: [
        "这是某个细分市场的事故，还是所有房子都在同一根绳上。",
        "你如果现在卖，等于承认自己半年前没读那八页。"
      ],
      terms: [
        { k: "底层资产", v: "拆开这层证券，最后面是一笔笔住房贷款。" },
        { k: "不再复核", v: "发行之后没人再看借款人的还款能力。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "银行间断了银行间的钱。这条街上最好的五金店、给学校供餐的承包商、还有一家开了四十年的印刷厂，都在同一周里来找你。\n" +
      "他们要的不是投资，是过桥的九十天。利率可以自己写——因为现在能拿出来的人不多。",
    brief: {
      lede: "危机里最贵的东西不是资产，是「现在就有」这四个字。",
      known: [
        "正规渠道这一周对所有人关门，包括信用最好的那几家。",
        "来的人里有你的老选民，也有你竞选时的对手的支持者。",
        "你的现钱可以放出去，也可以看着他们被别人接走。"
      ],
      rumor: [
        "有人说有位本地富商上周已经开出四倍于银行的利率，签了两家。",
        "有人说监管正在等谁先动手放高利贷，好抓一个样子。"
      ],
      unknown: [
        "这些企业九十天后还剩几家——决定你是恩人还是债主。",
        "同一批钱如果放错了人，你的名字会出现在谁的破产文件里。"
      ],
      terms: [
        { k: "过桥贷款", v: "九十天内还的短期钱，赌的是借款人撑到下一笔融资。" },
        { k: "危机利率", v: "钱稀缺时的价格。高到一定程度就叫另一个名字。" }
      ]
    },
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "这家银行没有倒闭，它只是持有别人不想要的债券。上午九点有财经账号算了一笔账，下午三点开始，客户在手机上排队转账。\n" +
      "你在里面有存款，也有认识的人在里面。你现在有大约一天的时间决定自己是哪一种人。",
    brief: {
      lede: "手机时代的挤兑不需要人站在门口排队——它需要的是一个算法愿意转发的数字。",
      known: [
        "监管已经知道这笔账面损失，正谈过桥方案，还没谈完。",
        "存款保险只覆盖到某个数额，超过的部分要等。",
        "你账上那笔钱刚好在保险线之上，转走只要两分钟。"
      ],
      rumor: [
        "有人说已经有两家机构客户今天凌晨转走了大笔钱。",
        "有人说转发那条帖子的人自己开了家对冲基金。"
      ],
      unknown: [
        "过桥方案签不签得成——它取决于今天有多少钱抢着出门。",
        "留下一句「我信它」，值多少钱；说晚了又值多少钱。"
      ],
      terms: [
        { k: "账面损失", v: "资产没卖就不算实现，但市场随时替你实现一次。" },
        { k: "数字挤兑", v: "转账按秒计，恐慌不需要人到现场。" }
      ]
    },
    choices: [
      {
