...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "就职演讲的余音还没散，行政令就一张接一张地签：联邦用人冻结、机构改名与合并、对外援助暂停、边境与关税指令重发。命令不经国会，直接落到司局一层的表格里。\n" +
      "你这一层当天就接到了电话：有人要你立刻公开背书，有人要你马上出面控诉「越权」。行政令不经国会表决，总统一签就落到司局的表格里；而冻结与合并砸下来的第一批饭碗，正是你选区里的联邦岗位与合同。\n" +
      "等着回话的邮件比往年一个月的量还多。冻结名单上有没有你认识的人？明天才公布。",
    choices: [
      {
   ...
   * ==================================================================== */
  {
    ...
    body: "周四傍晚，一套按国家分档、以贸易逆差反推税率的全面对等关税在玫瑰园公布，连一贯免税的小额包裹也被纳入。接下来几个交易日：股市连续熔断式下挫、国债被抛售，进口商在电话里把「四月生效」当成催命符。\n" +
      "两周后，除少数对象外，大部分税档暂停九十日——留出谈判窗口。市场收回了一大半跌幅，可供应链、仓单与订金已经烧掉一批，而你选区里那些报了价的企业，没人会替他们把报价单改回来。有人说暂停是被债市逼出来的，真正落地的税率会另算一套。",
    choices: [
      {
