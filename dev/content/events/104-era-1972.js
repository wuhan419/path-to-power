    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你抢在调查前把经手记录交得一干二净，把自己稳稳放在了「捐款人」而非「知情人」那一栏。风浪过去，你几乎没湿鞋。",
            effects: { rep: 8, lev: 1, fac: { establishment: 6, base: 5 } } },
          ok: { body: "你及时交了底，成了「配合的人」。委员会塌的时候，你不在承重墙那一列。",
            effects: { rep: 4, fac: { establishment: 4 } } },
          meh: { body: "你交得及时，可里面本就没你的名字，你白紧张一场，也没换来多少信任。",
            effects: { rep: 1 } },
          fail: { body: "你交出的记录反倒帮调查者串起了资金链，你成了那个「提供关键一笔」的人。",
            effects: { rep: -6, fac: { establishment: -8 }, flags: ["scandal_1", "investigation_open"] } },
          critfail: { body: "你想撇清，交出的东西却正好证明你不止捐了钱、还知情。撇清变成了自首。",
            effects: { rep: -12, fac: { establishment: -10, press: -8 }, flags: ["scandal_3", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你一口咬定「就是 burglary」，替上层顶住了整波追问。白宫记下了你的可靠，一笔「辛苦费」不动声色地到了你背后。",
            effects: { rep: 3, fun: 120000, lev: 1, fac: { establishment: 14 } } },
          ok: { body: "你守了口，上层认你这个「懂事的人」。风头暂时没到你身上。",
            effects: { fac: { establishment: 10 }, fun: 60000 } },
          meh: { body: "你什么都没说，可也没人特别记得你守过口。灰溜溜扛了一阵。",
            effects: { rep: -1 } },
          fail: { body: "你死守沉默，记者却挖出你和那家委员会的关系。「他为什么不说」比「他说了什么」更难回答。",
            effects: { rep: -5, fac: { press: -8, base: -5 }, flags: ["leaker_suspect"] } },
          critfail: { body: "你替人扛雷，扛到最后一刻才发现被扛的人早已安排好了「出错就推给下属」。你的名字成了那期的头条。",
            effects: { rep: -13, fun: -50000, fac: { establishment: -16, press: -10 }, flags: ["bought", "scandal_3"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你匿名点的一根线，让记者顺着资金链挖出了更深的东西。多年后真相大白，历史给「最早透风的人」留了一个位置——虽然没人知道是你。",
            effects: { rep: 6, lev: 1, fac: { press: 6, base: 6 }, flags: ["deep_throat"] } },
          ...
          fail: { body: "记者查到了你头上，你从爆料人变成了被查人。「谁在泄密」名单里多了你的名字。",
            effects: { rep: -5, fac: { establishment: -8 }, flags: ["leaker_suspect", "scandal_1"] } },
          critfail: { body: "你的匿名爆料被顺藤摸瓜反查出来，白宫把你的名字从「内部人」改成了「叛徒」。这一份，够你喝一壶。",
            effects: { rep: -10, fac: { establishment: -14, press: 4 }, flags: ["whistleblower", "investigation_open"] } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你把钱分发得干干净净，谁都没多拿谁都没少拿。上层把你当「能守口如瓶的自己人」，一份额外的活动经费长期挂在你的口子下。",
            effects: { fun: 200000, lev: 1, fac: { establishment: 10, commercial: 6 }, flags: ["black_money", "hush_man"] } },
          ok: { body: "钱分下去了，没人乱说。你成了链条上沉默的一环，也成别人眼里「懂事」的一环。",
            effects: { fun: 100000, fac: { establishment: 6 }, flags: ["hush_man"] } },
          meh: { body: "你分了钱，可拿钱的人里有一个不太安分。你白担了风险，还多了个隐患。",
            effects: { rep: -2, flags: ["hush_man", "leaker_suspect"] } },
          fail: { body: "收到钱的人里有一个转头做了证人，把你这份分发记录一并交了上去。链条上的名字，第一个是你。",
            effects: { rep: -8, fac: { establishment: -10, press: -6 }, flags: ["scandal_3", "investigation_open"] } },
          critfail: { body: "分发的账被完整起获，你被定性为「封口费的实际经手人」。上层脱了身，你替整条链背了锅。",
            effects: { rep: -14, fav: -2, fac: { establishment: -16, base: -10 }, flags: ["scandal_4", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你退回信封，还留了个时间记号。当整座船开始下沉，你是少数几个「当初就没上船」的人——这份清白比金子值钱。",
            effects: { rep: 8, fac: { base: 8, press: 6, establishment: -6 }, flags: ["clean_hands"] } },
          ok: { body: "你退了钱，划了线。上层对你冷了，可你自己那页账是干净的。",
            effects: { rep: 4, fac: { establishment: -6, base: 4 } } },
          meh: { body: "你退了，但没留证据。将来谁说得清你到底是「退过」还是「本来就没碰」。",
            effects: { rep: 1, fac: { establishment: -3 } } },
          fail: { body: "你退回信封被当成了「不忠诚」的信号，机器开始绕开你、也监视你。",
            effects: { rep: -3, fac: { establishment: -10 }, flags: ["leaker_suspect"] } },
          critfail: { body: "你拒收还声张，成了「到处说我见过这个信封」的不安定因素。他们决定一起把你做成那个乱说话的人。",
            effects: { rep: -8, fac: { establishment: -14, commercial: -6 }, flags: ["compromised", "investigation_open"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你带着信封走进了调查组，成了最早「从里面反水」的证人。案子因你这份实物而钉死，你的名字进了「说清真相的人」那一栏。",
            effects: { rep: 10, fac: { press: 10, base: 8, establishment: -12 }, flags: ["whistleblower"] } },
          ok: { body: "你把信封交了上去，做了一回吹哨人。上层恨你入骨，可你守住了更大的一头。",
            effects: { rep: 5, fac: { press: 6, establishment: -10 }, flags: ["whistleblower"] } },
          meh: { body: "你交了，可调查组嫌你来路暧昧——「你怎么拿到这个信封的？」你反而要多解释自己。",
            effects: { rep: 1, flags: ["leaker_suspect"] } },
          fail: { body: "你收下了，却没来得及交出去，半路被人截了胡。你既脏了手，又没做成吹哨人。",
            effects: { rep: -6, fac: { establishment: -8, press: -4 }, flags: ["scandal_2"] } },
          critfail: { body: "你想反水，可对方手里也有你「曾参与分发」的记录。两个人各执一词，被起诉的那一个偏偏是你。",
            effects: { rep: -12, fac: { establishment: -12, base: -8 }, flags: ["scandal_3", "investigation_open"] } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你公开拒绝、当场辞职，成了「那晚守住底线的人」之一。国会山的掌声和全国的电报一起寄到了你的办公室。",
            effects: { rep: 13, tier: 1, fac: { base: 12, press: 12, establishment: -10 }, flags: ["constitutionalist"] } },
          ok: { body: "你顶住了没签字，辞了职。眼下失去了位子，可你的名字进了「可靠」那一栏。",
            effects: { rep: 7, fac: { base: 8, press: 6, establishment: -6 } } },
          meh: { body: "你婉拒了，姿态摆得不太响，也不算难看。一个中不溜秋的原则时刻。",
            effects: { rep: 2 } },
          fail: { body: "你拒绝执行，却被上层反咬成「越权抗命」。辞职没辞成，还背了个抗上的记录。",
            effects: { rep: -4, fac: { establishment: -10, base: 3 }, flags: ["scandal_1"] } },
          critfail: { body: "你硬顶到底，可机器早有准备，把你描成「挟案自重、不肯交权」。原则被说成了私心。",
            effects: { rep: -8, fac: { establishment: -12, base: -6 }, flags: ["compromised"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你干净利落地办了一件别人不敢办的事，白宫把最烫的差事交给了你。可你心里清楚：风一变，第一个被拿出来平息众怒的就是执行者。",
            effects: { rep: 3, tier: 1, lev: 1, fac: { establishment: 14, base: -8, press: -10 } } },
          ok: { body: "你签了字、办了事，短期内平步青云。全国都在骂「听话的那只手」，而那只手是你的。",
            effects: { rep: -2, fac: { establishment: 10, base: -6, press: -8 } } },
          meh: { body: "你办了这件脏活，可上面转头又找了别人分担责任，脏水洒了你一身。",
            effects: { rep: -4, fac: { establishment: 3, press: -6 } } },
          fail: { body: "你刚动手，国会的抗议和街头的电话就压了过来。命令撤了，你的把柄留了下来。",
            effects: { rep: -7, fac: { establishment: -6, press: -10, base: -6 }, flags: ["scandal_2"] } },
          critfail: { body: "你成了那个「深夜去送解职信的人」。这事后来被反复拍成片子，每一次都在提醒选民：你干过什么。",
            effects: { rep: -13, fac: { establishment: -10, press: -14, base: -10 }, flags: ["bought", "scandal_3"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你把这道「深夜解职令」原原本本送上了头版。白宫焦头烂额，你匿名居功，调查因这股民意又续了命。",
            effects: { rep: 8, fac: { press: 8, base: 8, establishment: -12 }, flags: ["deep_throat"] } },
          ok: { body: "消息捅出去，舆论炸了锅。你没落名义，却实实在在拖住了那只黑手。",
            effects: { rep: 4, fac: { press: 5, establishment: -8 } } },
          meh: { body: "你放了出去，可没激起多大水花。你既违了上意，又没能改变什么。",
            effects: { rep: 1, fac: { establishment: -5 } } },
          fail: { body: "泄密被反查到你头上。你从吹哨人变成了「泄密嫌疑人」，两头受审。",
            effects: { rep: -6, fac: { establishment: -10 }, flags: ["leaker_suspect", "investigation_open"] } },
          critfail: { body: "白宫抢先把你塑造成「心怀不满、伪造命令」的内鬼。你越辩解，越像那么回事。",
            effects: { rep: -11, fac: { establishment: -12, press: -8, base: -6 }, flags: ["compromised", "scandal_2"] } }
        }
      }
    ]
  },
      ...
      },
      {
        ...
        outcomes: {
          crit: { body: "你一句「我劝你们别只盯着那五个人」帮两个记者打开了新线索。他们不知道你是谁，可这条线你救了。",
            effects: { rep: 4, fac: { press: 5, base: 3 }, flags: ["deep_throat"] } },
          ok: { body: "你轻推了一把，没留名。调查换了方向，你深藏功与名。",
            effects: { rep: 2, fac: { press: 3 } } },
          meh: { body: "你暗示了，记者没接住。你这番心，白费了一半。",
            effects: { rep: 1 } },
          fail: { body: "你「给方向」被听成了「你果然知情」。他们反过来把你也写进了调查对象。",
            effects: { rep: -4, fac: { press: -6 }, flags: ["leaker_suspect"] } },
          critfail: { body: "你想两头下注，结果上层察觉你在放风。你从「配合的人」一夜之间变成了「内鬼」。",
            effects: { rep: -8, fac: { establishment: -10 }, flags: ["leaker_suspect", "scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          ...
          fail: { body: "你的「无可奉告」被印成大字标题——在选举年，这就是「默认」。",
            effects: { rep: -3, fac: { base: -4, press: -3 } } },
          critfail: { body: "你想息事宁人，可你越客气越显得心虚。他们把「他什么都不敢说」写成了导语。",
            effects: { rep: -5, fac: { press: -6 } } }
        }
      }
    ]
  }
