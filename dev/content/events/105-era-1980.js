    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你第一个把老话改口成新话，新班子把你当「开明的地方人」。你既保住了老关系，又领了新潮流的功。",
            effects: { rep: 10, tier: 1, fac: { establishment: 6, commercial: 12, base: 6 }, flags: ["reagan_era"] } },
          ok: { body: "你顺势转向，成了「读懂选区」的人。老同事侧目，但账面上的好处是实打实的。",
            effects: { rep: 5, fac: { commercial: 8, establishment: 3 } } },
          meh: { body: "你转了向，可转得太露骨，谁都没全信。新的嫌你油滑，旧的骂你背叛。",
            effects: { rep: -1, fac: { base: -4 } } },
          fail: { body: "你急着拥抱新风，被拍到你「昨天还在念老稿子」。墙头草的标签一次贴牢。",
            effects: { rep: -6, fac: { base: -8, establishment: -6 }, flags: ["scandal_1"] } },
          critfail: { body: "你跳得太快，反被新势力当成「随时会再跳走的旧机器的人」，两边都不要你。",
            effects: { rep: -11, fac: { establishment: -10, commercial: -8, base: -8 }, flags: ["party_traitor"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "在全党投降的空气里，你替老议程说了完整的一段。当下没人接话，可工会和基层悄悄记住了「那种时候他还敢讲」。",
            effects: { rep: 7, fac: { labor: 12, base: 8, establishment: -4 }, contact: { union_boss: 8 }, flags: ["old_school"] } },
          ok: { body: "你守住了老话。短期内不占便宜，但你没丢自己的根，也没丢自己人。",
            effects: { rep: 3, fac: { labor: 6, base: 3 } } },
          meh: { body: "你讲了原则，讲得没人爱听。位子没动，声音越来越小。",
            effects: { rep: 1, fac: { establishment: -3 } } },
          fail: { body: "在举国思变的时刻你死守旧调，被报纸写成「跟不上时代的老派」。",
            effects: { rep: -5, fac: { press: -6, commercial: -6 } } },
          critfail: { body: "你的固执被算成了整片老机器的失败之一，党要把败选的责任甩给「不肯改的人」，你首当其冲。",
            effects: { rep: -9, fac: { establishment: -12, base: -6 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你把宏大的意识形态翻译成「给你少收点、多留点工作」的本地话，两边都挑不出毛病，选民觉得你最实在。",
            effects: { rep: 6, fac: { base: 8, commercial: 5 } } },
          ...
          fail: { body: "你的「不谈主义」被两边读成「没有立场」。在狂热的选举年，这几乎等于没票。",
            effects: { rep: -4, fac: { establishment: -4, base: -3 } } },
          critfail: { body: "你谁也没得罪，也谁也没动员。选区被对手一波带走，党内部检讨名单上有你「不出力」一条。",
            effects: { rep: -6, fac: { establishment: -6, labor: -4 } } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你在一片「依法办事」的声浪里替丢掉饭碗的人说了话。劳工阵营把你当成罕见的敢言者，日后每逢选举都替你抬桥。",
            effects: { rep: 9, fac: { labor: 16, base: 8, establishment: -8 }, contact: { union_boss: 12 }, flags: ["labor_champion"] } },
          ok: { body: "你替工人顶了几句。上层不悦，可工会的人记住了你没在他们最难的时候缩回去。",
            effects: { rep: 5, fac: { labor: 10, establishment: -5 }, contact: { union_boss: 6 } } },
          meh: { body: "你说了几句软话，谁都没解气。工会嫌你不够，上层嫌你多事。",
            effects: { rep: 1, fac: { labor: 3, establishment: -2 } } },
          fail: { body: "你反对铁腕，被说成「支持违法罢工」。这股逆流把你冲得够呛。",
            effects: { rep: -5, fac: { establishment: -8, press: -5 }, flags: ["scandal_1"] } },
          critfail: { body: "你带头反对，成了全国「谁在纵容罢工」的头号靶子。反对你，成了一种政治正确。",
            effects: { rep: -10, fac: { establishment: -12, commercial: -8, base: -4 }, flags: ["scandal_2"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你公开支持铁腕，被新潮流当成「敢讲常识的地方人」。上层与你越走越近，只是工会的门从此对你关了。",
            effects: { rep: 5, tier: 1, fac: { establishment: 12, commercial: 8, labor: -16 } } },
          ok: { body: "你站在「依法」一边，短期得利。可你在选区里握过手的工人，开始避开你的眼神。",
            effects: { rep: 2, fac: { establishment: 8, labor: -10 } } },
          ...
          fail: { body: "机场乱成了一锅粥，航班大面积取消。选民把怨气算到了「只会喊依法」的你头上。",
            effects: { rep: -5, fac: { base: -8, labor: -6 } } },
          critfail: { body: "你替铁腕吆喝得最响，转头被媒体扒出你自己的办公室也雇着「走后门」的关系——「讲规则的人自己不讲」。",
            effects: { rep: -9, fac: { press: -10, base: -8, labor: -8 }, flags: ["scandal_2"] } }
        }
      },
      {
    ...
    choices: [
      {
        ...
        cost: { fun: 120000 }, req: { fun: 120000 }, stake: { fun: true },
        outcomes: {
          crit: { body: "你在泡沫顶上及时套了现，一分红到手就辞了董事。别人还在往里冲，你已经坐在岸上数钱。",
            effects: { funMul: 1.6, rep: 3, fac: { commercial: 8 } } },
          ...
          fail: { body: "你贪了一下没撤干净，公司说倒就倒，你投进去的大部分打了水漂，还挂了个「董事」的名。",
            effects: { funMul: -0.7, rep: -4, flags: ["scandal_1"] } },
          critfail: { body: "储贷崩盘惊动联邦，作为挂名董事的你被追责。「监管放松的钱，最后要纳税人赔」——报道里的每一个字都对着你。",
            effects: { funMul: -1.0, rep: -12, fac: { press: -10, commercial: -8, base: -8 }, flags: ["scandal_3", "investigation_open"] } }
        }
      },
      {
      ...
      },
      {
        ...
        outcomes: {
          crit: { body: "你躲过了这场狂欢，还提前预警了几家本地机构。几年后满地狼藉，唯独你和你提醒过的人毫发无损——「这人靠得住」的名声就是这么攒下的。",
            effects: { rep: 8, fac: { base: 8, church: 5, commercial: -4 }, flags: ["snl_escaped"] } },
          ...
          fail: { body: "你的「别往里冲」扫了想借机发财的同僚的兴，你在小圈子里成了「挡人财路」的那一个。",
            effects: { rep: -3, fac: { commercial: -6, establishment: -4 } } },
          critfail: { body: "你劝退了别人，自己却因为一个「朋友」的面子投了一小笔。崩盘时，连这一笔也赔了进去，还落个「双标」。",
            effects: { rep: -6, fun: -60000, fac: { base: -6 }, flags: ["scandal_1"] } }
        }
      }
    ]
  },
    ...
    choices: [
      {
        ...
        outcomes: {
          crit: { body: "你签下名字上了本地报，年轻选民和一批忧心忡忡的家长把你当成了「说人话的人」。军工那边记你一账。",
            effects: { rep: 5, fac: { base: 8, foreign: -5, commercial: -4 } } },
          ...
          fail: { body: "对手把你「支持冻结」剪进了一段「他连国防都靠不住」的广告。",
            effects: { rep: -4, fac: { military: -6, establishment: -4 } } },
          critfail: { body: "你的签名被做成了「通敌」的暗示满城张贴，你不得不花好几周自证没那么天真。",
            effects: { rep: -6, fac: { press: -6, military: -6 }, flags: ["scandal_1"] } }
        }
      },
      {
        ...
        outcomes: {
          crit: { body: "你一段「实力才带来和平」的发言被保守派电台反复播放，军工游说第一次主动来约你吃饭。",
            effects: { rep: 4, fac: { military: 8, establishment: 6, commercial: 5, base: -4 } } },
          ok: { body: "你站了「硬」的一边，上层满意，街头的学生冲你嘘。",
            effects: { rep: 2, fac: { establishment: 5, military: 4 } } },
          ...
          critfail: { body: "就在你高喊扩军时，一桩军工回扣案爆了，你恰好在拿军工的献金。「战争贩子」四个字第一次上了你的门。",
            effects: { rep: -8, fac: { press: -8, base: -8 }, flags: ["scandal_2", "investigation_open"] } }
        }
      },
      {
