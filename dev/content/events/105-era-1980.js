...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "你的选区这次投了对手，党部要你解释，也看你变不变调。",
        "减税、强军、放松监管：从前是对手的话，本党也得小心说。",
        "你手上有老建制的任命，也有动摇的基层；两边看你眼色。"
      ],
      rumor: [
        "据说党魁准备改弦更张，正挑第一个转向的人当样板。",
      ...
      terms: [
        { k: "里根民主党人", v: "原投民主党的蓝领，1980 倒向共和党。" }
      ]
    },
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "你管着本地机场的预算，被解雇者的家属就在你选民册里。",
        "白宫要用这一刀告诉全国：工会好日子到头了。",
        "被解雇的人里，有不少是你从前在选区握过手的普通工薪族。"
      ],
      rumor: [
        "有人说上面早备好替代人手，不在乎机场会不会乱。",
        "有人说这场罢工是被故意激出来的，好杀鸡儆猴。"
      ],
      unknown: [
        "这一刀会不会砍掉你的整个工会票仓。",
        "十年后你是「看清风向的人」还是帮凶。"
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    brief: {
      ...
      known: [
        "他们来找你，是因为你是本地最可能被这事后拖上全国的年轻面孔。",
        "「冻结核武」听着人畜无害，却顶撞了本时代的主基调。",
        "签名的人里有学生，也有把孙子送上航母的母亲。"
      ],
      rumor: [
        "有人说这场运动背后有外国势力资助，正等着政客上钩。",
        "也有人说军工游说才是在地方选举砸钱的一方。"
      ],
      unknown: [
        "几年后会不会真有削减核武的协议。",
        "哪一边更记仇——学生还是军承包商。"
