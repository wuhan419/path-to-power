...
POTUS.define("event", [
   ...
   * ==================================================================== */
  {
    ...
    body: "为逼医保与教育开支的删减过关，国会与白宫把预算谈崩了：联邦政府从十二月中旬再度关门，一关就是三个多星期。\n" +
      "国家博物馆闭馆、护照与移民服务停发、数十万雇员回家待命、工资停发。对峙双方都赌对方先撑不住——而这笔账，要到明年的选票上才结。",
    brief: {
      lede: "政府关门成了党争人质：谁先松口，像在选举年先认输。",
      known: [
        "医保与教育删减是这场对峙真正的赌注。",
        "博物馆闭馆、护照与移民服务停发。",
        "数十万联邦雇员无薪休假，怨气四起。"
   ...
   * ==================================================================== */
  {
    ...
    body: "首都圈几条州际公路沿线，三周内接连响起枪声：十人死亡、多人重伤，目标像是随机的通勤者。\n" +
      "联邦探员进驻，学校接连停课，州警在高速上设卡盘查。人人摇上车窗、绕开加油站；这场恐慌很快被问成一个政治问题——谁，能保证你安全。",
    brief: {
      lede: "高速上有人狙杀通勤者：恐慌正被问成安全的考题。",
      known: [
        "三周内十余起袭击、十人死亡。",
        "联邦探员进驻，学校停课、州警设卡。",
        "调查指向两名流窜作案的枪手。"
   ...
   * ==================================================================== */
  {
    ...
    body: "经过近二十个月听证，跨党派调查委员会交出最终报告，把九一一归因成一连串「本可拦住的失误」：情报各说各话，威胁分级机制形同虚设。\n" +
      "报告在大选前六周占满头版。白宫第一反应是反击：措辞失当、误导公众。你所在的层级，明天上午被三家媒体约了「怎么看这份报告」。",
    brief: {
      lede: "大选前六周，一份报告把九一一写成一连串体制失误。",
      known: [
        "报告直指情报不共享、威胁分级失灵。",
        "两党委员联名签发，跨党派背书。",
        "白宫已公开指报告有误导性。"
