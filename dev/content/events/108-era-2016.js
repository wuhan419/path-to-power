...
POTUS.define("event", [
   ...
   * ---------------------------------------------------------------------- */
  {
    id: "soc16_election", photo: "era-2016.jpg", grade: "major", category: "political",
    ...
    body: "选前所有正经预测都指向同一个结局，模型无一例外。可推特上的愤怒、脸书上的转发、集会上的吼声，一张民调也没算进去。\n" +
      "开票之夜，「红州」一个一个提前变红，播报员的声音开始发紧。这是注意力政治（抢眼球、绕开政党机器的新打法）头一回压过组织；两拨人都来找你表态，谁都想借你这张本地熟脸。\n" +
      "有人说对手的爆款推文是境外内容农场放的。哪一边赢，都有大半选民觉得对面那批人不配治国——而你今晚押的这一边，四年后未必还是你想守的。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "有人捏造了一条关于你的「内幕」：细节逼真，来源「据知情人士」，瞄的正是你摇摆选民最敏感的那根神经。等你的团队查清，它已经传遍了半个网络。\n" +
      "辟谣稿要三天才写得出来，可三天后没人记得辟了什么；你越逐条反驳，越像替它二次传播，越轻描淡写，又越像默认。平台只回一句「不违反社区规则」——它们没有编辑部，你连该告谁都要先想半天。\n" +
      "有人说这条料是你对手放的，也有人说只是内容农场（批量造抓眼球的东西换流量的站点）在骗点击。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    ...
    body: "一家数据公司找上门，说手里有本地每一位选民的「心理画像」：从消费习惯到半夜刷什么，再按情绪弱点定制定向广告。\n" +
      "它开一笔顾问费，承诺千人千面——对怕的人讲恐惧，对怒的人讲愤怒。它要的不只是钱，还想要你手上部分选民名单去「校准模型」。\n" +
      "这笔竞选预算归你拍板，党内已经在传隔壁州的效果吓人。有人说它的数据是从社交平台的灰色接口里「顺」来的，也有人说真正买你选民画像的，未必只有你的竞选团队。",
    choices: [
      {
   ...
   * ---------------------------------------------------------------------- */
  {
    id: "soc20_mailin", photo: "era-2020.jpg", grade: "minor", category: "crisis",
