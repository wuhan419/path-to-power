...
POTUS.define("event", [
  {
    ...
    "brief": {
      ...
      "known": [
        "雷曼倒下两周后，政府拿出7000亿方案要国会批。",
        "财政部一个上周才认识的人来电：要你上电视说句「支持」。",
        "文件末尾有一份已署名名单，上面几个名字你只在新闻里见过。"
      ],
      "rumor": [
        "律师朋友说里面藏了几条无法复核的授权条款。"
      ],
      "unknown": [
        "你读不懂的那几条授权，早晚会反噬。",
        "两个月后大选，今天站哪边会被划线。"
      ...
      "terms": [
        { "k": "救市", "v": "政府出钱兜住快倒闭的金融机构。" },
        { "k": "TARP", "v": "那7000亿方案的正式代号。" }
      ]
    },
  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        "他们恨的是同一件事：政府拿钱救银行，而他们的房子在被收走。",
        "组织者给你十五分钟。你必须表态——不能两边都不站。",
        "同一批人里已经有人在聊找一个「自己人」去参选。"
      ],
      "unknown": [
        "今晚的话几年后会被对手剪成广告。",
        "这股愤怒最后会被谁收走，没人知道。"
  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        "标为「优质」的房贷池逾期率正在异常攀升，按历史模型不该发生。",
        "R说他不是唯一看见的人——几家基金已经在悄悄建仓。",
        "你要么通过CDS做空，要么把这份数据公开。"
      ],
      "unknown": [
        "你知道方向，但不知道什么时候崩。",
        "崩盘前你可能先被自己的仓位拖死。"
  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        "他要的很直白：在那条立法上「理解他的处境」。",
        "他开出的数字够你把整个竞选撑完，还剩下钱养团队。",
        "他前年给另一位议员塞过更重的，那人后来投桃报李。"
      ],
      "rumor": [
        "有人说他爱留录音录像，好「维持关系的稳定」。"
      ],
      "unknown": [
        "这笔钱会不会哪天以丑闻的形式回来。",
        "日后披露规则收紧，旧账会被重新翻出。"
  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        ...
        "你喝了酒，婚姻正处在没人愿意多提的阶段。",
        "她是那位同僚最信任的人：他的日程、电话、饭局她全知道。"
      ],
      "rumor": [
        "有人说那位同僚本人也在闹出轨，她因此更大胆。"
      ],
      "unknown": [
        "枕边话是硬通货：她说的不只是情话。",
        "有没有第三个人已经知道这条消息的存在。"
  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        "她枕边说的三件事已应验两件：那同僚果然塞进了自己人。",
        "关键表决在即：那位同僚是决定票，他的把柄只有你握着。",
        "她的最新消息只有一行：「他下周会很脆弱。」"
      ],
      "rumor": [
        "有人说她同样的话也讲给别人，情报从不只卖一家。",
  ...
  },
  {
    ...
    "brief": {
      ...
      "known": [
        "这是直播，全国观众九成此刻才第一次认真看你。",
        "对方的问题里埋了预设：只要你回答，就等于承认了那个预设。",
        "回应时间九十秒。你已经用掉三十五秒。"
      ],
      "rumor": [
        "有人说对手手里还有一份没公开的材料，留着以后用。"
      ],
      "unknown": [
        "这三十秒会被剪成什么，第二天你才知道。",
        "观众记住的是回答，还是那两秒停顿。"
  ...
  },
  {
    ...
    "weight": 8,
    "brief": {
      "lede": "一个以你名字命名的东西。它可以是慈善，也可以是别的东西。",
      "known": [
        "政客办同名基金会是常规操作：筹款、雇人、赚名声。",
        "账目只要请会计师事务所审计，就能合法不公开细节。",
        "但你清楚，一旦它成了工具，你就不再只是它的创始人。"
      ],
      "rumor": [
        "有人说某议员靠自家基金会养了八个吃空饷的顾问。"
      ],
      "unknown": [
        "迟早会有记者去翻你基金会的报销单。",
        "那些「顾问」里谁会第一个开口。"
  ...
  },
  {
    ...
    "weight": 8,
    "brief": {
      "lede": "K街打电话来了：请你们委员会「理解」一下我们的处境。",
      "known": [
        "行业协会要捐钱、给顾问合同、替你打电话拉票。",
        "他说得很清楚：你不接，他去找你的对手。"
      ],
      "rumor": [
        "有人说他前年改过一条监管条款的措辞。",
  ...
  },
  {
    ...
    "day": 30,
    "brief": {
      "lede": "党内建制推了另一个人。不打就认输，要打就掀桌子。",
      "known": [
        "初选赢的是代表席位，不是基层热度。",
        "党的机器、筹款网络全在建制候选人手里。",
        "挑战建制，输的是党内信任；服从，输的是自己的时间。"
      ],
      "rumor": [
        "主席说只要你这次「懂事」，下次许你好位子。",
        "你的支持者已经在串联，准备自己筹钱。"
