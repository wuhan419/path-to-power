...
POTUS.define("event", [
  ...
  /* ================= 外交族 ================= */
  {
    ...
    brief: {
      lede: "海峡昨夜布雷，油轮停在两舷不动，而原油价格七天涨四成。",
      known: [
        "派舰队护航，当天能出动的只有两艘，其余的还在船坞里做年检。",
        "只在话筒前表态最能安住盟国，也把话说死——对方等的就是你这一句。",
        "先放战略储备压油价最快见效，但海峡那边会把这份沉默读成许可。"
      ]
    },
    title: "布雷的海峡，和只有两艘在港的舰队",
    body: "封锁是昨夜开始的：两道巡逻线，一份「未经许可的船只后果自负」的公报，还有停在水两边的四十条油轮。三位盟国大使在国务院排队，他们要一句表态。海军作战部长把话说得很短：能动的是两艘，其余在船坞。第三份文件来自能源署——原油七天涨四成，加油站的队已经排到街角。",
    choices: [
      {
...

  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "cable"],
    brief: {
      lede: "使馆被占了四十四天，十一个人还在里面，而谈判桌上的钱已经在路上。",
      known: [
        "直升机要穿越八百公里沙漠，去程能成，回程带不带得回来没人保证。",
        "把那笔秘密汇款写成新闻能拆掉对方的要价，也等于告诉世界你付过。",
        "继续秘密谈最省钱，只是国内每天都在数日子，而日子不站在你这边。"
      ]
    },
    title: "第四十四天：沙漠里的八架直升机，和一笔不能提的汇款",
    body: "四十四天前一群武装者冲进使馆，十一名外交官至今活着——对方每天早上寄一段录音来，那是唯一的证据。军方把营救方案放在你桌上：八架直升机，穿越沙漠，只有一次机会。同一只抽屉里是第二份文件：秘密渠道上那笔汇款的底单，而报馆已经在问白宫是不是付了钱。",
    choices: [
      {
...

  {
    ...
    brief: {
      lede: "军控条约七十二小时后到期，重写核查条款的稿子里有一句是对方替我们写的。",
      known: [
        "按对方的口径接受那句核查措辞，条约活下来，我们少开一半的门。",
        "硬改回自己的措辞，七十二小时可能什么都不剩，然后两边互相指责。",
        "让将军先作证能证明你并不天真，那句证词也会绑住你签字的手。"
      ]
    },
    title: "到期前三天，和一句由对方起草的核查条款",
    body: "条约七十二小时后失效，桌上只剩那一条核查措辞没谈定——而对方送来的版本里，有半句是我们自己没想到的。国务院说签了吧，参院两位资深议员说这一句等于把眼睛闭上，参联会主席则要求先在听证会上讲清楚「我们不天真」。你的三小时里，两份草稿同时送来，都写着你的签名位置。",
    choices: [
      {
...

  {
    ...
    brief: {
      lede: "第二任期第一次外访：你回到当年下令轰炸的那座城市，讲稿里那个词还空着。",
      known: [
        "念出那个词，国内的退伍军人组织当天就把「叛徒」印上横幅。",
        "不念，广场上那些孩子已经练好一句提问，它会替你上遍全世界的晚间新闻。",
        "只宣布重建账目最稳，也最容易被读成：白宫什么也没说。"
      ]
    },
    title: "你下令炸过的城市，和讲稿里空着的那个词",
    body: "如今那里是广场、一所学校，和一块刻着三千余人名字的石头。第二任期没有下一次当选，你剩下的只有名声这一件事。主人请你讲三分钟；随行的两位参议员坚持稿子里不能出现那个词；而广场上的孩子已经练好一句提问：「总统先生，你是来道歉的吗？」",
    choices: [
      {
  ...
  /* ================= 人事族 ================= */
  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "cable"],
    brief: {
      lede: "大法官座位十月空出来，三十天内要定人，党内与金主各递来一份名单。",
      known: [
        "提党内要的那个人：基层满意，金主当季就把手收回去。",
        "提金主要的那个人：听证会两天就过，此后每一步都有人提醒你是谁的人。",
        "让司法部按资历自拟一份最体面，代价是两边都觉得自己被绕开了。"
      ]
    },
    title: "三十天，两份名单，一个空座位",
    body: "一位大法官在十月宣布退休，参院说只给你们三十天走完全部程序。党的基层在电话会上点名要一个「在那两件事上站得住的人」；两位最大的捐款人同一天送来同一份三人名单，理由写了四页。司法部自己那份只有资历，没有立场。你的支持率每掉一格，这两边说话的音量就高一分。",
    choices: [
      {
...

  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "internet"],
    brief: {
      lede: "七个职位的名单上，幕僚长和第一夫人各划掉了三个，其中两个是同一对人。",
      known: [
        "全按幕僚长的版本签：西翼从此只有一个声音，而餐桌上会有人记着这笔。",
        "采纳那张便条：家里当天安静，资深幕僚第二天开始约记者。",
        "把七个人全留下、名单退回重拟，是今天不付钱、下个月双倍付的那条路。"
      ]
    },
    title: "同一份名单，两个划掉的三行",
    body: "名单上有七个职位。幕僚长划掉三个，理由写在背面，字迹很急。当天晚上，第一夫人的助理送来一张便条，上面是她认为该换掉的三个人——其中两个正是幕僚长保住的那两个。这两个人过去八个月分别在你的厨房桌边出现过，而这一次只有一个人能在名单上签字。",
    choices: [
      {
...

  {
    ...
    weight: 10, minYear: 1981, maxYear: 2025, medium: ["tv", "cable"],
    brief: {
      lede: "副总统愿意替你跑二十场，条件是他有单独讲的三十秒。",
      known: [
        "给那三十秒：票会来，但那三十秒每场都会被单独剪出来评论。",
        "逐字审稿：你保住话题，他保住一句「连讲话都要人写」。",
        "不用他自己跑最省解释，也最贵——总统的日程表一年只空得出十场。"
      ]
    },
    title: "他替你输过一次初选，现在他要那三十秒",
    body: "初选那年，你在两个州把他推出去背了那笔预算账，他的名字和那串数字一起挂在地方报纸上整整六周。现在他说：我替你站台，二十场，一场不退；要的只有三十秒，不谈你的政策，只谈他自己那件事。幕僚长说那三十秒会变成每周的头条，而你在三个中西部州正在往下掉。",
    choices: [
      {
...

  {
    ...
    flags: ["pres_two_terms"],
    brief: {
      lede: "第二届的第一周，内阁集体递上辞呈，日期一栏空着，等你先动谁。",
      known: [
        "全部驳回，等于告诉每个人：他们这个姿态没有分量。",
        "先换掉最弱的那一位，其余十个人当天就知道下一次轮到自己。",
        "拖到「稍后答复」的那三天里，报馆会替你选出那个人。"
      ]
    },
    title: "十一份辞呈，日期一栏空着",
    body: "十一份辞呈按同一份格式打印，签名都是真的，只有日期空着。他们说这不是逼宫，只是「一届新任期该有新的团队」。你的立法只剩最后一格程序要走，而第二任期没有下一次当选——这些人都清楚，他们下一步要面对的是你之后的那个人。幕僚长在门口问：今天上午回几个。",
    choices: [
      {
