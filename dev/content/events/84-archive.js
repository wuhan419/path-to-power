...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    body: "你以为自己在查一件小事：一笔十年前被记错的土地交易。\n" +
      ...
      "它不进检索序列：连档案室自己的账上都查不到。卷宗里有三个签名，一个是你自己党里的老人。" +
      "归档员两点半回来，你还有一个小时零十分钟。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "最开始是一通打错的电话。第二周有人在你的车位对面坐了四十分钟。\n" +
      ...
      "「您对档案保管这件事有什么看法？」\n" +
      "你那份复印件还锁在抽屉里，一次都没用过。\n" +
      "她不是记者——记者的本子摊开着，她的合着。她只知道你翻过东西，不知道是哪份。" +
      "那份复印件还没有第三双眼睛看过，这是你唯一的筹码；她要的也许正是你先动一下。",
    choices: [
      {
   ...
   * ======================================================================== */
  {
    ...
    body: "他请你去他的办公室，时间是周日下午，楼里没有别人。\n" +
      ...
      "两个小时后你从楼里出来，天还没黑。\n" +
      "你手里那份复印件在西装内袋里，还是热的。\n" +
      "他这一生见过比这更糟的纸，吓是吓不动的。他真正在意的是儿子明年要选同一个位子。" +
      "他能给你三样：位置、钱、或者不再为难你。卷宗一旦公开，烧掉的不只他——那三个签名里还有两个在位。",
    choices: [
      {
      ...
      },
      {
        ...
        outcomes: {
          crit: aOut("你什么都没要，只说「我今天来是想认识您」。他送你到电梯口，握了很久的手。这张牌没打出去，但它从此每天都在替你说话。",
            { lev: 2, rep: 0.7, attr: { CUN: 2 }, fac: { establishment: 10 }, flags: ["archive_hold"] }),
          ok: aOut("你把它扣住了。他会一直记得你手上有什么 —— 这比一次性的交换有用得多。",
            { lev: 1, rep: 0.3, attr: { CUN: 1 }, fac: { establishment: 6 }, flags: ["archive_hold"] }),
   ...
   * ======================================================================== */
  {
    ...
    body: "你以为已经结掉的事情，回来给了你一张回执。\n" +
      ...
      "这世上没有把用过的牌放回牌堆这种事。已经有人知道你手过什么：他们不问，但记着。" +
      "有人说你当年见过的那个人正在写回忆录。十年后再提起这件事，用哪一个版本，现在还没定。",
    choices: [
      {
