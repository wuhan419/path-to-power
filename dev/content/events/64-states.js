...
POTUS.define("event", [
  ...
  /* ---- 深红州里的民主党人：少数派的生存术 ---- */
  {
    ...
    body: "你在深红州（共和党长期占优，基层职位照样经营得起来），你的党在这里是长期的少数派：" +
      "本党上次赢下一个全州职位时，报纸还没有彩色版，登记选民不到四成。县党部例会在一家餐馆后厅开，到会十七人。" +
      "街对面那家拉美商会是全州最大的，有钱，握着一张越来越长的名单，缺的只是一张能替它代言的脸。" +
      "有人说会长自己的野心不小，扶你可能是垫脚。人口曲线也站在你这一边。少数派要怎么打？",
    choices: [
      {
  ...
  /* ---- 摇摆州：最后一周 ---- */
  {
    ...
    title: "摇摆州选战进入最后一周",
    body: "你的摇摆州（两党基本盘咬得极近，每一票都有人肯出价钱）又成了全国战场：钱、代言人、广告按小时涌进来。" +
      "民调差距在误差以内，最后七天的资源怎么用，定下一切。桌上三张牌：电视广告、地面战（挨家挨户敲门催票的基层动员）、" +
      "还有对手的挖坟。全国委员会的最后一笔钱今晚到账，只够办其中两件事。有人说对面已经把你的旧账研究到了大学宿舍的违纪记录。" +
      "这一周，你每一个小决定都会被放大一万倍。",
    choices: [
      {
  ...
  /* ---- 深蓝州的共和党人：伪装温和派 ---- */
  {
    ...
    body: "深蓝州（民主党长期占优，共和党只剩地方可经营）的少数派政治学：你的党在这里是少数派中的少数派，" +
      "全州职位二十年没赢过一场。地方是另一回事——这里的选民投的是人，不是党徽，于是竞选材料上你的党派字号比对手小三号。" +
      "顾问给你两条路：全国路线的本州版，或者本地温和派；还有第三条——检察官、法官这类选票上不印党标的职位。" +
      "有人说全国党对深蓝州的温和派存着一份名单，资源连着约束。稀缺也意味着：风向一转，你先被花出去。",
    choices: [
      {
