...
POTUS.define("event", [
  {
    ...
    brief: {
      lede: "跨国输油管道破裂，成品油告急，三个州的加油站开始限购，州长们在电话会上互相甩锅。",
      known: [
        "动用战略储备并宣布配给，等于承认供应链断了——油价表先涨，民意先怒，这张牌也只剩这一次可打。",
        "只放行联邦运输优先权能稳住市场，但那三个州的加油车队每天还是得有人替你盯着。",
        "什么都不宣布最省政治资本，可州长们的互相指责不会一直停在电话会里。"
      ]
    },
    title: "管道正午破裂，三个州的加油站开始发号",
    body: "工程兵团报告：破裂点已定位，最快也要十天才能重启，内陆三州的成品油库存只够两周。三州州长今早已开过一场电话会议，每人开场白都是夸本州贡献了多少油、又拿走了多少；能源部长请你在今晚记者会前定个调子；两家报纸的头条已经在问，白宫是不是还要说「市场会自己修好」。",
    choices: [
      {
  ...
  },
  {
    ...
    brief: {
      lede: "一场大规模枪击后的第三天，全国在等你说出第二句悼词以外的话。",
      known: [
        "连夜推一部联邦法案需要票数，更需要运气——家属坐在画廊里旁计票，既能成为你的证人，也能成为你的陪审团。",
        "降半旗加委托委员会每一步都合规，而合规本身就会被解释成你只有仪式没有动作。",
        "亲自去那座城市开追思会，是获得原谅最快的路，也是被当场嘘下台最快的路。"
      ]
    },
    title: "第三天，全国在等你第二句话",
    body: "十天的下半旗已经排进了仪式表；参议院多数党领袖说票数没有、三周内也不会有；那座城市的市长对每个愿意听的人说，联邦的行动不能只是「换一种格式的慰问电」；两位遗属代表今天下午到白宫，她们和幕僚长的会谈纪要已经有人在楼下递给记者。",
    choices: [
      {
  ...
  },
  {
    ...
    brief: {
      lede: "电网被境外力量入侵，三个都会区停电进入第三周，医院在用发电机烧柴油。",
      known: [
        "公开点名并召回大使会把对抗摆上桌面——市场先跌为敬，而电什么时候回来没人能给你保证。",
        "私下渠道施压加悄悄补柴油能保住人命和温度，只是渠道一旦见光，你公开说过的每个字都会变成欠条。",
        "压下网络攻击的真相能稳住交易盘，但电力公司里的技师们在传话，医院油罐上的刻度也在传话。"
      ]
    },
    title: "停电第三周，医院的柴油刻度在走",
    body: "情报部门和能源部的初步评估指向同一个方向，但全文还不到能拿出去对质的程度；停电区一家电力公司总裁请求授权夜间拉闸非民用负荷，卫生部门警告三家医院的发电机柴油只够十天；财长已经两次派人来问「境外入侵」这四个字对盘面影响几何；在野党那位参议员正在家里排练周日的节目，问题只有一个——总统什么时候知道的。",
    choices: [
      {
  ...
  },
  {
    ...
    brief: {
      lede: "第二任期刚开始，一位从州里就跟着你的旧部定罪在望——卷宗里也有你签过字的东西。",
      known: [
        "签发特赦等于承认你当年知情，特别检察官明天就多出整整一章，新闻席也少一分客气。",
        "拒绝并公开切割可以止血，但旁听席上每一位跟过你的老同事，都在心里数这是第几个被推出去的人。",
        "拖到任期结束，你今天就什么都不必付——代价是把决定、卷宗和故事一起交给下一任。"
      ]
    },
    title: "他档案里有你签字的那几页",
    body: "判决最快本月底宣读，他的律师确认他到死都不会和检方合作；白宫法律顾问办公室理出了一张清单——涉案十九份文件里，三份是你还在州里时签的字；党主席上周来串门，笑着说老板你不再选下一次了，想想还想要什么；他的太太托当年那位老门卫递进来一封手写信，信封上只写了「给你本人」。",
    choices: [
      {
