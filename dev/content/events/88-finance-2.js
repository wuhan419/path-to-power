...
POTUS.define("event", [
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "天上掉下来的钱，落地时总带着别人的指纹。",
      known: [
        "全家族只有你在从政——名字是能拿来用的。",
        "遗产合法，缺的是那笔资产变成现金前的履历。",
        "你账上正好缺这么一笔钱撑过下半年。"
      ],
      rumor: [
        "有人说姑婆的钱和一个早已结业的商行有关。",
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "你没问过的那个问题，两年后自己找上门来了。",
      known: [
        "他敢来是因为你收钱那天没问「资产构成」。",
        "他要一笔「管理费」加你在委员会「保持现状」。",
        "交割文书和批注都是真的——这是最麻烦的地方。"
      ],
      rumor: [
        "他手里不止你一份批注，整条街他都管过。",
        "背后的委托人早就不在人世，他只是收无主的账。"
      ],
      unknown: [
        "批注法律上站不站得住——他赌你不敢验证。",
        "这页纸交给该交的地方，会先炸到谁。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "政治人物最怕的不是贪污指控，是一栏对不上的数字。",
      known: [
        "你被选中是因为公开行程里太多「报告收入付不起的场面」。",
        "三年里十一笔支出走了现金，其中三笔你说不清用途。",
        "审计不等于指控：结果可以是补税，也可以是案卷转检方。"
      ],
      rumor: [
        "审计名单上还有两个人，都比你有名。",
        "会计手里有一本「真账」，留着是为自保。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      ...
      known: [
        "开发商需要你这样的「有分量」早期买家来撑盘。",
        "规划图还是草案，但草案上有你委员会里见过面的签名。",
        "地价现在只有立项后估值的三成——这个差价是全部诱惑。"
      ],
      rumor: [
        "大桥走向还有第二套方案，仓库区在那套里是滩涂。",
        "中间人去年用同样的故事卖过另一块地，那块地还荒着。"
      ],
      unknown: [
        "草案上的签名会不会最后一轮换掉。",
        "曝光后先倒是你的钱还是你的席位。"
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "别人给你钱是投资，你给别人钱是权力。",
      known: [
        "你在圈内名字已经值钱——没分量的人立不起委员会。",
        "委员会收的钱没有上限，但不能直接给你的竞选。",
        "登记、章程、合规官都现成，说客连首笔捐款都物色好了。"
      ],
      rumor: [
        "首笔捐款的真正主人想借你的盘子洗一段旧关系。",
        "党内大佬已经盯着这个委员会了。"
      ],
      unknown: [
        "拿了委员会钱的人四年后还听不听你的。",
   ...
   * ======================================================================== */
  {
    ...
    brief: {
      lede: "破产不是因为做错了事，是该到账的钱没到。",
      known: [
        "三笔说好的捐款同时黄了，债主还不知道这个数字。",
        "拖欠工资会上报纸——见报后捐款更进不来。",
        "下周五前你必须拿出一个数字给团队看。"
      ],
      rumor: [
        "对手在放话「他快撑不住了」，捐款人观望就是被吓的。",
        "有个放贷的专门等这种时候，条件不只是利息。"
      ],
      unknown: [
        "团队里有几个人已经更新了简历。",
        "摊牌后等来的是同舟共济还是集体跳槽。"
   ...
   * ======================================================================== */
  {
    ...
    body: "一家本地媒体打来电话，语气很客气，问题很不客气：一位「公开承诺为普通人发声」的候选人，\n" +
      ...
      "你盯着屏幕上那串数字——利息滚得比你任何一次演讲都勤。",
    brief: {
      lede: "这不是没钱，是没把钱排到该在的位置——现在所有人都看见了。",
      known: [
        "逾期已累积到上征信的程度，瞒是瞒不住的。",
        "记者手里有公开记录，只能选择怎么说。",
        "还上一大笔能止住催收，但那笔钱要从别处挖窟窿。"
      ],
      rumor: [
        "对手团队已把这段贴上议题清单，等你先哭还是先硬。",
        "有人说这点事在竞选季根本不算事。"
      ],
      unknown: [
        "把窘境讲成选民同款，圈人还是翻车。",
